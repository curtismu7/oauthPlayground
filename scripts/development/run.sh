...
show_final_summary() {
    ...
    echo -e "${banner_color}║${NC} ${CYAN}   - backend.log (default backend logs)${NC}"
    ...
    echo -e "${banner_color}║${NC}"
    echo -e "${banner_color}║${NC} ${CYAN}📌 Recommended Monitoring Setups:${NC}"
    echo -e "${banner_color}║${NC} ${GREEN}   • Development: tail -f backend.log vite.log logs/pingone-api.log${NC}"
    echo -e "${banner_color}║${NC} ${GREEN}   • API Testing: tail -f backend.log logs/pingone-api.log logs/real-api.log${NC}"
    echo -e "${banner_color}║${NC} ${GREEN}   • Flow Testing: tail -f backend.log logs/sms.log logs/email.log${NC}"
    echo -e "${banner_color}║${NC} ${GREEN}   • Complete View: tail -f backend.log vite.log logs/pingone-api.log logs/server.log${NC}"
    echo -e "${banner_color}║${NC} ${GREEN}   • All-in-One: tail -f backend.log vite.log logs/pingone-api.log logs/server.log logs/sms.log logs/email.log${NC}"
    echo -e "${banner_color}║${NC}"
