...
async function testSQLite() {
	try {
		...
		const searchResults = userDatabaseService.searchUsers(
		...
		const smithResults = userDatabaseService.searchUsers(
			'b9817c16-9910-4415-b67e-4ac687da74d9',
			'smith'
		);
		...
		const wilsonResults = userDatabaseService.searchUsers(
			'b9817c16-9910-4415-b67e-4ac687da74d9',
			'wilson'
		);
