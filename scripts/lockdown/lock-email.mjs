...
/**
 * @file lock-email.mjs
 * @description Lock Email MFA V8 feature - Create isolated copy with all dependencies
 * @version 1.0.0
 * 
 * This script creates a complete isolated copy of Email MFA V8, including:
 * - Email flow files (registration and authentication)
 ...
 * 
 * Usage:
 *   node scripts/lockdown/lock-email.mjs [--dry-run]
 * 
 * After locking, Email MFA will be in src/locked/email-v8/ and will never break
...
const LOCKED_DIR = join(PROJECT_ROOT, 'src', 'locked', 'email-v8');
 ...
 */
function lockEmail(dryRun = false) {
	console.log('🔒 Locking Email MFA V8...\n');
	...
	console.log('\n✨ Email MFA V8 locked successfully!');
	console.log(`\n📊 Summary:`);
