...
function lockDeviceCode(dryRun = false) {
	...
	const manifest = {
		...
		description: 'Locked-down Device Code Authorization flow (RFC 8628) for OAuth 2.0/OIDC. This includes the device code integration service, device flow service, and all device-specific flow components. Protected from breaking changes in shared services.',
