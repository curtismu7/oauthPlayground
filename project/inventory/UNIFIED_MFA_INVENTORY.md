...
# OTP Authorization header 403 Forbidden prevention
grep -n -A 5 -B 5 "Authorization.*Bearer.*workerTokenForOTP" src/v8/flows/unified/UnifiedMFARegistrationFlowV8_Legacy.tsx
grep -n -A 3 -B 3 "validate-otp-for-device" src/v8/flows/unified/UnifiedMFARegistrationFlowV8_Legacy.tsx
grep -n -A 5 -B 5 "Invalid key=value pair.*missing equal-sign" src/v8/flows/unified/UnifiedMFARegistrationFlowV8_Legacy.tsx
...
| **✅ OTP Authorization Header 403 Forbidden** | RESOLVED | Added Bearer token to OTP validation request | `grep -A 5 "Authorization.*Bearer.*workerTokenForOTP"` |
