...
<tbody><tr>
	<td class="file high" data-value="logger.effects.ts"><a href="logger.effects.ts.html">logger.effects.ts</a></td>
...
<tr>
	<td class="file empty" data-value="logger.types.ts"><a href="logger.types.ts.html">logger.types.ts</a></td>
