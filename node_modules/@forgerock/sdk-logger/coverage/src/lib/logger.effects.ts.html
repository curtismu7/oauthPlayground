...
<head>
    <title>Code coverage report for src/lib/logger.effects.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/lib</a> logger.effects.ts</h1>
        <div class='clearfix'>
...
export function logger(config: { level: LogLevel; custom?: CustomLogger }) {
  let logLevel: LogLevel = config.<span class="branch-0 cbranch-no" title="branch not covered" >level || 'info';</span>
  const custom = config.custom;
&nbsp;
  // Implement log functions
  const logFunctions = {
    error: (...args: LogMessage[]) =&gt; <span class="branch-0 cbranch-no" title="branch not covered" >custom?.error(.</span>..args) || console.error(...args),
    warn: (...args: LogMessage[]) =&gt; <span class="branch-0 cbranch-no" title="branch not covered" >custom?.warn(.</span>..args) || console.warn(...args),
    info: (...args: LogMessage[]) =&gt; <span class="branch-0 cbranch-no" title="branch not covered" >custom?.info(.</span>..args) || console.info(...args),
    debug: (...args: LogMessage[]) =&gt; <span class="branch-0 cbranch-no" title="branch not covered" >custom?.debug(.</span>..args) || console.debug(...args),
  };
&nbsp;
