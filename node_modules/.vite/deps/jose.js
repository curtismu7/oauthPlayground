...
async function decryptKeyManagement(alg, key, encryptedKey, joseHeader, options) {
  ...
  key = await ((_b2 = (_a2 = normalize_key_default).normalizePrivateKey) == null ? void 0 : _b2.call(_a2, key, alg)) || key;
  switch (alg) {
    case "dir": {
...
async function encryptKeyManagement(alg, enc, key, providedCek, providedParameters = {}) {
  ...
  key = await ((_b2 = (_a2 = normalize_key_default).normalizePublicKey) == null ? void 0 : _b2.call(_a2, key, alg)) || key;
  switch (alg) {
    case "dir": {
      cek = key;
      break;
