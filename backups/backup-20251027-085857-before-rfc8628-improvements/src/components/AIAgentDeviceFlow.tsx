...
import { FiCopy, FiExternalLink, FiRefreshCw, FiXCircle, FiCheckCircle, FiAlertTriangle, FiCpu, FiZap, FiActivity, FiMessageCircle, FiUpload, FiSettings } from 'react-icons/fi';
    ...
    <AIAgentContainer>
      ...
      <AIDisplayScreen>
        ...
        <UserCodeDisplay>
          ...
          <CopyButton onClick={handleCopyUserCode} title="Copy authorization token">
            <FiCopy size={16} />
          </CopyButton>
        </UserCodeDisplay>
      </AIDisplayScreen>
      ...
      <InfoSection style={{ marginBottom: '1.5rem', padding: '1rem', background: '#f0f4ff', border: '1px solid #c7d2fe', borderRadius: '0.5rem' }}>
        <InfoTitle style={{ color: '#6366f1', fontSize: '0.875rem', fontWeight: 600, marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <FiCpu size={16} /> What is an AI Agent?
        </InfoTitle>
        <InfoText style={{ color: '#475569', fontSize: '0.75rem', lineHeight: '1.6', margin: 0 }}>
          AI agents are autonomous systems that perform tasks and make decisions on behalf of users. They require secure, seamless authentication to access protected resources without manual intervention.
          <br /><br />
          <strong>Use cases:</strong> Intelligent assistants, automated workflows, decision-making systems, predictive analytics
        </InfoText>
      </InfoSection>
