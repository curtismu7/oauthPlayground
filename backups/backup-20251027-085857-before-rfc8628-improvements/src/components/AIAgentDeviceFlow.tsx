		...
		<AIAgentContainer>
			...
			>
				...
				<InfoText style={{ color: '#475569', fontSize: '0.75rem', lineHeight: '1.6', margin: 0 }}>
					AI agents are autonomous systems that perform tasks and make decisions on behalf of users.
					They require secure, seamless authentication to access protected resources without manual
					intervention.
					<br />
					<br />
					<strong>Use cases:</strong> Intelligent assistants, automated workflows, decision-making
					...
					>
						...
						>
							...
							>
								...
								>
									I'd be happy to help analyze your quarterly sales data. I can process the
									information and provide insights on trends, performance metrics, and
									recommendations.
								</div>
								<div
									style={{
