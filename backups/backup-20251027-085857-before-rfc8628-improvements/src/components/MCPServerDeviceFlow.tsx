...
const MCPServerDeviceFlow: React.FC<MCPServerDeviceFlowProps> = ({
  ...
  return (
    <MCPServerContainer>
      ...
      <InfoSection style={{ marginBottom: '1.5rem', padding: '1rem', background: 'rgba(236, 72, 153, 0.1)', border: '1px solid rgba(236, 72, 153, 0.3)', borderRadius: '0.5rem' }}>
        <InfoTitle style={{ color: '#f472b6', fontSize: '0.875rem', fontWeight: 600, marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <FiServer size={16} /> What is an MCP Server?
        </InfoTitle>
        <InfoText style={{ color: '#cbd5e1', fontSize: '0.75rem', lineHeight: '1.6', margin: 0 }}>
          MCP (Model Context Protocol) servers provide secure, authenticated contexts for AI agents to access external data and tools. 
          Using OAuth Device Flow ensures that server resources are protected while allowing headless authentication for automated processes.
          <br /><br />
          <strong>Use cases:</strong> Automated AI workflows, data pipelines, cloud service integrations
        </InfoText>
      </InfoSection>
