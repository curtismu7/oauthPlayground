		...
		<MCPServerContainer>
			...
			>
				...
				<InfoText style={{ color: '#cbd5e1', fontSize: '0.75rem', lineHeight: '1.6', margin: 0 }}>
					MCP (Model Context Protocol) servers provide secure, authenticated contexts for AI agents
					to access external data and tools. Using OAuth Device Flow ensures that server resources
					are protected while allowing headless authentication for automated processes.
					<br />
					<br />
					<strong>Use cases:</strong> Automated AI workflows, data pipelines, cloud service
					integrations
				</InfoText>
			</InfoSection>
