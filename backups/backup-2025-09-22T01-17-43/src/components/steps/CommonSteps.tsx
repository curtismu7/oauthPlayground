		...
		<div>
			...
			<FormField>
				...
				<FormInput
					...
					onChange={(e) =>
						setCredentials({ ...credentials, scope: e.target.value, scopes: e.target.value })
					}
				...
				<InfoBox type="success">
					...
					<div>
						...
						{flowType === 'oauth' && (
							...
							>
								<strong>📝 OAuth 2.0 Note:</strong> This is a pure OAuth 2.0 flow, so you only
								receive Access and Refresh tokens. ID tokens are part of OpenID Connect (OIDC), not
								OAuth 2.0.
							</div>
						)}
					</div>
...
export const createRefreshTokenStep = (
	...
	description:
		'Demonstrate how to use the refresh token to obtain a new access token without user re-authentication.',
	icon: <FiKey />,
	category: 'token-exchange',
	content: (
		<div>
