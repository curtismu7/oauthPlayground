		...
		<Container>
			...
			<Nav>
				<ul>
					...
					<li>
						<a href="#current-standards">Current Standards</a>
					</li>
					<li>
						<a href="#ai-considerations">AI Considerations</a>
					</li>
					<li>
					...
					<CollapsibleContent $isOpen={expandedSections.basics}>
						<Section id="basics">
							...
							<p>
								...
								access to user accounts on an HTTP service. It works by delegating user
								authentication to the service that hosts the user account and authorizing
								third-party applications to access that user account.
							</p>

							<InfoBox>
								<strong>Key Concept:</strong> OAuth 2.0 is about <strong>authorization</strong>{' '}
								(what you can do), not authentication (who you are). That's where OpenID Connect
								comes in.
							</InfoBox>

							<SubTitle>What is OpenID Connect (OIDC)?</SubTitle>
							<p>
								OpenID Connect is an identity layer built on top of OAuth 2.0. It allows clients to
								verify the identity of end-users based on authentication performed by an
								authorization server, and to obtain basic profile information about the end-user.
							</p>
							...
							<Grid>
								<Card>
									<h4>OAuth 2.0</h4>
									<p>
										<strong>Purpose:</strong> Authorization
									</p>
									<p>
										<strong>Question:</strong> "What can this app access?"
									</p>
									<p>
										<strong>Output:</strong> Access tokens
									</p>
								</Card>
								<Card>
									<h4>OpenID Connect</h4>
									<p>
										<strong>Purpose:</strong> Authentication
									</p>
									<p>
										<strong>Question:</strong> "Who is this user?"
									</p>
									<p>
										<strong>Output:</strong> ID tokens (JWT)
									</p>
								</Card>
							</Grid>
					...
					<CollapsibleContent $isOpen={expandedSections.flows}>
						<Section id="flows">
							...
							<FlowDiagram>
								...
								<Arrow>↓</Arrow>
								<FlowStep>
									<strong>Step 2:</strong> App redirects to Authorization Server with client_id,
								...
								<Arrow>↓</Arrow>
								<FlowStep>
									<strong>Step 4:</strong> Authorization Server redirects back with authorization
									code
								</FlowStep>
								<Arrow>↓</Arrow>
								<FlowStep>
									<strong>Step 5:</strong> App exchanges code for tokens (access + refresh + ID
									token)
								</FlowStep>
								<Arrow>↓</Arrow>
								<FlowStep>
...
code_verifier=dBjftJeZ...`}</CodeBlock>
							...
							<InfoBox>
								<strong>PKCE (Proof Key for Code Exchange):</strong> Essential security extension
								that prevents authorization code interception attacks.{' '}
								<strong>Required for public clients</strong> (SPAs, mobile apps, desktop apps).
								<br />
								<br />
...
code_verifier=dBjftJeZ4CVP-mB92K27uhbUJU1p1r_wW1gFWFOEjXk`}</CodeBlock>
							...
							<p>
								Used when the AI application itself needs to access resources, not on behalf of a
								user. Common for background AI agents, batch processing, and service-to-service
								communication.
							</p>
...
scope=ai:process ai:analyze`}</CodeBlock>
							...
							<p>
								For input-constrained devices like AI assistants, smart displays, or IoT devices
								that don't have a browser.
							</p>
				...
				<CollapsibleSection>
					...
					<CollapsibleContent $isOpen={expandedSections.currentStandards}>
						<Section id="current-standards">
							...
							<InfoBox>
								<strong>What is PAR?</strong> Instead of passing authorization parameters in the
								URL, the client POSTs them directly to the authorization server and receives a
								request URI. This significantly improves security and privacy.
							</InfoBox>
						...
						<Section id="ai-considerations">
							<Grid>
								<Card>
									...
									<p>
										AI applications often need extended access. Use refresh tokens with appropriate
										rotation policies.
									</p>
								</Card>
								<Card>
									...
									<p>
										Define specific scopes for AI capabilities: ai:read, ai:write, ai:train,
										ai:deploy
									</p>
								</Card>
								<Card>
						...
						<Section id="security">
							...
							<Grid>
								<Card>
									...
									<p>
										All OAuth/OIDC communication must use TLS 1.2 or higher to protect tokens in
										transit.
									</p>
								</Card>
								<Card>
									...
									<p>
										Required for public clients. Prevents authorization code interception attacks.
									</p>
								</Card>
								<Card>
								...
								<Card>
									...
									<p>
										Keep access token lifetime short (15-60 minutes). Use refresh tokens for
										extended access.
									</p>
								</Card>
								<Card>
								...
								<Card>
									...
									<p>
										Always verify ID token and JWT signatures using the issuer's public keys (JWKS).
									</p>
								</Card>
							</Grid>
					...
					<CollapsibleContent $isOpen={expandedSections.future}>
						<Section id="future">
							...
							<Card>
								...
								<p>
									Enables fine-grained authorization using structured JSON instead of simple scopes.
								</p>
								<CodeBlock>{`{
  "authorization_details": [
    {
      ...
      "rate_limit": "100/hour"
							...
							<ul>
								<li>
									<strong>Model Access Control:</strong> How to authorize access to specific AI
									models
								</li>
								<li>
									<strong>Token Consumption:</strong> Tracking and limiting AI token usage per
									authorization
								</li>
								<li>
									<strong>Multi-Modal Permissions:</strong> Different permissions for text, image,
									audio AI capabilities
								</li>
								<li>
									<strong>Training Data Privacy:</strong> Ensuring user data used for AI training is
									properly authorized
								</li>
								<li>
									<strong>AI Agent Delegation:</strong> How AI agents can act on behalf of users
									with proper authorization chains
								</li>
							</ul>
						</Section>
					</CollapsibleContent>
