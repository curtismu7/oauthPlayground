	...
	return (
		<DocumentationContainer>
			<PageHeader>
				...
				<p>
					Welcome to the OAuth Playground documentation. Here you'll find guides, examples, and
					references to help you understand and implement OAuth 2.0 and OpenID Connect with PingOne.
				</p>
			</PageHeader>
