					...
					<div>
						<SecurityWarning>
							...
							<div style={{ fontSize: '0.875rem', lineHeight: '1.5' }}>
								...
								Access tokens are exposed in the URL fragment, making them vulnerable to theft. This
								flow is provided for legacy compatibility only. For new applications, use the
