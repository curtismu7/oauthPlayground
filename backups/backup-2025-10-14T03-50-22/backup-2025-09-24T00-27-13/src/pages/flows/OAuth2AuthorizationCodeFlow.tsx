			...
			if (storedCredentials && storedCredentials.clientId) {
				const convertedCredentials = {
					...
					scopes: Array.isArray(storedCredentials.scopes)
						...
						: storedCredentials.scopes || 'profile email',
					responseType: 'code',
					codeChallengeMethod: 'S256',
				};
			...
			try {
				...
				if (
					...
					if (!pingoneConfig && !loginCredentials) {
						...
						console.log(
							'⚠️ [EnhancedAuthorizationCodeFlowV2] Other credentials exist, keeping test values for now'
						);
					}
				}
				...
				if (!hasCredentials) {
					console.log(
						'⚠️ [EnhancedAuthorizationCodeFlowV2] No credentials found, loading from environment variables...'
					);
					try {
