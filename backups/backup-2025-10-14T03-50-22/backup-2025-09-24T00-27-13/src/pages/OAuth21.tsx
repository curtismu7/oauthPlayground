...
&code_challenge_method=S256`}</pre>
						...
						<SpecCard title="Resource Owner Password Credentials Deprecated">
							...
							<p>
								The Password grant is omitted from OAuth 2.1 specification. Use Authorization Code
								flow for user authentication scenarios.
							</p>
...
// 3. Or no refresh tokens at all`}</pre>
							...
							>
								...
								<div>
									...
									<p style={{ margin: '0', color: '#3b82f6', fontSize: '0.9rem' }}>
										PingOne supports both sender-constrained and one-time use refresh tokens for
										enhanced security.
									</p>
								</div>
							</div>
			...
			<Card>
				...
				<CardBody>
					...
					<ol style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						...
						<li>
							<strong>Secure Bearer Tokens:</strong> Use Authorization headers, not query strings
						</li>
						<li>
							<strong>Enhance Refresh Tokens:</strong> Implement sender-constrained or one-time use
							tokens
						</li>
					</ol>
					...
					<ul style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						...
						<li>
							<strong>Better Token Handling:</strong> Prevents token leakage in logs and referrers
						</li>
						<li>
			...
			<Card>
				...
				<CardBody>
					...
					<ul style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						...
						<li>
							<strong>Enhanced Refresh Tokens:</strong> Sender-constrained and one-time use options
						</li>
						<li>
