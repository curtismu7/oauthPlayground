...
import { FiGitBranch, FiShield, FiUsers, FiKey, FiZap } from 'react-icons/fi';
...
const InteractiveFlowDiagram: React.FC = () => {
	...
	const AuthorizationCodeDiagram = InteractiveFlowDiagramService.createFlowDiagram({
		...
		description: 'The most secure and recommended OAuth 2.0 flow for web applications with backend servers.',
		diagramType: 'oauth',
		interactive: true,
		showSteps: true,
		theme: 'default'
	...
	const OIDCDiagram = InteractiveFlowDiagramService.createFlowDiagram({
		...
		description: 'OAuth 2.0 Authorization Code Flow extended with OpenID Connect for user authentication and identity.',
		diagramType: 'oidc',
		interactive: true,
		showSteps: true,
		theme: 'default'
	...
	const ImplicitDiagram = InteractiveFlowDiagramService.createFlowDiagram({
		...
		description: 'OAuth 2.0 Implicit Flow - deprecated due to security concerns. Use Authorization Code Flow with PKCE instead.',
	...
	const ClientCredentialsDiagram = InteractiveFlowDiagramService.createFlowDiagram({
		...
		description: 'OAuth 2.0 flow for machine-to-machine communication where no user interaction is required.',
				...
				>
					<div style={{ padding: '1.5rem' }}>
						<div style={{
							...
							<strong>⚠️ Security Warning:</strong> The Implicit Flow is deprecated and should not be used in new applications. 
					...
					<div style={{ padding: '1.5rem' }}>
						<div style={{
							...
							<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
								<div style={{ padding: '1rem', background: 'white', borderRadius: '6px', border: '1px solid #e0f2fe' }}>
									<h4 style={{ color: '#0369a1', marginBottom: '0.5rem' }}>✅ Use Authorization Code Flow</h4>
								...
								<div style={{ padding: '1rem', background: 'white', borderRadius: '6px', border: '1px solid #e0f2fe' }}>
									<h4 style={{ color: '#0369a1', marginBottom: '0.5rem' }}>✅ Use Client Credentials Flow</h4>
									<ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#0c4a6e' }}>
								...
								<div style={{ padding: '1rem', background: 'white', borderRadius: '6px', border: '1px solid #fecaca' }}>
									<h4 style={{ color: '#dc2626', marginBottom: '0.5rem' }}>❌ Avoid Implicit Flow</h4>
						...
						<div style={{
							...
							<ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#166534' }}>
								<li><strong>Always use HTTPS:</strong> Encrypt all OAuth communications</li>
								<li><strong>Implement PKCE:</strong> Use Proof Key for Code Exchange for additional security</li>
								<li><strong>Validate state parameter:</strong> Prevent CSRF attacks</li>
								<li><strong>Use short-lived tokens:</strong> Minimize exposure window</li>
								<li><strong>Implement token refresh:</strong> Use refresh tokens for long-lived sessions</li>
								<li><strong>Store tokens securely:</strong> Use secure storage mechanisms</li>
								<li><strong>Validate all tokens:</strong> Always verify token signatures and claims</li>
							</ul>
						</div>
					</div>
				</CollapsibleHeader>
