		...
		<PageContainer>
			...
			<ReferenceCard>
				...
				<ReferenceContent>
					...
					<ReferenceText>
						This guide is based on the official IETF RFC 9700 - Best Current Practice for OAuth 2.0
						Security, published in January 2025. This document updates and consolidates security
						recommendations from RFC 6749, RFC 6750, and RFC 6819.
					</ReferenceText>
					<ReferenceLink
				...
				<Subsection>
					...
					<BestPracticeCard $type="critical">
						...
						<PracticeContent>
							...
							<PracticeDescription>
								Implement robust client authentication mechanisms to prevent unauthorized access to
							...
							<PracticeList>
								...
								<PracticeListItem>
									Use mutual TLS (mTLS) for high-security scenarios
								</PracticeListItem>
								<PracticeListItem>
									Consider JWT-based client assertions for stateless authentication
								</PracticeListItem>
							</PracticeList>
						</PracticeContent>
					</BestPracticeCard>
					...
					<BestPracticeCard $type="recommended">
						...
						<PracticeContent>
							...
							<PracticeList>
								...
								<PracticeListItem>
									Use exact URI matching (no wildcards for security-critical apps)
								</PracticeListItem>
								<PracticeListItem>Implement client metadata validation</PracticeListItem>
								<PracticeListItem>
									Use dynamic client registration with proper validation
								</PracticeListItem>
							</PracticeList>
						</PracticeContent>
					</BestPracticeCard>
				...
				<Subsection>
					...
					<BestPracticeCard $type="critical">
						...
						<PracticeContent>
							...
							<PracticeDescription>
								Redirect URI validation is critical to prevent authorization code interception
								attacks.
							</PracticeDescription>
							<PracticeList>
								<PracticeListItem>Use exact string matching for redirect URIs</PracticeListItem>
								<PracticeListItem>
									Validate scheme, host, port, and path components
								</PracticeListItem>
				...
				<Subsection>
					...
					<BestPracticeCard $type="critical">
						...
						<PracticeContent>
							...
							<PracticeDescription>
								PKCE (Proof Key for Code Exchange) is essential for securing public clients and
								should be used even for confidential clients.
							</PracticeDescription>
							<PracticeList>
								<PracticeListItem>
								...
								<PracticeListItem>
									Create code_challenge using SHA256 of code_verifier
								</PracticeListItem>
								<PracticeListItem>
									Include code_challenge_method=S256 in authorization request
								</PracticeListItem>
				...
				<Subsection>
					...
					<BestPracticeCard $type="critical">
						...
						<PracticeContent>
							...
							<PracticeDescription>
								The state parameter prevents CSRF attacks and should be used in all authorization
								requests.
							</PracticeDescription>
							<PracticeList>
								...
								<PracticeListItem>
									Use state for additional context (nonce, return URL, etc.)
								</PracticeListItem>
							</PracticeList>
						</PracticeContent>
					</BestPracticeCard>
				...
				<Subsection>
					...
					<WarningBox>
						...
						<WarningContent>
							...
							<WarningText>
								Access tokens should never be included in URL parameters, query strings, or
								fragments. Always use the Authorization header with Bearer authentication.
							</WarningText>
						</WarningContent>
					</WarningBox>
				</Subsection>
					...
					<BestPracticeCard $type="critical">
						...
						<PracticeContent>
							...
							<PracticeList>
								...
								<PracticeListItem>
									Implement token binding (binding to client/device)
								</PracticeListItem>
			...
			<Section>
				...
				<BestPracticeCard $type="important">
					...
					<PracticeContent>
						...
						<PracticeList>
							...
							<PracticeListItem>
								Use granular, specific scopes instead of broad ones
							</PracticeListItem>
				...
				<InfoBox>
					...
					<InfoContent>
						...
						<InfoText>
							<strong>Good:</strong> <code>read:profile</code>, <code>write:posts</code>
							<br />
			...
			<Section>
				...
				<WarningBox>
					...
					<WarningContent>
						...
						<WarningText>
							The Implicit Grant flow is deprecated and should not be used for new applications. Use
							the Authorization Code flow with PKCE instead for better security.
						</WarningText>
					</WarningContent>
				</WarningBox>
				...
				<BestPracticeCard $type="important">
					...
					<PracticeContent>
						...
						<PracticeList>
							...
							<PracticeListItem>
								Use secure error handling (don't expose tokens in errors)
							</PracticeListItem>
			...
			<ReferenceCard>
				...
				<ReferenceContent>
					...
					<ReferenceText>
						For more detailed information about OAuth 2.0 security, consult these official
						resources:
					</ReferenceText>
					<div
