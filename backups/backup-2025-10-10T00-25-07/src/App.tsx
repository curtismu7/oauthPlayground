					...
					<MainContent>
						<Routes>
							...
							<Route
								...
								element={<Navigate to="/flows/oauth-authorization-code-v6" replace />}
							/>
							<Route
							...
							<Route
								...
								element={<Navigate to="/flows/oauth-implicit-v6" replace />}
							/>
							<Route
							...
							<Route
								...
								element={<Navigate to="/flows/oidc-implicit-v6" replace />}
							/>
							<Route
