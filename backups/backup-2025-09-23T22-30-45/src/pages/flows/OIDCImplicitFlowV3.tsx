					...
					<div>
						<SecurityWarning>
							...
							<div style={{ fontSize: '0.875rem', lineHeight: '1.5' }}>
								The OIDC Implicit flow is <strong>deprecated</strong> due to security concerns. ID
								tokens and access tokens are exposed in the URL fragment, making them vulnerable to
								theft. This flow is provided for legacy compatibility only. For new applications,
					...
					<div>
						...
						{credentials.clientId && (
							...
							>
								...
								>
									<h4
										style={{ margin: 0, color: '#dc2626', display: 'flex', alignItems: 'center' }}
									>
