...
export const FLOW_ROUTE_MAP: Record<string, string> = {
	...
	'device-authorization-v5': '/flows/device-authorization-v5',
	'oidc-device-authorization-v5': '/flows/oidc-device-authorization-v5',
	'ciba-v5': '/flows/ciba-v5',
...
export const FLOW_DISPLAY_NAMES: Record<string, string> = {
	...
	'device-authorization-v5': 'Device Authorization Flow',
	'oidc-device-authorization-v5': 'OIDC Device Authorization Flow',
	'ciba-v5': 'CIBA Flow',
