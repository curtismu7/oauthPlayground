...
interface CreateMockOIDCResourceOwnerPasswordStepsParams {
	controller: MockOIDCResourceOwnerPasswordController;
}

const createMockOIDCResourceOwnerPasswordSteps = ({
	controller,
}: CreateMockOIDCResourceOwnerPasswordStepsParams): EnhancedFlowStep[] => {
	const {
		credentials,
		setCredentials,
		saveCredentials,
...
export default createMockOIDCResourceOwnerPasswordSteps;
