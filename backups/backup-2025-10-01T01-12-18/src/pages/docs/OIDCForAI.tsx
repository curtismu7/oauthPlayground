		...
		<DocsContainer>
			...
			<Section>
				...
				<SpecCard title="Authentication Patterns for AI Applications">
					<p>AI applications have unique authentication and authorization requirements:</p>
					<ul>
						<li>
							<strong>Service-to-Service Authentication:</strong> Use Client Credentials flow for AI
							model access
						</li>
						<li>
							<strong>User Context Preservation:</strong> Maintain user identity through the AI
							processing pipeline
						</li>
						<li>
							<strong>Token Lifecycle Management:</strong> Implement proper token refresh for
							long-running AI processes
						</li>
						<li>
							<strong>Scope-Based Access Control:</strong> Use OAuth scopes to control AI model
							access and capabilities
						</li>
						<li>
							<strong>Audit and Compliance:</strong> Ensure all AI operations are properly logged
							and auditable
						</li>
					</ul>
				</SpecCard>
				...
				<SpecCard title="Security Best Practices for AI">
					<p>Key security considerations when implementing OIDC for AI applications:</p>
					<ul>
