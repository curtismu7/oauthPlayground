...
const flowCategories: FlowCategory[] = [
		...
		flows: [
			{
				...
				title: 'Authorization Code Flow V5',
				description: 'Reusable, production-ready Authorization Code experience',
				icon: <FiCode />,
				security: 'high',
				recommended: true,
				complexity: 'medium',
	...
	},
	{
		...
		flows: [
			...
			{
				id: 'worker-token',
				title: 'Worker Token Flow V5',
				description: 'PingOne admin access and management operations',
				icon: <FiTool />,
				security: 'high',
				recommended: false,
				complexity: 'medium',
