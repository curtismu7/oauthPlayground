...
const OAuth2ClientCredentialsFlowV3: React.FC = () => {
	...
	const requestToken = useCallback(async () => {
		if (
			...
			throw new Error(
				'Missing required credentials. Please configure Environment ID, Client ID, and Client Secret.'
			);
		}
					...
					<div>
						...
						<FormField>
							...
							<select
								...
								onChange={(e) =>
									setCredentials((prev) => ({ ...prev, authMethod: e.target.value as any }))
								}
								style={{
									width: '100%',
									padding: '0.75rem',
						...
						>
							...
							<div style={{ fontSize: '0.875rem', color: '#6b7280' }}>
								...
								{credentials.audience && (
									<div>
										<strong>Audience:</strong> {credentials.audience}
									</div>
								)}
							</div>
						</div>
								...
								>
									...
									<div style={{ color: '#92400e', fontSize: '0.875rem', lineHeight: '1.5' }}>
										<p style={{ margin: '0 0 0.5rem 0' }}>
											<strong>🔐 Credential Security:</strong> Client secrets must be stored
											securely (environment variables, secret management systems).
										</p>
										<p style={{ margin: '0 0 0.5rem 0' }}>
											<strong>🔑 Strong Authentication:</strong> Use private_key_jwt when possible
										...
										<p style={{ margin: '0 0 0.5rem 0' }}>
											<strong>🛡️ Scope Limitation:</strong> For OAuth 2.0 Client Credentials, use
