...
describe('BaseOAuthFlow', () => {
	...
	it('should render with basic props', () => {
		render(
			<BaseOAuthFlow title="Test Flow" description="Test description" flowType="test-flow">
...
describe('useOAuthFlowBase', () => {
	...
	it('should handle error', () => {
		const TestComponent = () => {
			const { handleError, error } = useOAuthFlowBase('test-flow');
	...
	it('should clear error', () => {
		const TestComponent = () => {
			const { handleError, clearError, error } = useOAuthFlowBase('test-flow');
...
describe('getPingOneEnvVars', () => {
	it('should return window environment variables when available', () => {
		const result = getPingOneEnvVars();
	...
	it('should return config fallback when window variables are not available', () => {
		...
		delete (window as any).__PINGONE_ENVIRONMENT_ID__;
		delete (window as any).__PINGONE_API_URL__;
		delete (window as any).__PINGONE_CLIENT_ID__;
