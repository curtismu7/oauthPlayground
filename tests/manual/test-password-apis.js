...
async function testPasswordState() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      logTest('Read Password State', 'SKIP', `Status: ${response.status} - ${data.error_description || data.message}`);
    }
  } catch (error) {
...
async function testSendRecoveryCode() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      logTest('Send Recovery Code', 'SKIP', `Status: ${response.status} - ${data.error_description || data.message}`);
    }
  } catch (error) {
...
async function testRecoverPassword() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      logTest('Recover Password', 'SKIP', `Status: ${response.status} - ${data.error_description || data.message}`);
    }
  } catch (error) {
...
async function testCheckPassword() {
  ...
  try {
    ...
    if (response.ok || response.status === 400) {
      ...
      logTest('Check Password', 'SKIP', `Status: ${response.status} - ${data.error_description || data.message}`);
    }
  } catch (error) {
...
async function testForcePasswordChange() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      logTest('Force Password Change', 'SKIP', `Status: ${response.status} - ${data.error_description || data.message}`);
    }
  } catch (error) {
...
async function testUnlockPassword() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      logTest('Unlock Password', 'SKIP', `Status: ${response.status} - ${data.error_description || data.message}`);
    }
  } catch (error) {
...
async function testSetPassword() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      logTest('Set Password (Admin)', 'SKIP', `Status: ${response.status} - ${data.error_description || data.message}`);
    }
  } catch (error) {
...
async function testSetPasswordValue() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      logTest('Set Password Value', 'SKIP', `Status: ${response.status} - ${data.error_description || data.message}`);
    }
  } catch (error) {
...
async function testAdminSetPassword() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      logTest('Admin Set Password', 'SKIP', `Status: ${response.status} - ${data.error_description || data.message}`);
    }
  } catch (error) {
