...
while [ $# -gt 0 ]; do
    case "$1" in
        --help|-h|-help)
            ...
            echo "  • Manages three core services: Frontend (Vite), Backend HTTP, Backend HTTPS"
            ...
            echo "        • Auto-tails pingone-api.log without prompting"
            echo "        • Ideal for automated scripts and CI/CD"
            echo ""
            echo "    -Background"
        ...
        -Background|-background)
            ...
            print_info "🌃 Background mode enabled - servers will run in background"
            shift
            ;;
