...
async function runAllTests() {
  ...
  const allPassed = results.backendHealth && results.envConfig && results.credentialManager && results.dashboardCredentials;
...
export { runAllTests, testBackendHealth, testEnvConfig, testCredentialManager, testDashboardCredentials };