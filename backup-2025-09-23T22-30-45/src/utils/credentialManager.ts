	...
	loadConfigCredentials(): PermanentCredentials {
		try {
			...
			if (stored) {
				...
				console.log(
					'✅ [CredentialManager] Loaded config credentials from localStorage:',
					credentials
				);
	...
	loadAuthzFlowCredentials(): PermanentCredentials {
		try {
			...
			if (stored) {
				const credentials = JSON.parse(stored);
				console.log(
					'✅ [CredentialManager] Loaded authz flow credentials from localStorage:',
					credentials
				);
	...
	loadImplicitFlowCredentials(): PermanentCredentials {
		try {
			...
			if (stored) {
				const credentials = JSON.parse(stored);
				console.log(
					'✅ [CredentialManager] Loaded implicit flow credentials from localStorage:',
					credentials
				);
