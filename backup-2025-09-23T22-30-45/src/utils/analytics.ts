...
export class AnalyticsManager {
  ...
  // Track flow complete
  public trackFlowComplete(flowType: string, success: boolean, properties: Record<string, any> = {}): void {
  ...
  // Track flow error
  public trackFlowError(flowType: string, error: string, properties: Record<string, any> = {}): void {
  ...
  public trackPerformanceMetric(metric: string, value: number, properties: Record<string, any> = {}): void {
  ...
  public trackSecurityEvent(event: string, severity: 'low' | 'medium' | 'high' | 'critical', properties: Record<string, any> = {}): void {
...
export const trackFlowComplete = (flowType: string, success: boolean, properties?: Record<string, any>) => {
  analyticsManager.trackFlowComplete(flowType, success, properties);
};

export const trackFlowError = (flowType: string, error: string, properties?: Record<string, any>) => {
...
export const trackSecurityEvent = (event: string, severity: 'low' | 'medium' | 'high' | 'critical', properties?: Record<string, any>) => {
