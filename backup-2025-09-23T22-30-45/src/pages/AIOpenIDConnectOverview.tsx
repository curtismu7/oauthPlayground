...
import { FiBookOpen, FiCode, FiShield, FiUsers, FiCheckCircle, FiAlertTriangle, FiInfo, FiArrowRight, FiTrendingUp } from 'react-icons/fi';
...
const AIOpenIDConnectOverview = () => {
  ...
  const oidcConcepts = [
    {
      title: 'ID Token',
      description: 'JSON Web Token (JWT) signed by the OpenID Provider containing claims about user identity and authentication event.',
      icon: FiUsers,
      examples: ['sub (subject)', 'name', 'email', 'email_verified', 'iss (issuer)', 'aud (audience)']
    },
    {
      title: 'Relying Party (RP)',
      description: 'The client application that requests and verifies the ID Token from the OpenID Provider.',
      icon: FiShield,
      examples: ['Web applications', 'Mobile apps', 'Single Page Apps', 'API services']
    },
    {
      title: 'OpenID Provider (OP)',
      description: 'The authorization server that authenticates users and issues ID Tokens and access tokens.',
      icon: FiBookOpen,
    ...
    <Container>
      <Header>
        <div>
          ...
          <p>
            Comprehensive guide to OpenID Connect authentication flows, security considerations,
            and implementation best practices for modern applications.
          </p>
        </div>
      </Header>
              ...
              <CardBody>
                ...
                <div style={{ marginBottom: '1rem' }}>
                  ...
                  <span style={{
                    ...
                    fontSize: '0.75rem',
                    fontWeight: '500',
                    backgroundColor: flow.security === 'Very High' ? '#dcfce7' :
                                   flow.security === 'High' ? '#dbeafe' :
                                   flow.security === 'Medium-High' ? '#ecfdf5' : '#fef3c7',
                    color: flow.security === 'Very High' ? '#166534' :
                          flow.security === 'High' ? '#1e40af' :
                          flow.security === 'Medium-High' ? '#059669' : '#d97706'
                  }}>
                    {flow.security}
                  </span>
                </div>
...
AS → Client: Validate PKCE & return tokens`}
      ...
      <SecuritySection>
        ...
        <CardBody>
          <p style={{ marginBottom: '1.5rem', color: '#6b7280', lineHeight: '1.6' }}>
            Following security best practices is crucial for protecting user data and maintaining trust.
            Here are the key recommendations for implementing OpenID Connect securely:
          </p>
            ...
            <li>
              ...
              <div>
                ...
                <p style={{ margin: '0.25rem 0', fontSize: '0.875rem', color: '#6b7280' }}>
                  Always use PKCE for enhanced security, especially for public clients without client secrets.
                </p>
              </div>
            </li>
            <li>
      ...
      <section style={{ marginTop: '3rem', padding: '2rem', backgroundColor: '#f8fafc', borderRadius: '0.75rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
          <div>
            ...
            <p style={{ color: '#6b7280', fontSize: '0.875rem', lineHeight: '1.5' }}>
              Use Authorization Code Flow with PKCE. Store tokens securely and implement proper logout flows.
            </p>
          </div>
          <div>
            <h3 style={{ fontSize: '1.125rem', fontWeight: '600', marginBottom: '0.5rem', color: '#374151' }}>
            ...
            <p style={{ color: '#6b7280', fontSize: '0.875rem', lineHeight: '1.5' }}>
              Use Authorization Code Flow with PKCE. Implement secure token storage and certificate pinning.
            </p>
          </div>
          <div>
            <h3 style={{ fontSize: '1.125rem', fontWeight: '600', marginBottom: '0.5rem', color: '#374151' }}>
            ...
            <p style={{ color: '#6b7280', fontSize: '0.875rem', lineHeight: '1.5' }}>
              Validate JWT tokens, implement proper scopes, and use refresh tokens for long-lived sessions.
            </p>
          </div>
        </div>
      </section>
...
export default AIOpenIDConnectOverview;
