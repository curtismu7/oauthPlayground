      ...
      <AppContainer>
        ...
        <MainContent>
          <Routes>
            ...
            <Route path="/flows/oauth2-client-credentials-v3" element={<OAuth2ClientCredentialsFlowV3 />} />
            <Route path="/flows/oidc-client-credentials-v3" element={<OIDCClientCredentialsFlowV3 />} />
            ...
            <Route path="/oauth/resource-owner-password" element={<OAuth2ResourceOwnerPasswordFlow />} />
