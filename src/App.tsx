...
const AppRoutes = () => {
	...
	const { showAuthModal, authRequestData, proceedWithOAuth, closeAuthModal } =
		useAuth();
	...
	useEffect(() => {
		...
		const checkConfiguration = () => {
			...
			try {
				...
				const shouldShowCredentialsModal =
				...
				const skipStartupModal =
					localStorage.getItem("skip_startup_credentials_modal") === "true";
			...
			<AppContainer>
				...
				<MainContent>
					<Routes>
						...
						<Route
							path="/implicit-callback-v3"
							element={<ImplicitCallbackV3 />}
						/>
						<Route
							path="/worker-token-callback"
							element={<WorkerTokenCallback />}
						/>
						...
						<Route
							path="/flows/diagrams"
							element={<InteractiveFlowDiagram />}
						/>
						<Route
						...
						/>
						<Route
							path="/flows/enhanced-authorization-code-v3"
							element={<UnifiedAuthorizationCodeFlowV3 flowType="oidc" />}
						/>
						<Route
						...
						<Route
							...
							element={<OAuth2ImplicitFlowV3 />}
						/>
						<Route
							path="/flows/oidc-implicit-v3"
							element={<OIDCImplicitFlowV3 />}
						/>
						<Route
							path="/flows/oidc-hybrid-v3"
							element={<OIDCHybridFlowV3 />}
						/>
						<Route
						...
						/>
						<Route
							path="/flows/device-code-oidc"
							element={<DeviceCodeFlowOIDC />}
						/>
						<Route
							path="/flows/resource-owner-password"
							element={<ResourceOwnerPasswordFlow />}
						/>
						...
						/>
						<Route
							path="/flows/worker-token-v3"
							element={<WorkerTokenFlowV3 />}
						/>
						...
						<Route path="/oidc" element={<OIDC />}>
							...
							<Route
								...
								element={<OIDCResourceOwnerPasswordFlow />}
							/>
							<Route path="worker-token" element={<WorkerTokenFlow />} />
							<Route path="jwt-bearer" element={<JWTBearerFlow />} />
						...
						<Route
							path="/oidc/tokens"
							element={<Navigate to="/oidc/id-tokens" replace />}
						/>
