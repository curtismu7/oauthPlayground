...
describe('New Component Integration Tests', () => {
  describe('OAuth Detective Component', () => {
    it('should analyze OAuth URLs and extract parameters', () => {
      const testUrl = 'https://auth.pingone.com/authorize?client_id=test&response_type=code&scope=openid&redirect_uri=http://localhost';
    ...
    it('should validate PKCE parameters', () => {
      const pkceUrl = 'https://auth.example.com/authorize?code_challenge=abc123&code_challenge_method=S256';
  ...
  describe('Security Threat Theater', () => {
    ...
    it('should detect token leakage in URL fragments', () => {
      const implicitFlowUrl = 'https://example.com/callback#access_token=secret123&token_type=Bearer';
  ...
  describe('Combined OAuth & OIDC for AI Documentation', () => {
    ...
    it('should provide PingOne compatibility status', () => {
      ...
      Object.entries(pingOneFeatures).forEach(([feature, status]) => {
