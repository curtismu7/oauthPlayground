...
export const OAuthFlowWithRedirectStateManager: React.FC = () => {
  ...
  const handleStep1Complete = useCallback(() => {
    ...
    if (success) {
      ...
      // Generate OAuth URL
      const authorizationUrl = new URL(`https://auth.pingone.com/${credentials.environmentId}/as/authorize`);
  ...
  return (
    <Container>
      ...
      <p style={{ color: '#6b7280', marginBottom: '2rem' }}>
        This example demonstrates how to use RedirectStateManager to preserve flow state across OAuth redirects.
      </p>
