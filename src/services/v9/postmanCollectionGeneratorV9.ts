			...
			events.push({
				...
				script: {
					exec: [
						...
						'            });',
						'            ',
						'            logger.info("✅ Access token saved to environment");',
						'        }',
						'        ',
						...
						'            });',
						'            ',
						'            logger.info("✅ ID token saved to environment");',
						'        }',
						'        ',
						...
						'            });',
						'            ',
						'            logger.info("✅ Refresh token saved to environment");',
						'        }',
						'        ',
			...
			events.push({
				...
				script: {
					exec: [
						...
						'            });',
						'            ',
						'            logger.info("✅ Device code saved to environment");',
						'        }',
						'        ',
			...
			events.push({
				...
				script: {
					exec: [
						...
						'            });',
						'            ',
						'            logger.info("✅ Request URI saved to environment");',
						'        }',
						'        ',
						'        // Extract expiration time',
						'        if (jsonData.expires_in) {',
			...
			events.push({
				...
				script: {
					exec: [
						...
						'        logger.info("✅ User token saved to environment");',
						'    }',
						'    ',
				...
				},
				{
					...
					script: {
						exec: [
							...
							'    logger.info("✅ PKCE codes successfully saved to environment variables");',
							...
							'    });',
							'} else {',
							'    logger.info("❌ PKCE codes generation failed");',
							'}',
						],
						type: 'text/javascript',
					},
		...
		tokenExchangeEvents.push({
			...
			script: {
				exec: [
					...
					'    logger.info("⚠️ Private Key JWT requires RSA signing. Set {{user_client_assertion_jwt_private}} manually.");',
					'}',
				],
				type: 'text/javascript',
			},
...
const generateRandomBaseballPlayerScript = (prefix: string = 'SignUp'): string[] => {
	return [
		...
		'',
		`logger.info("🎲 Randomly selected baseball player: " + selectedPlayer.firstName + " " + selectedPlayer.lastName);`,
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'    logger.info("✅ Population created successfully");',
						'});',
					]
				),
				createUseCaseItem(
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        logger.info("⚠️ User already exists - cannot create duplicate account");',
						'    } else {',
						...
						'            logger.info("📝 Proceed to next step: Create User Account");',
						'        } else {',
				...
				createUseCaseItem(
					...
					[
						...
						'        logger.info("📝 Verification email has been sent to the user\'s email address");',
						'        logger.info("📝 User should check their email for the verification code");',
						'    }',
				...
				createUseCaseItem(
					...
					[
						...
						'        }',
						'        ',
						'        logger.info("📝 User account verification complete - proceed to set password");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						...
						'                logger.info("📝 Make sure you entered the correct OTP code from your email");',
						'            }',
						'        } catch (e2) {',
						'            logger.info("❌ Verification failed - invalid verification code");',
						'            logger.info("📝 Please check your email for the OTP code and update the emailVerificationCode variable");',
						'        }',
						'    }',
						'}',
					],
					[
						'logger.info("");',
						'logger.info("╔════════════════════════════════════════════════════════════════╗");',
						'logger.info("║  ⚠️  REQUIRED: Fill In Environment Variable Before Running  ║");',
						'logger.info("╚════════════════════════════════════════════════════════════════╝");',
						'logger.info("");',
						'logger.info("📝 VARIABLE TO SET: emailVerificationCode");',
						'logger.info("");',
						'logger.info("📧 WHERE TO FIND IT:");',
						'logger.info("   1. Check the email inbox for: " + pm.environment.get("SignUpEmail") || "the user\'s email address");',
						'logger.info("   2. Look for an email from PingOne");',
						'logger.info("   3. The verification code is typically 8 digits");',
						'logger.info("");',
						'logger.info("🔧 HOW TO SET IT:");',
						'logger.info("   1. In Postman, click on the Environment dropdown (top right)");',
						'logger.info("   2. Click the eye icon to view/edit environment variables");',
						'logger.info("   3. Find or create: emailVerificationCode");',
						'logger.info("   4. Enter the OTP code from your email");',
						'logger.info("   5. Save the environment");',
						'logger.info("   6. Then run this request");',
						'logger.info("");',
						...
						'    logger.info("");',
						'    logger.info("❌ ERROR: emailVerificationCode is not set!");',
						'    logger.info("   Please set this variable before running the request.");',
						...
						'    logger.info("   Ready to verify user!");',
						'    logger.info("");',
						'}',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'logger.info("📝 User can now sign in with the new password");',
					],
				...
				createUseCaseItem(
					...
					[
						...
						'        }',
						'        ',
						'        logger.info("📝 Sign-up flow complete - user is ready to sign in");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        logger.info("📝 Sign-up workflow verified - user exists and can be found by username");',
						'    } else {',
						'        logger.info("⚠️ User not found by username - verify sign-up workflow completed successfully");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
				...
				createUseCaseItem(
					...
					[
						...
						'        }',
						'        logger.info("📝 Sign-up workflow verified - user exists and can be found by email");',
						'    } else {',
						'        logger.info("⚠️ User not found by email - verify sign-up workflow completed successfully");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to lookup user:", pm.response.code);',
				...
				createUseCaseItem(
					...
					[
						...
						'    });',
						'    ',
						'    logger.info("✅ User retrieved successfully by User ID");',
						...
						'    }',
						'    logger.info("📝 Sign-up workflow verified - user exists with all expected properties");',
						'    logger.info("📝 Sign-up workflow test complete - user is ready for sign-in");',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    if (pm.response.code === 404) {',
						'        logger.info("❌ User not found - verify SignUpUserID is correct");',
						'    } else {',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'    logger.info("");',
						'    logger.info("╔════════════════════════════════════════════════════════════════╗");',
						'    logger.info("║  ❌  ERROR: redirect_uri is Required for Application Creation  ║");',
						'    logger.info("╚════════════════════════════════════════════════════════════════╝");',
						'    logger.info("");',
						'    logger.info("📝 The redirect_uri environment variable must be set before creating the application.");',
						'    logger.info("");',
						'    logger.info("🔧 HOW TO SET IT:");',
						'    logger.info("   1. In Postman, click on the Environment dropdown (top right)");',
						'    logger.info("   2. Click the eye icon to view/edit environment variables");',
						'    logger.info("   3. Find or create: redirect_uri");',
						'    logger.info("   4. Enter your callback URL (e.g., https://localhost:3000/postman-callback)");',
						'    logger.info("   5. Save the environment");',
						'    logger.info("   6. Then run this request again");',
						'    logger.info("");',
						'    logger.info("💡 EXAMPLE VALUES:");',
						...
						'    logger.info("");',
						'    logger.info("⚠️  The request will fail with validation error if redirect_uri is not set!");',
						'    logger.info("");',
						'    logger.info("📝 NOTE: For Postman collection testing, use https://localhost:3000/postman-callback");',
						'    logger.info("   Make sure this URI is registered in your PingOne application\'s redirect URIs list");',
						'    logger.info("");',
						...
						'    logger.info("✅ Set default redirect_uri to: https://localhost:3000/postman-callback");',
						'    logger.info("   This is the recommended URI for Postman collection testing");',
						'    logger.info("   Update this if you need a different callback URL");',
						'    logger.info("");',
						'} else {',
						'    logger.info("✅ redirect_uri is set: " + redirectUri);',
						'    logger.info("   Ready to create application!");',
						'}',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'        logger.info("✅ Application secret retrieved successfully");',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
				...
				createUseCaseItem(
					...
					[
						...
						'        logger.info("✅ Sign-on policy created successfully");',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
				...
				createUseCaseItem(
					...
					[
						...
						'        logger.info("✅ Login action created successfully");',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
				...
				createUseCaseItem(
					...
					[
						...
						'});',
						'',
						'logger.info("✅ Sign-on policy assigned to application successfully");',
						'logger.info("📝 Application is now configured with the sign-on policy");',
					]
				),
			],
		},
			...
			item: [
				...
				createUseCaseItem(
					...
					[
						...
						'logger.info("📝 User can now sign in with this password");',
					],
					generatePasswordScript()
				),
			],
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        });',
						'    } else {',
						'        logger.error("❌ No \'id\' field found in response.");',
				...
				createUseCaseItem(
					...
					[
						...
						'            logger.info("📝 Username/password required - proceed to submit credentials step");',
						'        } else if (jsonData.status === "COMPLETE" || jsonData.status === "COMPLETED") {',
						'            logger.info("📝 Flow completed - proceed to resume endpoint");',
						'        } else if (jsonData.status === "OTP_REQUIRED") {',
						'            logger.info("📝 MFA required - proceed to MFA challenge step");',
						'        }',
						'    }',
						'    ',
						'    if (jsonData.resumeUrl) {',
						'        pm.environment.set("resumeUrl", jsonData.resumeUrl);',
						'        logger.info("✅ Resume URL saved: " + jsonData.resumeUrl);',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
				...
				createUseCaseItem(
					...
					[
						...
						'            logger.info("📝 MFA required - proceed to MFA challenge step");',
						'        } else if (jsonData.status === "COMPLETE" || jsonData.status === "COMPLETED") {',
						'            logger.info("📝 Login successful - proceed to resume endpoint");',
						'        }',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ Authorization code retrieved successfully");',
						'        logger.info("📝 Proceed to exchange code for tokens");',
						'    } else {',
						'        logger.error("❌ Authorization code not found in response.");',
				...
				createUseCaseItem(
					...
					[
						...
						'    });',
						'    ',
						'    logger.info("✅ Token exchange completed - user is now authenticated");',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
						'        pm.expect.fail("Failed to parse response as JSON: " + e.message);',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'            logger.info("📝 Proceed to create SMS device");',
						'        } else {',
						'            logger.info("⚠️ Policy found but no ID available");',
						'        }',
						'    } else {',
						'        logger.info("⚠️ No device authentication policies found in the environment");',
						'        logger.info("   You must create at least one MFA policy before registering devices");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        logger.info("📝 Proceed to get device authentication policies");',
						'    } else {',
						'        logger.info("⚠️ User not found - verify username is correct");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to lookup user:", pm.response.code);',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'            logger.info("📝 OTP code has been sent to phone number");',
						'            logger.info("📝 Proceed to step 4: Activate Device with OTP");',
						'        }',
						'    } else {',
						'        logger.info("⚠️ Device created but no ID in response");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ SMS device activated successfully");',
						'        ',
						'        if (pm.response.code === 200) {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.status) {',
						...
						'                    logger.info("✅ Device is now ACTIVE and ready for MFA");',
						'                    logger.info("📝 MFA enrollment complete - device can be used for login-time MFA");',
						'                }',
						'            }',
						'            if (jsonData.id) {',
						'                pm.environment.set("deviceId", jsonData.id);',
						...
						'            logger.info("📝 MFA enrollment complete - device is now ACTIVE");',
						'        }',
						...
						'                    logger.info("   OTP code is incorrect or expired - user should retry with correct code");',
						'                }',
						'            }',
						'        } catch (e2) {',
						'            logger.info("❌ Activation failed - invalid OTP code");',
						'        }',
						'    } else if (pm.response.code === 404) {',
						'        logger.info("❌ Device not found - verify deviceId is correct");',
						'    } else {',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'            logger.info("📝 OTP code has been sent to device");',
						...
						'            logger.info("📝 Device selection required - proceed to step 2: Select Device");',
						'        }',
						'        ',
						...
						// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
						'                logger.info(`   ${index + 1}. ${device.type} - ${device.nickname || device.id}`);',
						'            });',
						'        }',
						'    } else {',
						'        logger.info("⚠️ Authentication initialized but no ID in response");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
				...
				createUseCaseItem(
					...
					[
						...
						'            const jsonData = pm.response.json();',
						'            if (jsonData.status === "OTP_REQUIRED" || jsonData.nextStep === "OTP_REQUIRED") {',
						'                logger.info("📝 OTP code has been sent to selected device");',
						'                logger.info("📝 Proceed to step 3: Check OTP Code");',
						'            }',
				...
				createUseCaseItem(
					...
					[
						...
						'                    logger.info("✅ MFA challenge complete - user can proceed with login");',
						'                    logger.info("📝 Device authentication successful");',
						'                } else if (jsonData.status === "OTP_REQUIRED") {',
						'                    logger.info("⚠️ OTP still required - verification may have failed");',
						'                }',
						'            }',
						'            if (jsonData._links && jsonData._links.complete) {',
						'                logger.info("📝 Next: Complete device authentication if needed");',
						'            }',
						'        } else {',
						'            // Response may be empty (204 No Content)',
						'            logger.info("✅ OTP validation successful (204 No Content)");',
						'            logger.info("📝 MFA challenge complete - proceed with login");',
						'        }',
						...
						'            }',
						'        } catch (e2) {',
						'            logger.info("❌ OTP validation failed - invalid or expired OTP code");',
						'        }',
						'    } else if (pm.response.code === 404) {',
						'        logger.info("❌ Device authentication session not found - verify deviceAuthenticationId is correct");',
						'    } else {',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        logger.info("✅ User found:", user.id);',
						'        logger.info("   Email:", user.email?.address || user.email || "N/A");',
						'        logger.info("📝 Proceed to step 2: Send Recovery Code to email");',
						'    } else {',
						"        // Security best practice: Don't reveal if user exists or not",
						'        logger.info("⚠️ User lookup completed - proceed if user exists");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to lookup user:", pm.response.code);',
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ Recovery code sent successfully to user\'s email");',
						'        ',
						'        if (pm.response.code === 200) {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.message) {',
						...
						'        }',
						'        ',
						'        logger.info("📝 User should check their email for the recovery code");',
						'        logger.info("📝 Proceed to step 3: Validate Recovery Code");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ Recovery code validated successfully");',
						'        ',
						'        if (pm.response.code === 200) {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.message) {',
						...
						'        }',
						'        ',
						'        logger.info("✅ Account recovery complete - user can now sign in");',
						'        logger.info("📝 User password has been reset as part of recovery process");',
						'    } else if (pm.response.code === 400 || pm.response.code === 401) {',
						'        try {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.message) {',
						...
						'                    logger.info("   Recovery code is incorrect or expired - user should check email and try again");',
						'                }',
						'            }',
						...
						'            }',
						'        } catch (e2) {',
						'            logger.info("❌ Recovery code validation failed - invalid or expired code");',
						'        }',
						'    } else if (pm.response.code === 404) {',
						'        logger.info("❌ User not found - verify userId is correct");',
						'    } else {',
	...
	const changePasswordItems: PostmanCollectionItem[] = [
		...
		createUseCaseItem(
			...
			[
				...
				'});',
				'',
				'logger.info("✅ Force password change set successfully");',
				'logger.info("📝 User will be prompted to change password on next sign-in");',
			]
		),
	];
	...
	const socialLoginItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				'        logger.info("📝 Facebook login option is now available in PingOne authentication flows");',
				'    } else {',
				'        logger.info("⚠️ Facebook IdP configured but no ID in response");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
		...
		createUseCaseItem(
			...
			[
				...
				'        logger.info("   Enabled:", jsonData.enabled !== false ? "true" : "false");',
				'        logger.info("📝 LinkedIn login option is now available in PingOne authentication flows");',
				'    } else {',
				'        logger.info("⚠️ LinkedIn IdP configured but no ID in response");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
	...
	const federationItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				'        }',
				'        logger.info("📝 Azure AD enterprise federation is now available in PingOne authentication flows");',
				'        logger.info("📝 Users can sign in with their organization credentials");',
				'    } else {',
				'        logger.info("⚠️ Azure AD IdP configured but no ID in response");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
	...
	const riskCheckItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				'            logger.info(`\\n   Predictor ${index + 1}:`);',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`      ID: ${predictor.id}`);',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`      Name: ${predictor.name || "N/A"}`);',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`      Type: ${predictor.type || "N/A"}`);',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`      Enabled: ${predictor.enabled !== false ? "true" : "false"}`);',
				'            if (predictor.description) {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      Description: ${predictor.description}`);',
				'            }',
				'        });',
				'        ',
				...
				'        logger.info("📝 Proceed to create or update risk evaluations using these predictors");',
				'    } else {',
				'        logger.info("⚠️ Response structure unexpected - no _embedded.riskPredictors found");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
		...
		createUseCaseItem(
			...
			[
				...
				'    });',
				'    ',
				'    logger.info("✅ Risk evaluation updated successfully");',
				'    ',
				'    if (jsonData.id) {',
				...
				'    logger.info("📝 This feedback helps PingOne Protect improve future risk assessments");',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 400) {',
				'        try {',
				...
				'            }',
				'        } catch (e2) {',
				'            logger.info("❌ Failed to update risk evaluation - invalid request");',
				'        }',
				'    } else if (pm.response.code === 404) {',
				'        logger.info("❌ Risk evaluation not found - verify riskEvaluationId is correct");',
				'        logger.info("   Create a risk evaluation first to obtain a valid evaluation ID");',
				'    } else {',
	...
	const logoutItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      IP Address: ${session.ipAddress}`);',
				'            }',
				'            if (session.userAgent) {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      User Agent: ${session.userAgent}`);',
				'            }',
				'            if (session.createdAt) {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      Created At: ${session.createdAt}`);',
				'            }',
				...
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      Environment: ${session.environment.id || session.environment}`);',
				'            }',
				'        });',
				'        ',
				...
				'            logger.info("📝 Proceed to step 4 or 5 to delete this session or verify token status");',
				'        } else {',
				'            logger.info("\\n📝 No active sessions found for this user");',
				'        }',
				'    } else {',
				'        logger.info("⚠️ Response structure unexpected - no _embedded.sessions found");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 404) {',
		...
		createUseCaseItem(
			...
			[
				...
				'        }',
				'        ',
				'        logger.info("📝 User session has been invalidated");',
				'        logger.info("📝 Proceed to step 3 to revoke refresh token, or step 5 to verify token status");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 401 || pm.response.code === 403) {',
				'        logger.info("❌ Session end failed - invalid or expired access token");',
				'    } else {',
		...
		createUseCaseItem(
			...
			[
				...
				'        }',
				'        ',
				'        logger.info("📝 Refresh token can no longer be used to obtain new access tokens");',
				'        logger.info("📝 Logout flow complete - all tokens have been invalidated");',
				...
				'                    logger.info("   Token is invalid or already revoked");',
				'                }',
				'            }',
				'            if (jsonData.error_description) {',
				'                logger.info("   Error description:", jsonData.error_description);',
				'            }',
				'        } catch (e2) {',
				'            logger.info("❌ Token revocation failed - invalid token or client credentials");',
				'        }',
				'    } else {',
		...
		createUseCaseItem(
			...
			[
				...
				'        logger.info("📝 User is now logged out from that specific device/browser");',
				'        logger.info("📝 Proceed to step 1 again to verify session has been removed from active sessions list");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 404) {',
				'        logger.info("❌ Session not found - session may have already expired or been deleted");',
				'        logger.info("   Verify sessionId is correct or session may have expired");',
				'    } else if (pm.response.code === 403) {',
				'        logger.info("❌ Permission denied - verify worker token has appropriate permissions");',
				'    } else {',
		...
		createUseCaseItem(
			...
			[
				...
				'        logger.info("⚠️ Token is still ACTIVE");',
				'        logger.info("   This token has not been revoked and can still be used");',
				'        if (jsonData.exp) {',
				...
				'        logger.info("   This token has been revoked or has expired");',
				'        logger.info("   Token cannot be used for authentication");',
				'    }',
				'    ',
				'    if (jsonData.sub) {',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'            logger.info("✅ Worker token saved to environment variable");',
									'            ',
									'            if (jsonData.expires_in) {',
									'                logger.info("📝 Token expires in:", jsonData.expires_in, "seconds");',
									'            }',
									'        } else {',
									'            logger.info("❌ No access_token in response");',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'',
									'// Log success message',
									'logger.info("✅ JWT assertion generated successfully");',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'    logger.info("⚠️ Private Key JWT requires RSA signing. Set {{client_assertion_jwt_private}} manually.");',
									'}',
								],
								type: 'text/javascript',
							},
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'                logger.info("   💡 Tip: Verify client_id and client_secret are correct");',
								'            } else if (jsonData.error === "invalid_scope") {',
								'                logger.info("   💡 Tip: Verify requested scopes are valid for this client");',
								'            }',
								'        }',
								'    } catch (e) {',
								'        // Response may not be JSON',
					...
					},
					{
						...
						script: {
							exec: [
								...
								'            // Common errors',
								'            if (jsonData.error === "invalid_client") {',
								'                logger.info("   💡 Tip: Verify user_client_id and user_client_secret in Authorization header are correct");',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'        logger.info("   👤 User must enter this code at verification URI");',
								'    }',
								'    ',
								...
								'    logger.info("   3. User authenticates and authorizes");',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'        logger.info("⏳ Authorization pending - user has not authorized yet");',
								...
								'        logger.info("⚠️ Slow down - polling too frequently");',
								...
								'        logger.info("❌ Device code expired - restart flow from Request Device Authorization step");',
								'        pm.environment.unset("device_code");',
								'        pm.environment.unset("user_code");',
								'    } else if (jsonData.error === "access_denied") {',
								'        logger.info("❌ User denied authorization - restart flow from Request Device Authorization step");',
								'        pm.environment.unset("device_code");',
								'        pm.environment.unset("user_code");',
								'    } else {',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    logger.info("✅ Authorization URL generated for OAuth 2.0 Implicit Flow");',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    if (locationHeader) {',
								'        logger.info("✅ Authorization URL generated for Hybrid Flow");',
								...
								'        logger.info("   2. User is redirected to redirect_uri with tokens in fragment");',
								'        logger.info("   3. Extract code and id_token from redirect URL fragment");',
								'        logger.info("   4. Call Exchange Authorization Code step to get access_token");',
								'    }',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'        logger.info("   💡 ID token already received - no need to wait for token exchange!");',
								'    }',
								'    ',
								...
								'        } else {',
								'            logger.info("⚠️ State mismatch - possible CSRF attack!");',
								'        }',
								'    }',
								'}',
								'',
								...
								'}',
								'',
								'logger.info("📋 Hybrid Flow callback parsed:");',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    }',
								'    ',
								'    logger.info("✅ Hybrid Flow completed successfully!");',
								...
								'    logger.info("   - Refresh token: Received if offline_access scope requested");',
								'} else {',
								'    logger.info("❌ Token exchange failed:", pm.response.code);',
								'    try {',
								'        const jsonData = pm.response.json();',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'            } else if (jsonData.error === "invalid_scope") {',
								'                logger.info("   💡 Tip: Verify requested scopes are valid for this client");',
								'                logger.info("   💡 Tip: Request openid scope to receive id_token");',
								'            }',
								'        }',
								'    } catch (e) {',
								'        // Response may not be JSON',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'            logger.info("⚠️ MFA required - call Check Username/Password again with otp_code");',
									'        } else if (jsonData.status === "COMPLETE" || jsonData.status === "READY_TO_RESUME") {',
									'            logger.info("✅ Credentials validated - proceed to Get Auth Code step");',
									'        }',
									'    }',
									'    ',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'        }',
									'    } catch (e) {',
									'        logger.info("⚠️ Could not parse JSON response");',
									'    }',
									'} else {',
						...
						},
						{
							...
							script: {
								exec: [
									...
									'    logger.info("⚠️ User can now proceed with normal authentication flow");',
									'    ',
