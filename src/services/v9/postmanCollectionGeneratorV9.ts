/**
 * @file postmanCollectionGeneratorV9.ts
 * @module services/v9
...
export const generatePostmanCollection = (
	...
	const flowTypeLabels: Record<V9FlowType, string> = {
			...
			events.push({
				...
				script: {
					exec: [
						...
						'            });',
						'            ',
						'            logger.info("✅ Access token saved to environment", "Logger info");',
						'        }',
						'        ',
						...
						'            });',
						'            ',
						'            logger.info("✅ ID token saved to environment", "Logger info");',
						'        }',
						'        ',
						...
						'            });',
						'            ',
						'            logger.info("✅ Refresh token saved to environment", "Logger info");',
						'        }',
						'        ',
						...
						'        });',
						'    } else {',
						'        logger.info("❌ Token exchange failed:", pm.response.code);',
						'        logger.info("Response:", pm.response.text());',
						'        pm.test("❌ Token exchange should return 200", function() {',
						'            pm.expect.fail("Token exchange failed with status: " + pm.response.code);',
						'        });',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
			...
			events.push({
				...
				script: {
					exec: [
						...
						'            });',
						'            ',
						'            logger.info("✅ Device code saved to environment", "Logger info");',
						'        }',
						'        ',
						...
						'            });',
						'            ',
						'            logger.info("✅ User code saved to environment:", jsonData.user_code);',
						'        }',
						'        ',
						'        // Extract verification URI',
						'        if (jsonData.verification_uri) {',
						'            pm.environment.set("verification_uri", jsonData.verification_uri);',
						'            logger.info("✅ Verification URI:", jsonData.verification_uri);',
						'        }',
						'        ',
						...
						'        });',
						'    } else {',
						'        logger.info("❌ Device authorization failed:", pm.response.code);',
			...
			events.push({
				...
				script: {
					exec: [
						...
						'            });',
						'            ',
						'            logger.info("✅ Request URI saved to environment", "Logger info");',
						'        }',
						'        ',
						'        // Extract expiration time',
						'        if (jsonData.expires_in) {',
						...
						'        });',
						'    } else {',
						'        logger.info("❌ PAR request failed:", pm.response.code);',
			...
			events.push({
				...
				script: {
					exec: [
						...
						'            });',
						'            ',
						'            logger.info("✅ User ID saved to environment:", userId);',
						'        } else if (jsonData.id) {',
						...
						'            });',
						'            ',
						'            logger.info("✅ User ID saved to environment:", jsonData.id);',
						'        }',
						'    } else {',
						'        logger.info("❌ User lookup failed:", pm.response.code);',
			...
			events.push({
				...
				script: {
					exec: [
						...
						'            });',
						'            ',
						'            logger.info("✅ Device ID saved to environment:", jsonData.id);',
						'        }',
						'        ',
						...
						'            logger.info("✅ Policy ID saved to environment:", jsonData.policy.id);',
						'        }',
						'    } else {',
						'        logger.info("❌ Device creation failed:", pm.response.code);',
			...
			events.push({
				...
				script: {
					exec: [
						...
						'            });',
						'            ',
						'            logger.info("✅ Device Authentication ID saved to environment:", jsonData.id);',
						'        }',
						'    } else {',
						'        logger.info("❌ Device authentication initialization failed:", pm.response.code);',
			...
			events.push({
				...
				script: {
					exec: [
						...
						'        logger.info("✅ User token saved to environment", "Logger info");',
						'    }',
						'    ',
			...
			event: [
				{
					...
					script: {
						exec: [
							...
							'',
							'logger.info("✅ PKCE codes generated:", "Logger info");',
							'logger.info("   Code Verifier:", codeVerifier);',
							'logger.info("   Code Challenge:", codeChallenge);',
							'logger.info("   Method: S256", "Logger info");',
						],
						type: 'text/javascript',
					},
				},
				{
					...
					script: {
						exec: [
							...
							'    logger.info("✅ PKCE codes successfully saved to environment variables", "Logger info");',
							...
							'    });',
							'} else {',
							'    logger.info("❌ PKCE codes generation failed", "Logger info");',
							'}',
						],
						type: 'text/javascript',
					},
		...
		tokenExchangeEvents.push({
			...
			script: {
				exec: [
					...
					'    logger.info("⚠️ Private Key JWT requires RSA signing. Set {{user_client_assertion_jwt_private}} manually.", "Logger info");',
					'}',
				],
				type: 'text/javascript',
			},
...
const generateRandomBaseballPlayerScript = (prefix: string = 'SignUp'): string[] => {
	return [
		...
		'',
		`logger.info("🎲 Randomly selected baseball player: " + selectedPlayer.firstName + " " + selectedPlayer.lastName, "Logger info");`,
		`logger.info("📝 Generated username: " + pm.environment.get("${prefix}Username"));`,
		`logger.info("📧 Generated email: " + pm.environment.get("${prefix}Email"));`,
	];
};
...
const generatePasswordScript = (): string[] => {
	return [
		...
		'logger.info("🔐 Generated password: " + generatedPassword, "Logger info");',
		'logger.info("📝 Password variables (userPassword, newPassword) set for use in request");',
	];
};
...
const generateUseCasesItems = (
	 ...
	 */
	const extractUserFilledVariables = (
	...
	const createUseCaseItem = (
		...
		if (userFilledVariables.length > 0) {
			...
			enhancedDescription +=
				'**💡 Tip:** Check the Pre-request Script tab for detailed instructions on where to find these values.\n';
		}
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'    });',
						'    ',
						'    logger.info("SignUpPopID is now: " + pm.environment.get("SignUpPopID"));',
						'    logger.info("✅ Population created successfully", "Logger info");',
						'});',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'    });',
						'    ',
						'    logger.info("groupId is now: " + pm.environment.get("groupId"));',
						'    logger.info("✅ Group created successfully", "Logger info");',
						'});',
					]
				),
			],
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("userId is now: " + pm.environment.get("userId"));',
						'        logger.info("✅ User found:", user.id, "- username:", user.username || "N/A");',
						'        logger.info("⚠️ User already exists - cannot create duplicate account", "Logger info");',
						'    } else {',
						...
						'            logger.info("✅ User not found - username saved for account creation:", username);',
						'            logger.info("📝 Proceed to next step: Create User Account", "Logger info");',
						'        } else {',
						'            logger.info("⚠️ User not found, but username not available in filter or environment");',
						'        }',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						...
						'        if (username) {',
						'            pm.environment.set("username", username);',
						'            logger.info("✅ User not found (404) - username saved for account creation:", username);',
						'        }',
						'    }',
						'}',
					]
				...
				createUseCaseItem(
					...
					[
						...
						'    });',
						'    ',
						'    logger.info("SignUpUserID is now: " + pm.environment.get("SignUpUserID"));',
						'    logger.info("SignUpUsername is now: " + pm.environment.get("SignUpUsername"));',
						'    logger.info("username is now: " + pm.environment.get("username"));',
						'    logger.info("✅ User created successfully", "Logger info");',
						'    ',
						'    if (jsonData.verifyStatus) {',
						'        logger.info("📝 User verifyStatus:", jsonData.verifyStatus);',
						'        logger.info("📝 Verification email has been sent to the user\'s email address", "Logger info");',
						'        logger.info("📝 User should check their email for the verification code", "Logger info");',
						'    }',
						'    if (jsonData.lifecycle && jsonData.lifecycle.status) {',
						'        logger.info("📝 User lifecycle status:", jsonData.lifecycle.status);',
						'    }',
						'});',
					],
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ User verified successfully", "Logger info");',
						'        ',
						'        if (pm.response.code === 200) {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.emailVerified !== undefined) {',
						'                pm.environment.set("emailVerified", jsonData.emailVerified);',
						'                logger.info("   Email verified:", jsonData.emailVerified);',
						'            }',
						'            if (jsonData.lifecycle && jsonData.lifecycle.status) {',
						'                pm.environment.set("userStatus", jsonData.lifecycle.status);',
						'                logger.info("   User status:", jsonData.lifecycle.status);',
						'            }',
						'        }',
						'        ',
						'        logger.info("📝 User account verification complete - proceed to set password", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						...
						'            const jsonData = pm.response.json();',
						'            if (jsonData.message) {',
						'                logger.info("❌ Verification failed:", jsonData.message);',
						'                logger.info("📝 Make sure you entered the correct OTP code from your email", "Logger info");',
						'            }',
						'        } catch (e2) {',
						'            logger.info("❌ Verification failed - invalid verification code", "Logger info");',
						'            logger.info("📝 Please check your email for the OTP code and update the emailVerificationCode variable", "Logger info");',
						'        }',
						'    }',
						'}',
					],
					[
						...
						'logger.info("╔════════════════════════════════════════════════════════════════╗", "Logger info");',
						'logger.info("║  ⚠️  REQUIRED: Fill In Environment Variable Before Running  ║", "Logger info");',
						'logger.info("╚════════════════════════════════════════════════════════════════╝", "Logger info");',
						'logger.info("", "Logger info");',
						'logger.info("📝 VARIABLE TO SET: emailVerificationCode", "Logger info");',
						'logger.info("", "Logger info");',
						'logger.info("📧 WHERE TO FIND IT:", "Logger info");',
						'logger.info("   1. Check the email inbox for: " + pm.environment.get("SignUpEmail") || "the user\'s email address");',
						'logger.info("   2. Look for an email from PingOne", "Logger info");',
						'logger.info("   3. The verification code is typically 8 digits", "Logger info");',
						'logger.info("", "Logger info");',
						'logger.info("🔧 HOW TO SET IT:", "Logger info");',
						'logger.info("   1. In Postman, click on the Environment dropdown (top right)");',
						'logger.info("   2. Click the eye icon to view/edit environment variables", "Logger info");',
						'logger.info("   3. Find or create: emailVerificationCode", "Logger info");',
						'logger.info("   4. Enter the OTP code from your email", "Logger info");',
						'logger.info("   5. Save the environment", "Logger info");',
						'logger.info("   6. Then run this request", "Logger info");',
						'logger.info("", "Logger info");',
						'logger.info("💡 EXAMPLE VALUE: 12345678 (your actual code will be different)");',
						'logger.info("", "Logger info");',
						'logger.info("═══════════════════════════════════════════════════════════════════", "Logger info");',
						'',
						...
						'    logger.info("", "Logger info");',
						'    logger.info("❌ ERROR: emailVerificationCode is not set!", "Logger info");',
						'    logger.info("   Please set this variable before running the request.", "Logger info");',
						'    logger.info("   The request will still run, but it will likely fail.");',
						'    logger.info("", "Logger info");',
						'} else {',
						'    logger.info("✅ emailVerificationCode is set: " + emailVerificationCode.substring(0, 2) + "******");',
						'    logger.info("   Ready to verify user!", "Logger info");',
						'    logger.info("", "Logger info");',
						'}',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'});',
						'',
						'logger.info("✅ Password set successfully", "Logger info");',
						'logger.info("📝 User can now sign in with the new password", "Logger info");',
					],
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ User successfully added to group", "Logger info");',
						'        ',
						'        const jsonData = pm.response.json();',
						'        if (jsonData && jsonData.id) {',
						'            logger.info("   Group ID:", jsonData.id);',
						'            logger.info("   Group name:", jsonData.name || "N/A");',
						'        }',
						'        ',
						'        logger.info("📝 Sign-up flow complete - user is ready to sign in", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ User found by username:", user.username);',
						'        logger.info("   User ID:", user.id);',
						'        logger.info("   Email:", user.email?.address || user.email || "N/A");',
						'        logger.info("📝 Sign-up workflow verified - user exists and can be found by username", "Logger info");',
						'    } else {',
						'        logger.info("⚠️ User not found by username - verify sign-up workflow completed successfully", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to lookup user:", pm.response.code);',
						'}',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ User found by email:", user.email?.address || user.email);',
						'        logger.info("   User ID:", user.id);',
						'        logger.info("   Username:", user.username || "N/A");',
						'        if (user.verifyStatus) {',
						'            logger.info("   Email Verified:", user.verifyStatus === "VERIFIED" ? "Yes" : "No");',
						'        }',
						'        logger.info("📝 Sign-up workflow verified - user exists and can be found by email", "Logger info");',
						'    } else {',
						'        logger.info("⚠️ User not found by email - verify sign-up workflow completed successfully", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to lookup user:", pm.response.code);',
				...
				createUseCaseItem(
					...
					[
						...
						'    });',
						'    ',
						'    logger.info("✅ User retrieved successfully by User ID", "Logger info");',
						'    logger.info("   User ID:", jsonData.id);',
						'    logger.info("   Username:", jsonData.username || "N/A");',
						'    logger.info("   Email:", jsonData.email?.address || jsonData.email || "N/A");',
						'    if (jsonData.verifyStatus) {',
						'        logger.info("   Email Verified:", jsonData.verifyStatus === "VERIFIED" ? "Yes" : "No");',
						'    }',
						'    if (jsonData.lifecycle && jsonData.lifecycle.status) {',
						'        logger.info("   Lifecycle Status:", jsonData.lifecycle.status);',
						'    }',
						'    if (jsonData.createdAt) {',
						'        logger.info("   Created At:", jsonData.createdAt);',
						'    }',
						'    logger.info("📝 Sign-up workflow verified - user exists with all expected properties", "Logger info");',
						'    logger.info("📝 Sign-up workflow test complete - user is ready for sign-in", "Logger info");',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    if (pm.response.code === 404) {',
						'        logger.info("❌ User not found - verify SignUpUserID is correct", "Logger info");',
						'    } else {',
						'        logger.info("❌ Failed to retrieve user:", pm.response.code);',
						'    }',
						'}',
					]
				),
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("webAppSignInWithPKCEId is now: " + pm.environment.get("webAppSignInWithPKCEId"));',
						'        logger.info("✅ Web application created successfully", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
					...
					[
						...
						'    logger.info("", "Logger info");',
						'    logger.info("╔════════════════════════════════════════════════════════════════╗", "Logger info");',
						'    logger.info("║  ❌  ERROR: redirect_uri is Required for Application Creation  ║", "Logger info");',
						'    logger.info("╚════════════════════════════════════════════════════════════════╝", "Logger info");',
						'    logger.info("", "Logger info");',
						'    logger.info("📝 The redirect_uri environment variable must be set before creating the application.", "Logger info");',
						'    logger.info("", "Logger info");',
						'    logger.info("🔧 HOW TO SET IT:", "Logger info");',
						'    logger.info("   1. In Postman, click on the Environment dropdown (top right)");',
						'    logger.info("   2. Click the eye icon to view/edit environment variables", "Logger info");',
						'    logger.info("   3. Find or create: redirect_uri", "Logger info");',
						'    logger.info("   4. Enter your callback URL (e.g., https://localhost:3000/postman-callback)");',
						'    logger.info("   5. Save the environment", "Logger info");',
						'    logger.info("   6. Then run this request again", "Logger info");',
						'    logger.info("", "Logger info");',
						'    logger.info("💡 EXAMPLE VALUES:", "Logger info");',
						'    logger.info("   - https://localhost:3000/postman-callback (default for Postman testing)");',
						'    logger.info("   - https://oauth.pstmn.io/v1/callback (Postman OAuth helper - desktop)");',
						'    logger.info("   - https://oauth.pstmn.io/v1/browser-callback (Postman OAuth helper - web)");',
						'    logger.info("   - https://your-app.com/callback (your production app)");',
						'    logger.info("", "Logger info");',
						'    logger.info("⚠️  The request will fail with validation error if redirect_uri is not set!", "Logger info");',
						'    logger.info("", "Logger info");',
						'    logger.info("📝 NOTE: For Postman collection testing, use https://localhost:3000/postman-callback");',
						'    logger.info("   Make sure this URI is registered in your PingOne application\'s redirect URIs list", "Logger info");',
						'    logger.info("", "Logger info");',
						...
						'    logger.info("✅ Set default redirect_uri to: https://localhost:3000/postman-callback", "Logger info");',
						'    logger.info("   This is the recommended URI for Postman collection testing", "Logger info");',
						'    logger.info("   Update this if you need a different callback URL", "Logger info");',
						'    logger.info("", "Logger info");',
						'} else {',
						'    logger.info("✅ redirect_uri is set: " + redirectUri, "Logger info");',
						'    logger.info("   Ready to create application!", "Logger info");',
						'}',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("SignInWithPKCEAppSecret is now: " + pm.environment.get("SignInWithPKCEAppSecret"));',
						'        logger.info("✅ Application secret retrieved successfully", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("SignInSignonPolicyID is now: " + pm.environment.get("SignInSignonPolicyID"));',
						'        logger.info("✅ Sign-on policy created successfully", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("signInLoginPolicyActionID is now: " + pm.environment.get("signInLoginPolicyActionID"));',
						'        logger.info("✅ Login action created successfully", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
				...
				createUseCaseItem(
					...
					[
						...
						'});',
						'',
						'logger.info("✅ Sign-on policy assigned to application successfully", "Logger info");',
						'logger.info("📝 Application is now configured with the sign-on policy", "Logger info");',
					]
				),
			],
		},
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'    });',
						'    ',
						'    logger.info("SignInPopID is now: " + pm.environment.get("SignInPopID"));',
						'    logger.info("✅ Population created successfully", "Logger info");',
						'});',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'    });',
						'    ',
						'    logger.info("SignInUserID is now: " + pm.environment.get("SignInUserID"));',
						'    logger.info("SignInUsername is now: " + pm.environment.get("SignInUsername"));',
						'    logger.info("username is now: " + pm.environment.get("username"));',
						'    logger.info("✅ User created successfully", "Logger info");',
						'});',
					],
				...
				createUseCaseItem(
					...
					[
						...
						'});',
						'',
						'logger.info("✅ User password set successfully", "Logger info");',
						'logger.info("📝 User can now sign in with this password", "Logger info");',
					],
					generatePasswordScript()
				),
			],
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        logger.info("flowID set to:", json.id);',
						'        ',
						...
						'        });',
						'    } else {',
						'        logger.error("❌ No \'id\' field found in response.", "Logger error");',
						...
						'                logger.info("✅ flowID extracted from Location header:", flowIdMatch[1]);',
						'                ',
					...
					[
						...
						'logger.info("PKCE Code Verifier:", codeVerifier);',
						'logger.info("PKCE Code Challenge:", codeChallenge);',
					]
				),
				createUseCaseItem(
					'Step 2: Get the flow',
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ Flow retrieved successfully, status: " + jsonData.status);',
						'        ',
						'        if (jsonData.status === "USERNAME_PASSWORD_REQUIRED" || jsonData.status === "LOGIN_REQUIRED") {',
						'            logger.info("📝 Username/password required - proceed to submit credentials step", "Logger info");',
						'        } else if (jsonData.status === "COMPLETE" || jsonData.status === "COMPLETED") {',
						'            logger.info("📝 Flow completed - proceed to resume endpoint", "Logger info");',
						'        } else if (jsonData.status === "OTP_REQUIRED") {',
						'            logger.info("📝 MFA required - proceed to MFA challenge step", "Logger info");',
						'        }',
						'    }',
						'    ',
						'    if (jsonData.resumeUrl) {',
						'        pm.environment.set("resumeUrl", jsonData.resumeUrl);',
						'        logger.info("✅ Resume URL saved: " + jsonData.resumeUrl, "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ Login credentials submitted, returned status of: " + jsonData.status);',
						'        ',
						'        if (jsonData.status === "OTP_REQUIRED") {',
						'            logger.info("📝 MFA required - proceed to MFA challenge step", "Logger info");',
						'        } else if (jsonData.status === "COMPLETE" || jsonData.status === "COMPLETED") {',
						'            logger.info("📝 Login successful - proceed to resume endpoint", "Logger info");',
						'        }',
						'    }',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
				...
				createUseCaseItem(
					...
					[
						...
						'        logger.info("authCode saved:", json.authorizeResponse.code);',
						'        ',
						...
						'        });',
						'        ',
						'        logger.info("✅ Authorization code retrieved successfully", "Logger info");',
						'        logger.info("📝 Proceed to exchange code for tokens", "Logger info");',
						'    } else {',
						'        logger.error("❌ Authorization code not found in response.", "Logger error");',
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("access_token is now: " + pm.environment.get("access_token"));',
						'        logger.info("✅ Access token retrieved successfully", "Logger info");',
						'    }',
						'    ',
						'    if (jsonData.id_token) {',
						'        pm.environment.set("id_token", jsonData.id_token);',
						...
						'                    ',
						'                    logger.info("userId is now: " + pm.environment.get("userId"));',
						'                    logger.info("✅ User ID extracted from ID token:", payload.sub);',
						'                }',
						'            } catch (e) {',
						'                logger.info("❌ There was an error parsing ID token", e);',
						'            }',
						'        }',
						'        ',
						'        logger.info("✅ ID token retrieved successfully", "Logger info");',
						'    }',
						'    ',
						'    if (jsonData.refresh_token) {',
						'        pm.environment.set("refresh_token", jsonData.refresh_token);',
						...
						'        });',
						'        ',
						'        logger.info("refresh_token is now: " + pm.environment.get("refresh_token"));',
						'        logger.info("✅ Refresh token saved", "Logger info");',
						'    }',
						'    ',
						...
						'    });',
						'    ',
						'    logger.info("✅ Token exchange completed - user is now authenticated", "Logger info");',
						'} catch (e) {',
						'    logger.info("❌ There was an error parsing JSON", e);',
						'    pm.test("❌ Response should be valid JSON", function() {',
						'        pm.expect.fail("Failed to parse response as JSON: " + e.message);',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'            });',
						'            ',
						'            logger.info("deviceAuthenticationPolicyId is now: " + pm.environment.get("deviceAuthenticationPolicyId"));',
						'            logger.info("✅ Device authentication policy ID saved:", firstPolicy.id);',
						'            logger.info("   Policy name:", firstPolicy.name || "N/A");',
						'            logger.info("📝 Proceed to create SMS device", "Logger info");',
						'        } else {',
						'            logger.info("⚠️ Policy found but no ID available", "Logger info");',
						'        }',
						'    } else {',
						'        logger.info("⚠️ No device authentication policies found in the environment", "Logger info");',
						'        logger.info("   You must create at least one MFA policy before registering devices", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to retrieve policies:", pm.response.code);',
						'}',
					]
				),
			],
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        logger.info("📝 Proceed to get device authentication policies", "Logger info");',
						'    } else {',
						'        logger.info("⚠️ User not found - verify username is correct", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to lookup user:", pm.response.code);',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("deviceId is now: " + pm.environment.get("deviceId"));',
						'        logger.info("✅ SMS device created:", jsonData.id);',
						'        logger.info("   Device type:", jsonData.type || "SMS");',
						'        logger.info("   Device status:", jsonData.status || "N/A");',
						'        logger.info("   Phone number:", jsonData.phone?.number || jsonData.phone || "N/A");',
						'        if (jsonData.status === "ACTIVATION_REQUIRED") {',
						'            logger.info("📝 OTP code has been sent to phone number", "Logger info");',
						'            logger.info("📝 Proceed to step 4: Activate Device with OTP", "Logger info");',
						'        }',
						'    } else {',
						'        logger.info("⚠️ Device created but no ID in response", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to create SMS device:", pm.response.code);',
						'}',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ SMS device activated successfully", "Logger info");',
						'        ',
						'        if (pm.response.code === 200) {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.status) {',
						'                logger.info("   Device status:", jsonData.status);',
						'                if (jsonData.status === "ACTIVE") {',
						'                    logger.info("✅ Device is now ACTIVE and ready for MFA", "Logger info");',
						'                    logger.info("📝 MFA enrollment complete - device can be used for login-time MFA", "Logger info");',
						'                }',
						'            }',
						'            if (jsonData.id) {',
						'                pm.environment.set("deviceId", jsonData.id);',
						...
						'            logger.info("✅ Device activation successful (204 No Content)");',
						'            logger.info("📝 MFA enrollment complete - device is now ACTIVE", "Logger info");',
						'        }',
						'    } else if (pm.response.code === 400) {',
						'        try {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.message) {',
						'                logger.info("❌ Activation failed:", jsonData.message);',
						'                if (jsonData.message.includes("invalid") || jsonData.message.includes("incorrect")) {',
						'                    logger.info("   OTP code is incorrect or expired - user should retry with correct code", "Logger info");',
						'                }',
						'            }',
						'        } catch (e2) {',
						'            logger.info("❌ Activation failed - invalid OTP code", "Logger info");',
						'        }',
						'    } else if (pm.response.code === 404) {',
						'        logger.info("❌ Device not found - verify deviceId is correct", "Logger info");',
						'    } else {',
						'        logger.info("❌ Failed to activate device with status:", pm.response.code);',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'}',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("deviceAuthenticationId is now: " + pm.environment.get("deviceAuthenticationId"));',
						'        logger.info("✅ Device authentication initialized:", jsonData.id);',
						'        logger.info("   Status:", jsonData.status || "N/A");',
						'        logger.info("   Next step:", jsonData.nextStep || "N/A");',
						'        ',
						...
						'            logger.info("📝 OTP code has been sent to device", "Logger info");',
						'            logger.info("📝 Proceed to step 3: Check OTP Code (skip step 2 if device was auto-selected)");',
						'        } else if (jsonData.status === "DEVICE_SELECTION_REQUIRED" || jsonData.nextStep === "SELECTION_REQUIRED") {',
						'            logger.info("📝 Device selection required - proceed to step 2: Select Device", "Logger info");',
						'        }',
						'        ',
						...
						'            logger.info("📝 Available devices:", jsonData._embedded.devices.length);',
						'            jsonData._embedded.devices.forEach((device, index) => {',
						// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
						'                logger.info(`   ${index + 1}. ${device.type} - ${device.nickname || device.id}`, "Logger info");',
						'            });',
						'        }',
						'    } else {',
						'        logger.info("⚠️ Authentication initialized but no ID in response", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to initialize device authentication:", pm.response.code);',
						'}',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ Device selected successfully", "Logger info");',
						'        ',
						'        if (pm.response.code === 200) {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.status === "OTP_REQUIRED" || jsonData.nextStep === "OTP_REQUIRED") {',
						'                logger.info("📝 OTP code has been sent to selected device", "Logger info");',
						'                logger.info("📝 Proceed to step 3: Check OTP Code", "Logger info");',
						'            }',
						'            if (jsonData.selectedDevice) {',
						'                logger.info("   Selected device:", jsonData.selectedDevice.id);',
						'            }',
						'        } else {',
						'            // Response may be empty (204 No Content)',
						'            logger.info("✅ Device selected successfully (204 No Content)");',
						'        }',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to select device:", pm.response.code);',
						'}',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ OTP code validated successfully", "Logger info");',
						'        ',
						'        if (pm.response.code === 200) {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.status) {',
						'                logger.info("   Authentication status:", jsonData.status);',
						'                if (jsonData.status === "COMPLETED" || jsonData.nextStep === "COMPLETE") {',
						'                    logger.info("✅ MFA challenge complete - user can proceed with login", "Logger info");',
						'                    logger.info("📝 Device authentication successful", "Logger info");',
						'                } else if (jsonData.status === "OTP_REQUIRED") {',
						'                    logger.info("⚠️ OTP still required - verification may have failed", "Logger info");',
						'                }',
						'            }',
						'            if (jsonData._links && jsonData._links.complete) {',
						'                logger.info("📝 Next: Complete device authentication if needed", "Logger info");',
						'            }',
						'        } else {',
						'            // Response may be empty (204 No Content)',
						'            logger.info("✅ OTP validation successful (204 No Content)");',
						'            logger.info("📝 MFA challenge complete - proceed with login", "Logger info");',
						'        }',
						'    } else if (pm.response.code === 400 || pm.response.code === 401) {',
						'        try {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.message) {',
						'                logger.info("❌ OTP validation failed:", jsonData.message);',
						'                if (jsonData.message.includes("invalid") || jsonData.message.includes("incorrect")) {',
						'                    logger.info("   OTP code is incorrect or expired - user should retry with correct code", "Logger info");',
						'                }',
						'            }',
						'            if (jsonData.attemptsRemaining !== undefined) {',
						'                logger.info("   Attempts remaining:", jsonData.attemptsRemaining);',
						'            }',
						'        } catch (e2) {',
						'            logger.info("❌ OTP validation failed - invalid or expired OTP code", "Logger info");',
						'        }',
						'    } else if (pm.response.code === 404) {',
						'        logger.info("❌ Device authentication session not found - verify deviceAuthenticationId is correct", "Logger info");',
						'    } else {',
						'        logger.info("❌ Failed to validate OTP with status:", pm.response.code);',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'}',
			...
			item: [
				createUseCaseItem(
					...
					[
						...
						'        logger.info("✅ User found:", user.id);',
						'        logger.info("   Email:", user.email?.address || user.email || "N/A");',
						'        logger.info("📝 Proceed to step 2: Send Recovery Code to email", "Logger info");',
						'    } else {',
						"        // Security best practice: Don't reveal if user exists or not",
						'        logger.info("⚠️ User lookup completed - proceed if user exists", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to lookup user:", pm.response.code);',
				...
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ Recovery code sent successfully to user\'s email", "Logger info");',
						'        ',
						'        if (pm.response.code === 200) {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.message) {',
						'                logger.info("   Message:", jsonData.message);',
						'            }',
						'        } else {',
						'            // Response may be empty (204 No Content)',
						'            logger.info("✅ Recovery code sent successfully (204 No Content)");',
						'        }',
						'        ',
						'        logger.info("📝 User should check their email for the recovery code", "Logger info");',
						'        logger.info("📝 Proceed to step 3: Validate Recovery Code", "Logger info");',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'    logger.info("❌ Failed to send recovery code:", pm.response.code);',
						'}',
					]
				),
				createUseCaseItem(
					...
					[
						...
						'        });',
						'        ',
						'        logger.info("✅ Recovery code validated successfully", "Logger info");',
						'        ',
						'        if (pm.response.code === 200) {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.message) {',
						...
						'        }',
						'        ',
						'        logger.info("✅ Account recovery complete - user can now sign in", "Logger info");',
						'        logger.info("📝 User password has been reset as part of recovery process", "Logger info");',
						'    } else if (pm.response.code === 400 || pm.response.code === 401) {',
						'        try {',
						'            const jsonData = pm.response.json();',
						'            if (jsonData.message) {',
						'                logger.info("❌ Recovery code validation failed:", jsonData.message);',
						'                if (jsonData.message.includes("invalid") || jsonData.message.includes("incorrect") || jsonData.message.includes("expired")) {',
						'                    logger.info("   Recovery code is incorrect or expired - user should check email and try again", "Logger info");',
						'                }',
						'            }',
						'            if (jsonData.error_description) {',
						'                logger.info("   Error description:", jsonData.error_description);',
						'            }',
						'        } catch (e2) {',
						'            logger.info("❌ Recovery code validation failed - invalid or expired code", "Logger info");',
						'        }',
						'    } else if (pm.response.code === 404) {',
						'        logger.info("❌ User not found - verify userId is correct", "Logger info");',
						'    } else {',
						'        logger.info("❌ Failed to validate recovery code with status:", pm.response.code);',
						'    }',
						'} catch (e) {',
						'    logger.info("There was an error parsing JSON", e);',
						'}',
	...
	const passwordResetItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				'        ',
				'        logger.info("userId is now: " + pm.environment.get("userId"));',
				'        logger.info("✅ User found for password reset", "Logger info");',
				'    }',
				'} catch (e) {',
				'    logger.info("❌ There was an error parsing JSON", e);',
				'    pm.test("❌ Response should be valid JSON", function() {',
		...
		createUseCaseItem(
			...
			[
				...
				'});',
				'',
				'logger.info("✅ Password reset successfully", "Logger info");',
				'logger.info("📝 User can now sign in with the new password", "Logger info");',
			],
			generatePasswordScript()
		),
	...
	const changePasswordItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				'});',
				'',
				'logger.info("✅ Password changed successfully", "Logger info");',
				'logger.info("📝 User can now sign in with the new password", "Logger info");',
			],
			generatePasswordScript()
		),
		createUseCaseItem(
			...
			[
				...
				'});',
				'',
				'logger.info("✅ Force password change set successfully", "Logger info");',
				'logger.info("📝 User will be prompted to change password on next sign-in", "Logger info");',
			]
		),
	];
	...
	const socialLoginItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				'        });',
				'        ',
				'        logger.info("facebook_idp_id is now: " + pm.environment.get("facebook_idp_id"));',
				'        logger.info("✅ Facebook external IdP configured:", jsonData.id);',
				'        logger.info("   IdP Name:", jsonData.name || "N/A");',
				'        logger.info("   IdP Type:", jsonData.type || "FACEBOOK");',
				'        logger.info("   Enabled:", jsonData.enabled !== false ? "true" : "false");',
				'        logger.info("📝 Facebook login option is now available in PingOne authentication flows", "Logger info");',
				'    } else {',
				'        logger.info("⚠️ Facebook IdP configured but no ID in response", "Logger info");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    logger.info("❌ Failed to configure Facebook IdP:", pm.response.code);',
				'}',
			]
		),
		createUseCaseItem(
			...
			[
				...
				'        });',
				'        ',
				'        logger.info("linkedin_idp_id is now: " + pm.environment.get("linkedin_idp_id"));',
				'        logger.info("✅ LinkedIn external IdP configured:", jsonData.id);',
				'        logger.info("   IdP Name:", jsonData.name || "N/A");',
				'        logger.info("   IdP Type:", jsonData.type || "LINKEDIN");',
				'        logger.info("   Enabled:", jsonData.enabled !== false ? "true" : "false");',
				'        logger.info("📝 LinkedIn login option is now available in PingOne authentication flows", "Logger info");',
				'    } else {',
				'        logger.info("⚠️ LinkedIn IdP configured but no ID in response", "Logger info");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    logger.info("❌ Failed to configure LinkedIn IdP:", pm.response.code);',
				'}',
			]
		),
	];
	...
	const federationItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				'        });',
				'        ',
				'        logger.info("azure_idp_id is now: " + pm.environment.get("azure_idp_id"));',
				'        logger.info("✅ Azure AD external IdP configured for enterprise federation:", jsonData.id);',
				'        logger.info("   IdP Name:", jsonData.name || "N/A");',
				'        logger.info("   IdP Type:", jsonData.type || "OPENID_CONNECT");',
				'        logger.info("   Enabled:", jsonData.enabled !== false ? "true" : "false");',
				'        if (jsonData.issuer) {',
				'            logger.info("   Issuer:", jsonData.issuer);',
				'        }',
				'        logger.info("📝 Azure AD enterprise federation is now available in PingOne authentication flows", "Logger info");',
				'        logger.info("📝 Users can sign in with their organization credentials", "Logger info");',
				'    } else {',
				'        logger.info("⚠️ Azure AD IdP configured but no ID in response", "Logger info");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    logger.info("❌ Failed to configure Azure AD IdP:", pm.response.code);',
				'}',
			]
		),
	];
	...
	const riskCheckItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				'        });',
				'        ',
				'        logger.info("✅ Retrieved", predictors.length, "risk predictors");',
				'        ',
				'        // Log predictor details',
				'        predictors.forEach((predictor, index) => {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`\\n   Predictor ${index + 1}:`, "Logger info");',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`      ID: ${predictor.id}`, "Logger info");',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`      Name: ${predictor.name || "N/A"}`, "Logger info");',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`      Type: ${predictor.type || "N/A"}`, "Logger info");',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`      Enabled: ${predictor.enabled !== false ? "true" : "false"}`, "Logger info");',
				'            if (predictor.description) {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      Description: ${predictor.description}`, "Logger info");',
				'            }',
				'        });',
				'        ',
				...
				'        }',
				'        ',
				'        logger.info("\\n📝 Risk predictors are used in risk policies to evaluate authentication and transaction risk", "Logger info");',
				'        logger.info("📝 Proceed to create or update risk evaluations using these predictors", "Logger info");',
				'    } else {',
				'        logger.info("⚠️ Response structure unexpected - no _embedded.riskPredictors found", "Logger info");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    logger.info("❌ Failed to get risk predictors:", pm.response.code);',
				'}',
			]
		),
		createUseCaseItem(
			...
			[
				...
				'    });',
				'    ',
				'    logger.info("✅ Risk evaluation updated successfully", "Logger info");',
				'    ',
				'    if (jsonData.id) {',
				'        logger.info("   Evaluation ID:", jsonData.id);',
				'    }',
				'    if (jsonData.completionStatus) {',
				'        logger.info("   Completion Status:", jsonData.completionStatus);',
				'        pm.environment.set("completionStatus", jsonData.completionStatus);',
				'    }',
				'    if (jsonData.result && jsonData.result.level) {',
				'        logger.info("   Risk Level:", jsonData.result.level);',
				'        logger.info("   Recommended Action:", jsonData.result.recommendedAction || "N/A");',
				'    }',
				'    if (jsonData.createdAt) {',
				'        logger.info("   Created At:", jsonData.createdAt);',
				'    }',
				'    if (jsonData.updatedAt) {',
				'        logger.info("   Updated At:", jsonData.updatedAt);',
				'    }',
				'    ',
				'    logger.info("\\n📝 Risk evaluation feedback has been recorded", "Logger info");',
				'    logger.info("📝 This feedback helps PingOne Protect improve future risk assessments", "Logger info");',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 400) {',
				'        try {',
				'            const jsonData = pm.response.json();',
				'            if (jsonData.message) {',
				'                logger.info("❌ Failed to update risk evaluation:", jsonData.message);',
				'                if (jsonData.message.includes("invalid") || jsonData.message.includes("expired")) {',
				'                    logger.info("   Risk evaluation ID is invalid or evaluation has expired (>30 minutes old)");',
				'                }',
				'            }',
				'            if (jsonData.error_description) {',
				'                logger.info("   Error description:", jsonData.error_description);',
				'            }',
				'        } catch (e2) {',
				'            logger.info("❌ Failed to update risk evaluation - invalid request", "Logger info");',
				'        }',
				'    } else if (pm.response.code === 404) {',
				'        logger.info("❌ Risk evaluation not found - verify riskEvaluationId is correct", "Logger info");',
				'        logger.info("   Create a risk evaluation first to obtain a valid evaluation ID", "Logger info");',
				'    } else {',
				'        logger.info("❌ Failed to update risk evaluation with status:", pm.response.code);',
				'    }',
				'}',
			]
		),
	...
	const logoutItems: PostmanCollectionItem[] = [
		createUseCaseItem(
			...
			[
				...
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`\\n   Session ${index + 1}:`, "Logger info");',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'            logger.info(`      Session ID: ${session.id}`, "Logger info");',
				'            if (session.ipAddress) {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      IP Address: ${session.ipAddress}`, "Logger info");',
				'            }',
				'            if (session.userAgent) {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      User Agent: ${session.userAgent}`, "Logger info");',
				'            }',
				'            if (session.createdAt) {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      Created At: ${session.createdAt}`, "Logger info");',
				'            }',
				'            if (session.expiresAt) {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      Expires At: ${session.expiresAt}`, "Logger info");',
				'            }',
				'            if (session.environment) {',
				// biome-ignore lint/suspicious/noTemplateCurlyInString: This is Postman script code where template literals are valid
				'                logger.info(`      Environment: ${session.environment.id || session.environment}`, "Logger info");',
				'            }',
				'        });',
				'        ',
				...
				'            logger.info("📝 Proceed to step 4 or 5 to delete this session or verify token status", "Logger info");',
				'        } else {',
				'            logger.info("\\n📝 No active sessions found for this user", "Logger info");',
				'        }',
				'    } else {',
				'        logger.info("⚠️ Response structure unexpected - no _embedded.sessions found", "Logger info");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 404) {',
				'        logger.info("❌ User not found - verify userId is correct", "Logger info");',
				'    } else {',
				'        logger.info("❌ Failed to get user sessions:", pm.response.code);',
				'    }',
				'}',
			]
		),
		createUseCaseItem(
			...
			[
				...
				'        });',
				'        ',
				'        logger.info("✅ Session ended successfully", "Logger info");',
				'        ',
				'        if (pm.response.code === 200) {',
				'            const jsonData = pm.response.json();',
				'            if (jsonData.message) {',
				...
				'        } else {',
				'            // Response may be empty (204 No Content)',
				'            logger.info("✅ Session ended successfully (204 No Content)");',
				'        }',
				'        ',
				'        logger.info("📝 User session has been invalidated", "Logger info");',
				'        logger.info("📝 Proceed to step 3 to revoke refresh token, or step 5 to verify token status");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 401 || pm.response.code === 403) {',
				'        logger.info("❌ Session end failed - invalid or expired access token", "Logger info");',
				'    } else {',
				'        logger.info("❌ Failed to end session with status:", pm.response.code);',
				'    }',
				'}',
			]
		),
		createUseCaseItem(
			...
			[
				...
				'        });',
				'        ',
				'        logger.info("✅ Refresh token revoked successfully", "Logger info");',
				'        ',
				'        if (pm.response.code === 200) {',
				'            const jsonData = pm.response.json();',
				'            if (jsonData.message) {',
				...
				'        } else {',
				'            // Response may be empty (204 No Content)',
				'            logger.info("✅ Refresh token revoked successfully (204 No Content)");',
				'        }',
				'        ',
				'        logger.info("📝 Refresh token can no longer be used to obtain new access tokens", "Logger info");',
				'        logger.info("📝 Logout flow complete - all tokens have been invalidated", "Logger info");',
				'        logger.info("📝 Proceed to step 5 to verify token status (should show inactive)");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 400) {',
				...
				'            const jsonData = pm.response.json();',
				'            if (jsonData.error) {',
				'                logger.info("❌ Token revocation failed:", jsonData.error);',
				'                if (jsonData.error === "invalid_token") {',
				'                    logger.info("   Token is invalid or already revoked", "Logger info");',
				'                }',
				'            }',
				'            if (jsonData.error_description) {',
				'                logger.info("   Error description:", jsonData.error_description);',
				'            }',
				'        } catch (e2) {',
				'            logger.info("❌ Token revocation failed - invalid token or client credentials", "Logger info");',
				'        }',
				'    } else {',
				'        logger.info("❌ Failed to revoke refresh token with status:", pm.response.code);',
				'    }',
				'}',
			]
		),
		createUseCaseItem(
			...
			[
				...
				'        });',
				'        ',
				'        logger.info("✅ Session deleted successfully", "Logger info");',
				'        ',
				'        if (pm.response.code === 200) {',
				'            const jsonData = pm.response.json();',
				'            if (jsonData.message) {',
				...
				'        } else {',
				'            // Response may be empty (204 No Content)',
				'            logger.info("✅ Session deleted successfully (204 No Content)");',
				'        }',
				'        ',
				'        logger.info("📝 Session", pm.environment.get("sessionId") || "{{sessionId}}", "has been terminated");',
				'        logger.info("📝 User is now logged out from that specific device/browser", "Logger info");',
				'        logger.info("📝 Proceed to step 1 again to verify session has been removed from active sessions list", "Logger info");',
				'    }',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 404) {',
				'        logger.info("❌ Session not found - session may have already expired or been deleted", "Logger info");',
				'        logger.info("   Verify sessionId is correct or session may have expired", "Logger info");',
				'    } else if (pm.response.code === 403) {',
				'        logger.info("❌ Permission denied - verify worker token has appropriate permissions", "Logger info");',
				'    } else {',
				'        logger.info("❌ Failed to delete session with status:", pm.response.code);',
				'    }',
				'}',
			]
		),
		createUseCaseItem(
			...
			[
				...
				'        logger.info("⚠️ Token is still ACTIVE", "Logger info");',
				'        logger.info("   This token has not been revoked and can still be used", "Logger info");',
				'        if (jsonData.exp) {',
				'            const expDate = new Date(jsonData.exp * 1000);',
				'            logger.info("   Token expires at:", expDate.toISOString());',
				'        }',
				'    } else {',
				'        logger.info("✅ Token is INACTIVE", "Logger info");',
				'        logger.info("   This token has been revoked or has expired", "Logger info");',
				'        logger.info("   Token cannot be used for authentication", "Logger info");',
				'    }',
				'    ',
				'    if (jsonData.sub) {',
				'        logger.info("   Subject (User ID):", jsonData.sub);',
				'    }',
				'    if (jsonData.client_id) {',
				'        logger.info("   Client ID:", jsonData.client_id);',
				'    }',
				'    if (jsonData.scope) {',
				'        logger.info("   Scopes:", jsonData.scope);',
				'    }',
				'    if (jsonData.iat) {',
				'        const iatDate = new Date(jsonData.iat * 1000);',
				'        logger.info("   Issued At:", iatDate.toISOString());',
				'    }',
				'    if (jsonData.exp) {',
				'        const expDate = new Date(jsonData.exp * 1000);',
				'        logger.info("   Expires At:", expDate.toISOString());',
				'    }',
				'    ',
				'    logger.info("\\n📝 Token introspection is useful for verifying logout operations", "Logger info");',
				'    logger.info("📝 After logout, tokens should show active: false");',
				'} catch (e) {',
				'    logger.info("There was an error parsing JSON", e);',
				'    if (pm.response.code === 400) {',
				'        try {',
				'            const jsonData = pm.response.json();',
				'            if (jsonData.error) {',
				'                logger.info("   Error:", jsonData.error);',
				'            }',
				'            if (jsonData.error_description) {',
				'                logger.info("   Error description:", jsonData.error_description);',
				'            }',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'            });',
									'            ',
									'            logger.info("workerToken is now: " + pm.environment.get("workerToken"));',
									'            logger.info("✅ Worker token saved to environment variable", "Logger info");',
									'            ',
									'            if (jsonData.expires_in) {',
									'                logger.info("📝 Token expires in:", jsonData.expires_in, "seconds");',
									'            }',
									'        } else {',
									'            logger.info("❌ No access_token in response", "Logger info");',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'',
									'if (!clientId || !clientSecret || !envId) {',
									'    logger.info("❌ Missing required variables: worker_client_id, worker_client_secret, or envID");',
									...
									'',
									'// Log success message',
									'logger.info("✅ JWT assertion generated successfully", "Logger info");',
									'logger.info("📝 JWT ID (jti):", payload.jti);',
									'logger.info("📝 Expires at:", new Date((now + 300) * 1000).toISOString());',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'    logger.info("⚠️ Private Key JWT requires RSA signing. Set {{client_assertion_jwt_private}} manually.", "Logger info");',
									'}',
								],
								type: 'text/javascript',
							},
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    if (jsonData.access_token) {',
								'        pm.environment.set("access_token", jsonData.access_token);',
								'        logger.info("✅ Access token received (OAuth 2.0 - Client Credentials)");',
								'    }',
								'    ',
								...
								'        logger.info("⏱️ Access token expires in:", jsonData.expires_in, "seconds (" + Math.round(jsonData.expires_in / 60) + " minutes)");',
								'    }',
								'    if (jsonData.scope) {',
								'        pm.environment.set("token_scope", jsonData.scope);',
								'        logger.info("📋 Token scope:", jsonData.scope);',
								'    }',
								'    ',
								'    // Note: OAuth 2.0 Client Credentials does not return id_token or refresh_token',
								'    logger.info("✅ Client Credentials flow completed successfully!", "Logger info");',
								'} else {',
								'    logger.info("❌ Client Credentials token request failed:", pm.response.code);',
								'    try {',
								'        const jsonData = pm.response.json();',
								'        if (jsonData.error) {',
								'            logger.info("   Error:", jsonData.error);',
								'            if (jsonData.error_description) {',
								'                logger.info("   Description:", jsonData.error_description);',
								'            }',
								'            ',
								'            // Common errors',
								'            if (jsonData.error === "invalid_client") {',
								'                logger.info("   💡 Tip: Verify client_id and client_secret are correct", "Logger info");',
								'            } else if (jsonData.error === "invalid_scope") {',
								'                logger.info("   💡 Tip: Verify requested scopes are valid for this client", "Logger info");',
								'            }',
								'        }',
								'    } catch (e) {',
								'        // Response may not be JSON',
					...
					},
					{
						...
						script: {
							exec: [
								...
								'    if (jsonData.access_token) {',
								'        pm.environment.set("access_token", jsonData.access_token);',
								'        logger.info("✅ Access token received (OAuth 2.0 - Client Credentials Basic)");',
								'    }',
								'    ',
								'    // Extract token metadata',
								'    if (jsonData.token_type) {',
								...
								'    ',
								'    // Note: OAuth 2.0 Client Credentials does not return id_token or refresh_token',
								'    logger.info("✅ Client Credentials flow completed successfully (Basic Auth)!");',
								'} else {',
								'    logger.info("❌ Client Credentials token request failed:", pm.response.code);',
								'    try {',
								'        const jsonData = pm.response.json();',
								...
								'            // Common errors',
								'            if (jsonData.error === "invalid_client") {',
								'                logger.info("   💡 Tip: Verify user_client_id and user_client_secret in Authorization header are correct", "Logger info");',
								'                logger.info("   💡 Tip: Verify {{user_client_credentials_basic}} = base64(user_client_id:user_client_secret)");',
								'            } else if (jsonData.error === "invalid_scope") {',
								'                logger.info("   💡 Tip: Verify requested scopes are valid for this client", "Logger info");',
								'            }',
								'        }',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    if (jsonData.device_code) {',
								'        pm.environment.set("device_code", jsonData.device_code);',
								'        logger.info("✅ Device code saved:", jsonData.device_code.substring(0, 20) + "...");',
								'    }',
								'    ',
								'    // Required: user_code for user to enter',
								'    if (jsonData.user_code) {',
								'        pm.environment.set("user_code", jsonData.user_code);',
								'        logger.info("✅ User code saved:", jsonData.user_code);',
								'        logger.info("   👤 User must enter this code at verification URI", "Logger info");',
								'    }',
								'    ',
								...
								'        logger.info("✅ Verification URI Complete (QR code):", jsonData.verification_uri_complete);',
								'    }',
								'    ',
								...
								'        logger.info("⏱️ Device code expires in:", jsonData.expires_in, "seconds (" + Math.round(jsonData.expires_in / 60) + " minutes)");',
								'    }',
								'    ',
								...
								'    logger.info("🔄 Poll token endpoint every", interval, "seconds");',
								'    logger.info("", "Logger info");',
								'    logger.info("📋 Next Steps:", "Logger info");',
								'    logger.info("   1. User opens:", pm.environment.get("verification_uri") || jsonData.verification_uri);',
								'    logger.info("   2. User enters code:", pm.environment.get("user_code") || jsonData.user_code);',
								'    logger.info("   3. User authenticates and authorizes", "Logger info");',
								'    logger.info("   4. Call Poll for Tokens step (wait", interval, "seconds between polls)");',
								'} else {',
								'    logger.info("❌ Device authorization request failed:", pm.response.code);',
								'    try {',
								'        const jsonData = pm.response.json();',
								'        if (jsonData.error) {',
								'            logger.info("   Error:", jsonData.error);',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    if (jsonData.access_token) {',
								'        pm.environment.set("access_token", jsonData.access_token);',
								'        logger.info("✅ Access token received (OAuth 2.0 - no id_token)");',
								'    }',
								'    ',
								'    // Extract token metadata',
								'    if (jsonData.token_type) {',
								...
								'        const expiresAt = Date.now() + (jsonData.expires_in * 1000);',
								'        pm.environment.set("access_token_expires_at", expiresAt.toString());',
								'        logger.info("⏱️ Access token expires in:", jsonData.expires_in, "seconds");',
								'    }',
								'    if (jsonData.scope) {',
								'        pm.environment.set("token_scope", jsonData.scope);',
								'    }',
								...
								'    logger.info("✅ Device Code Flow completed successfully!", "Logger info");',
								'} else if (pm.response.code === 400) {',
								'    // Handle polling errors',
								'    const jsonData = pm.response.json();',
								'    ',
								'    if (jsonData.error === "authorization_pending") {',
								'        logger.info("⏳ Authorization pending - user has not authorized yet", "Logger info");',
								'        logger.info("   🔄 Poll again after interval (typically 5 seconds)");',
								'        const interval = parseInt(pm.environment.get("device_code_interval") || "5");',
								'        logger.info("   ⏱️ Wait", interval, "seconds before next poll");',
								'    } else if (jsonData.error === "slow_down") {',
								'        logger.info("⚠️ Slow down - polling too frequently", "Logger info");',
								...
								'        logger.info("   🔄 Increased polling interval to", newInterval, "seconds");',
								'    } else if (jsonData.error === "expired_token") {',
								'        logger.info("❌ Device code expired - restart flow from Request Device Authorization step", "Logger info");',
								'        pm.environment.unset("device_code");',
								'        pm.environment.unset("user_code");',
								'    } else if (jsonData.error === "access_denied") {',
								'        logger.info("❌ User denied authorization - restart flow from Request Device Authorization step", "Logger info");',
								'        pm.environment.unset("device_code");',
								'        pm.environment.unset("user_code");',
								'    } else {',
								'        logger.info("❌ Polling failed:", jsonData.error);',
								'        if (jsonData.error_description) {',
								'            logger.info("   Description:", jsonData.error_description);',
								'        }',
								'    }',
								'} else {',
								'    logger.info("❌ Unexpected response code:", pm.response.code);',
								'}',
							],
							type: 'text/javascript',
						},
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    logger.info("✅ Authorization URL generated for OAuth 2.0 Implicit Flow", "Logger info");',
								'    logger.info("⚠️ Access token will be in redirect URL fragment, not in response body");',
								'}',
							],
							type: 'text/javascript',
						},
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'if (pm.response.code === 200 || pm.response.code === 302) {',
								'    logger.info("✅ Authorization URL generated for OAuth 2.0 Implicit Flow (Form POST)");',
								'    logger.info("⚠️ Access token will be in POST body to redirect_uri, not in response body");',
								'}',
							],
							type: 'text/javascript',
						},
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    if (jsonData.access_token) {',
								'        pm.environment.set("access_token", jsonData.access_token);',
								'        logger.info("✅ Access token received (OIDC)");',
								'    }',
								'    ',
								'    if (jsonData.id_token) {',
								'        pm.environment.set("id_token", jsonData.id_token);',
								'        logger.info("✅ ID token received (OIDC)");',
								'    }',
								'    ',
								'    if (jsonData.refresh_token) {',
								'        pm.environment.set("refresh_token", jsonData.refresh_token);',
								'        logger.info("✅ Refresh token received (offline_access scope requested)");',
								'    }',
								'    ',
								'    // Extract token metadata',
								'    if (jsonData.token_type) {',
								...
								'    }',
								'    ',
								'    logger.info("✅ Device Code Flow completed successfully (OIDC)!");',
								'} else if (pm.response.code === 400) {',
								'    // Handle polling errors',
								'    const jsonData = pm.response.json();',
								'    ',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    if (locationHeader) {',
								'        logger.info("✅ Authorization URL generated for Hybrid Flow", "Logger info");',
								'        logger.info("   Redirecting to:", locationHeader);',
								'        logger.info("   After user authorizes, you\'ll be redirected to redirect_uri with:");',
								'        logger.info("   - code (authorization code) in URL fragment");',
								'        logger.info("   - id_token (user identity token) in URL fragment");',
								'        logger.info("   - state (for validation) in URL fragment");',
								'        logger.info("", "Logger info");',
								'        logger.info("📋 Next Steps:", "Logger info");',
								'        logger.info("   1. User completes authorization (opens redirect URL)");',
								'        logger.info("   2. User is redirected to redirect_uri with tokens in fragment", "Logger info");',
								'        logger.info("   3. Extract code and id_token from redirect URL fragment", "Logger info");',
								'        logger.info("   4. Call Exchange Authorization Code step to get access_token", "Logger info");',
								'    }',
								'} else if (pm.response.code === 200) {',
								'    logger.info("✅ Authorization URL generated for Hybrid Flow", "Logger info");',
								'    logger.info("⚠️ Note: In real flow, user completes authorization and is redirected to redirect_uri");',
								'} else {',
								'    logger.info("❌ Authorization URL generation failed:", pm.response.code);',
								'}',
							],
							type: 'text/javascript',
						},
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'        logger.info("✅ Authorization code extracted from fragment:", code);',
								'    }',
								'    ',
								...
								'        logger.info("✅ ID token extracted from fragment (Hybrid Flow):", idToken.substring(0, 50) + "...");',
								'        logger.info("   💡 ID token already received - no need to wait for token exchange!", "Logger info");',
								'    }',
								'    ',
								...
								'            logger.info("✅ State parameter validated:", state);',
								'        } else {',
								'            logger.info("⚠️ State mismatch - possible CSRF attack!", "Logger info");',
								'        }',
								'    }',
								'}',
								'',
								...
								'}',
								'',
								'logger.info("📋 Hybrid Flow callback parsed:", "Logger info");',
								'logger.info("   - Authorization code:", pm.environment.get("authorization_code") || "not found");',
								'logger.info("   - ID token:", pm.environment.get("id_token") ? "extracted" : "not found");',
								'logger.info("", "Logger info");',
								'logger.info("✅ Next step: Exchange Authorization Code for access_token (id_token already received)");',
							],
							type: 'text/javascript',
						},
					},
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    if (jsonData.access_token) {',
								'        pm.environment.set("access_token", jsonData.access_token);',
								'        logger.info("✅ Access token received (Hybrid Flow)");',
								'    }',
								'    ',
								...
								'        pm.environment.set("id_token", jsonData.id_token);',
								'        logger.info("✅ ID token received (backup from token exchange)");',
								'    } else if (pm.environment.get("id_token")) {',
								'        logger.info("✅ ID token already received from Step 1 redirect (Hybrid Flow advantage)");',
								'    }',
								'    ',
								...
								'    }',
								'    ',
								'    logger.info("✅ Hybrid Flow completed successfully!", "Logger info");',
								'    logger.info("   - ID token: Already received from Step 1 (immediate authentication)");',
								'    logger.info("   - Access token: Received from token exchange (for API calls)");',
								'    logger.info("   - Refresh token: Received if offline_access scope requested", "Logger info");',
								'} else {',
								'    logger.info("❌ Token exchange failed:", pm.response.code);',
								'    try {',
								'        const jsonData = pm.response.json();',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    if (jsonData.access_token) {',
								'        pm.environment.set("access_token", jsonData.access_token);',
								'        logger.info("✅ Access token received (OIDC 2.1 - Client Credentials)");',
								'    }',
								'    ',
								'    // OIDC 2.1: Extract id_token if openid scope requested',
								'    if (jsonData.id_token) {',
								'        pm.environment.set("id_token", jsonData.id_token);',
								'        logger.info("✅ ID token received (OIDC 2.1 - openid scope requested)");',
								'    }',
								'    ',
								'    // Extract token metadata',
								'    if (jsonData.token_type) {',
								...
								'    logger.info("✅ Client Credentials flow completed successfully (OIDC 2.1)!");',
								'} else {',
								'    logger.info("❌ Client Credentials token request failed:", pm.response.code);',
								'    try {',
								'        const jsonData = pm.response.json();',
								...
								'            } else if (jsonData.error === "invalid_scope") {',
								'                logger.info("   💡 Tip: Verify requested scopes are valid for this client", "Logger info");',
								'                logger.info("   💡 Tip: Request openid scope to receive id_token", "Logger info");',
								'            }',
								'        }',
								'    } catch (e) {',
								'        // Response may not be JSON',
					...
					},
					{
						...
						script: {
							exec: [
								...
								'    if (jsonData.access_token) {',
								'        pm.environment.set("access_token", jsonData.access_token);',
								'        logger.info("✅ Access token received (OIDC 2.1 - Client Credentials Basic)");',
								'    }',
								'    ',
								'    // OIDC 2.1: Extract id_token if openid scope requested',
								'    if (jsonData.id_token) {',
								...
								'    ',
								'    // Note: Client Credentials flow does not return refresh_token',
								'    logger.info("✅ Client Credentials flow completed successfully (OIDC 2.1 - Basic Auth)!");',
								'} else {',
								'    logger.info("❌ Client Credentials token request failed:", pm.response.code);',
								'    try {',
								'        const jsonData = pm.response.json();',
				...
				event: [
					{
						...
						script: {
							exec: [
								...
								'    if (jsonData.access_token) {',
								'        pm.environment.set("access_token", jsonData.access_token);',
								'        logger.info("✅ Access token received (OIDC 2.1)");',
								'    }',
								'    ',
								'    if (jsonData.id_token) {',
								'        pm.environment.set("id_token", jsonData.id_token);',
								'        logger.info("✅ ID token received (OIDC 2.1)");',
								'    }',
								'    ',
								'    if (jsonData.refresh_token) {',
								'        pm.environment.set("refresh_token", jsonData.refresh_token);',
								...
								'    }',
								'    ',
								'    logger.info("✅ Device Code Flow completed successfully (OIDC 2.1)!");',
								'} else if (pm.response.code === 400) {',
								'    // Handle polling errors',
								'    const jsonData = pm.response.json();',
								'    ',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'        logger.info("✅ Flow ID saved:", flowId);',
									'    }',
									'    ',
									...
									'        logger.info("✅ Flow status:", jsonData.status);',
									'    }',
									'    ',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'    if (jsonData.status) {',
									'        pm.environment.set("redirectless_status", jsonData.status);',
									'        logger.info("✅ Flow status updated:", jsonData.status);',
									'        ',
									'        if (jsonData.status === "MFA_REQUIRED") {',
									'            logger.info("⚠️ MFA required - call Check Username/Password again with otp_code", "Logger info");',
									'        } else if (jsonData.status === "COMPLETE" || jsonData.status === "READY_TO_RESUME") {',
									'            logger.info("✅ Credentials validated - proceed to Get Auth Code step", "Logger info");',
									'        }',
									'    }',
									'    ',
									...
									'    }',
									'} else {',
									'    logger.info("❌ Username/password check failed:", pm.response.code);',
									'    const jsonData = pm.response.json();',
									'    if (jsonData.error) {',
									'        logger.info("   Error:", jsonData.error);',
									'        if (jsonData.error_description) {',
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'        if (code) {',
									'            pm.environment.set("authorization_code", code);',
									'            logger.info("✅ Authorization code extracted from redirect:", code);',
									'        }',
									'        if (state) {',
									...
									'            logger.info("✅ Authorization code extracted from JSON:", jsonData.code);',
									'        }',
									'        if (jsonData.state) {',
									'            pm.environment.set("state", jsonData.state);',
									'        }',
									'    } catch (e) {',
									'        logger.info("⚠️ Could not parse JSON response", "Logger info");',
									'    }',
									'} else {',
									'    logger.info("❌ Failed to get authorization code:", pm.response.code);',
									'}',
								],
								type: 'text/javascript',
							},
					...
					event: [
						{
							...
							script: {
								exec: [
									...
									'    if (jsonData.status) {',
									'        pm.environment.set("redirectless_status", jsonData.status);',
									'        logger.info("✅ Session reset - new status:", jsonData.status);',
									'    }',
									'    ',
									'    // Update flowId if changed',
									'    const flowId = jsonData.id || jsonData._id || jsonData.flowId;',
									...
									'    }',
									'} else {',
									'    logger.info("❌ Session reset failed:", pm.response.code);',
									'}',
								],
								type: 'text/javascript',
							},
						...
						},
						{
							...
							script: {
								exec: [
									...
									'    logger.info("✅ Password change successful", "Logger info");',
									'    logger.info("⚠️ User can now proceed with normal authentication flow", "Logger info");',
									'    ',
									'    // Reset flow status to allow re-authentication',
									'    pm.environment.set("redirectless_status", "USERNAME_PASSWORD_REQUIRED");',
									'} else {',
									'    logger.info("❌ Password change failed:", pm.response.code);',
									'    try {',
									'        const jsonData = pm.response.json();',
									'        if (jsonData.error) {',
									'            logger.info("   Error:", jsonData.error);',
						...
						},
						{
							...
							script: {
								exec: [
									...
									'if (pm.response.code === 200 || pm.response.code === 201 || pm.response.code === 204) {',
									'    logger.info("✅ Password updated successfully", "Logger info");',
									'    pm.test("Password update successful", function () {',
									'        pm.expect(pm.response.code).to.be.oneOf([200, 201, 204]);',
									'    });',
									'} else {',
									'    logger.info("❌ Password update failed:", pm.response.code);',
									'    try {',
									'        const jsonData = pm.response.json();',
									'        if (jsonData.error) {',
									'            logger.info("   Error:", jsonData.error);',
									...
									'            }',
									'            if (jsonData.details) {',
									'                logger.info("   Details:", JSON.stringify(jsonData.details, null, 2));',
									'            }',
									'        }',
									'    } catch (e) {',
									'        // Response may not be JSON',
