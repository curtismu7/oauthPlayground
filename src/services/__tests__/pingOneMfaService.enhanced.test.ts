...
describe('Enhanced PingOneMfaService', () => {
  ...
  beforeEach(() => {
    ...
    mockQRCodeService.generateTOTPQRCode.mockResolvedValue({
      ...
      totpUri: 'otpauth://totp/PingOne%20MFA:test@example.com?secret=JBSWY3DPEHPK3PXP&issuer=PingOne%20MFA',
      manualEntryKey: 'JBSW Y3DP EHPK 3PXP',
      backupCodes: ['1234-5678', '2345-6789', '3456-7890', '4567-8901', '5678-9012', '6789-0123', '7890-1234', '8901-2345']
    });
  ...
  describe('generateDeviceQRCode', () => {
    ...
    it('should reject non-TOTP devices', async () => {
      ...
      await expect(PingOneMfaService.generateDeviceQRCode(mockCredentials, smsDevice))
    ...
    it('should reject devices without secret', async () => {
      ...
      await expect(PingOneMfaService.generateDeviceQRCode(mockCredentials, deviceWithoutSecret))
    ...
    it('should handle QRCodeService errors', async () => {
      ...
      await expect(PingOneMfaService.generateDeviceQRCode(mockCredentials, mockTotpDevice))
  ...
  describe('getDeviceSetupData', () => {
    ...
    it('should handle SMS device setup data', async () => {
      ...
      expect(result.setupInstructions).toContain('Verification codes will be sent to your phone via SMS');
    ...
    it('should handle QR code generation failure gracefully', async () => {
      ...
      expect(result.alternativeMethods.manualEntry?.instructions).toContain('QR code generation failed');
    });
    ...
    it('should support custom options', async () => {
      ...
      const result = await PingOneMfaService.getDeviceSetupData(mockCredentials, mockTotpDevice, options);
