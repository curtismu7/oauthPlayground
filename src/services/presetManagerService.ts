...
const BUILT_IN_PRESETS: ConfigurationPreset[] = [
	...
	// Single Page Applications
	{
		...
		configuration: {
			enabled: true,
			redirectUris: ['https://localhost:3000/callback', 'https://app.company.com/callback'],
			postLogoutRedirectUris: ['https://localhost:3000', 'https://app.company.com'],
			grantTypes: ['authorization_code', 'refresh_token'],
			responseTypes: ['code'],
...

	{
		...
		configuration: {
			enabled: true,
			redirectUris: ['https://localhost:4200/callback', 'https://app.company.com/callback'],
			postLogoutRedirectUris: ['https://localhost:4200', 'https://app.company.com'],
			grantTypes: ['authorization_code', 'refresh_token'],
			responseTypes: ['code'],
			tokenEndpointAuthMethod: 'none',
			pkceEnforcement: 'REQUIRED',
...

	{
		...
		configuration: {
			enabled: true,
			redirectUris: ['https://localhost:8080/callback', 'https://app.company.com/callback'],
			postLogoutRedirectUris: ['https://localhost:8080', 'https://app.company.com'],
			grantTypes: ['authorization_code', 'refresh_token'],
			responseTypes: ['code'],
			tokenEndpointAuthMethod: 'none',
			pkceEnforcement: 'REQUIRED',
	...
	// OAuth Implicit Flow Presets
	{
		...
		configuration: {
			enabled: true,
			redirectUris: ['https://localhost:3000', 'https://app.company.com'],
			postLogoutRedirectUris: ['https://localhost:3000', 'https://app.company.com'],
			grantTypes: ['implicit'],
			responseTypes: ['token'],
			tokenEndpointAuthMethod: 'none',
