...
export class FlowConfigService {
  ...
  private static createImplicitConfig(): FlowConfig {
    return {
      ...
      category: 'deprecated',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the Implicit Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Authorization Request', 'Build and launch the authorization URL', 'request'),
        this.createStepConfig(2, 'Step 2: Token Response', 'Receive tokens directly from URL fragment', 'response'),
        this.createStepConfig(3, 'Step 3: Token Introspection', 'Validate and inspect tokens', 'validation'),
        this.createStepConfig(4, 'Step 4: Security Features', 'Advanced security demonstrations', 'completion'),
      ],
  ...
  private static createAuthorizationCodeConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the Authorization Code Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Authorization Request', 'Build and launch the authorization URL', 'request'),
        this.createStepConfig(2, 'Step 2: Code Exchange', 'Exchange authorization code for tokens', 'response'),
        this.createStepConfig(3, 'Step 3: Token Introspection', 'Validate and inspect tokens', 'validation'),
        this.createStepConfig(4, 'Step 4: Security Features', 'Advanced security demonstrations', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
  ...
  private static createClientCredentialsConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the Client Credentials Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Client Authentication', 'Configure client credentials', 'credentials'),
        this.createStepConfig(2, 'Step 2: Token Request', 'Request access token using client credentials', 'request'),
        this.createStepConfig(3, 'Step 3: Token Response', 'Review the received access token', 'response'),
        this.createStepConfig(4, 'Step 4: Security Features', 'Advanced security demonstrations', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
      validationRules: [
  ...
  private static createDeviceAuthorizationConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the Device Authorization Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Device Code Request', 'Request device code from authorization server', 'request'),
        this.createStepConfig(2, 'Step 2: User Authorization', 'Complete authorization on device', 'response'),
        this.createStepConfig(3, 'Step 3: Token Polling', 'Poll for tokens', 'validation'),
        this.createStepConfig(4, 'Step 4: Token Response', 'Review the received tokens', 'response'),
  ...
  private static createResourceOwnerPasswordConfig(): FlowConfig {
    return {
      ...
      category: 'deprecated',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the Resource Owner Password Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Credentials Configuration', 'Configure client and user credentials', 'credentials'),
        this.createStepConfig(2, 'Step 2: Token Request', 'Request access token using user credentials', 'request'),
        this.createStepConfig(3, 'Step 3: Token Response', 'Review the received access token', 'response'),
        this.createStepConfig(4, 'Step 4: Security Features', 'Advanced security demonstrations', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
  ...
  private static createJWTBearerConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the JWT Bearer Token Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: JWT Configuration', 'Configure JWT signing key', 'credentials'),
        this.createStepConfig(2, 'Step 2: Token Request', 'Request access token using JWT assertion', 'request'),
        this.createStepConfig(3, 'Step 3: Token Response', 'Review the received access token', 'response'),
  ...
  private static createOIDCAuthorizationCodeConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the OIDC Authorization Code Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Authorization Request', 'Build and launch the authorization URL', 'request'),
        this.createStepConfig(2, 'Step 2: Code Exchange', 'Exchange authorization code for tokens', 'response'),
        this.createStepConfig(3, 'Step 3: User Info Request', 'Request user information', 'validation'),
        this.createStepConfig(4, 'Step 4: Complete', 'Review results and next steps', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
      validationRules: [
  ...
  private static createOIDCImplicitConfig(): FlowConfig {
    return {
      ...
      category: 'deprecated',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the OIDC Implicit Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Authorization Request', 'Build and launch the authorization URL', 'request'),
        this.createStepConfig(2, 'Step 2: Token Response', 'Receive tokens directly from URL fragment', 'response'),
        this.createStepConfig(3, 'Step 3: User Info Request', 'Request user information', 'validation'),
        this.createStepConfig(4, 'Step 4: Complete', 'Review results and next steps', 'completion'),
  ...
  private static createOIDCHybridConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the OIDC Hybrid Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Authorization Request', 'Build and launch the authorization URL', 'request'),
        this.createStepConfig(2, 'Step 2: Token Response', 'Receive tokens and authorization code', 'response'),
        this.createStepConfig(3, 'Step 3: Code Exchange', 'Exchange authorization code for additional tokens', 'validation'),
        this.createStepConfig(4, 'Step 4: Complete', 'Review results and next steps', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
      validationRules: [
  ...
  private static createOIDCClientCredentialsConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the OIDC Client Credentials Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Client Authentication', 'Configure client credentials', 'credentials'),
        this.createStepConfig(2, 'Step 2: Token Request', 'Request access token using client credentials', 'request'),
        this.createStepConfig(3, 'Step 3: Token Response', 'Review the received access token', 'response'),
        this.createStepConfig(4, 'Step 4: Complete', 'Review results and next steps', 'completion'),
  ...
  private static createOIDCDeviceAuthorizationConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the OIDC Device Authorization Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Device Code Request', 'Request device code from authorization server', 'request'),
        this.createStepConfig(2, 'Step 2: User Authorization', 'Complete authorization on device', 'response'),
        this.createStepConfig(3, 'Step 3: Token Polling', 'Poll for tokens', 'validation'),
        this.createStepConfig(4, 'Step 4: Token Response', 'Review the received tokens', 'response'),
  ...
  private static createOIDCCIBAConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the OIDC CIBA Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: CIBA Request', 'Initiate CIBA authentication request', 'request'),
        this.createStepConfig(2, 'Step 2: User Authorization', 'Complete CIBA authentication', 'response'),
        this.createStepConfig(3, 'Step 3: Token Polling', 'Poll for tokens', 'validation'),
        this.createStepConfig(4, 'Step 4: Token Response', 'Review the received tokens', 'response'),
        this.createStepConfig(5, 'Step 5: Complete', 'Review results and next steps', 'completion'),
      ],
  ...
  private static createWorkerTokenConfig(): FlowConfig {
    return {
      ...
      category: 'pingone',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the Worker Token Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Worker Configuration', 'Configure worker credentials', 'credentials'),
        this.createStepConfig(2, 'Step 2: Token Request', 'Request worker token', 'request'),
        this.createStepConfig(3, 'Step 3: Token Response', 'Review the received worker token', 'response'),
        this.createStepConfig(4, 'Step 4: Complete', 'Review results and next steps', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
      validationRules: [
  ...
  private static createPingOnePARConfig(): FlowConfig {
    return {
      ...
      category: 'pingone',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the PingOne PAR Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: PAR Request', 'Create Pushed Authorization Request', 'request'),
        this.createStepConfig(2, 'Step 2: Authorization Request', 'Build authorization URL with request_uri', 'request'),
        this.createStepConfig(3, 'Step 3: Code Exchange', 'Exchange authorization code for tokens', 'response'),
        this.createStepConfig(4, 'Step 4: Complete', 'Review results and next steps', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
      validationRules: [
  ...
  private static createRedirectlessConfig(): FlowConfig {
    return {
      ...
      category: 'pingone',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand the Redirectless Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: PKCE Parameters', 'Generate secure PKCE codes', 'credentials'),
        this.createStepConfig(2, 'Step 2: Authorization Request', 'Build authorization URL with response_mode=pi.flow', 'request'),
        this.createStepConfig(3, 'Step 3: Flow Response', 'Receive and process flow object', 'response'),
        this.createStepConfig(4, 'Step 4: Token Response', 'Receive tokens in JSON format', 'response'),
        this.createStepConfig(5, 'Step 5: Complete', 'Review results and next steps', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
      validationRules: [
  ...
  private static createTokenIntrospectionConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand Token Introspection', 'introduction'),
        this.createStepConfig(1, 'Step 1: Configuration', 'Configure credentials and access token', 'credentials'),
        this.createStepConfig(2, 'Step 2: Introspection Request', 'Introspect the access token', 'request'),
        this.createStepConfig(3, 'Step 3: Introspection Response', 'Review the introspection results', 'response'),
        this.createStepConfig(4, 'Step 4: Complete', 'Review results and next steps', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
      validationRules: [
  ...
  private static createTokenRevocationConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand Token Revocation', 'introduction'),
        this.createStepConfig(1, 'Step 1: Configuration', 'Configure credentials and access token', 'credentials'),
        this.createStepConfig(2, 'Step 2: Revocation Request', 'Revoke the access token', 'request'),
        this.createStepConfig(3, 'Step 3: Revocation Response', 'Review the revocation results', 'response'),
        this.createStepConfig(4, 'Step 4: Complete', 'Review results and next steps', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
      validationRules: [
  ...
  private static createUserInfoConfig(): FlowConfig {
    return {
      ...
      category: 'standard',
      stepConfigs: [
        this.createStepConfig(0, 'Step 0: Introduction & Setup', 'Understand User Info Flow', 'introduction'),
        this.createStepConfig(1, 'Step 1: Configuration', 'Configure access token', 'credentials'),
        this.createStepConfig(2, 'Step 2: User Info Request', 'Request user information', 'request'),
        this.createStepConfig(3, 'Step 3: User Info Response', 'Review the received user information', 'response'),
        this.createStepConfig(4, 'Step 4: Complete', 'Review results and next steps', 'completion'),
      ],
      introSectionKeys: ['overview', 'flowDiagram', 'credentials', 'results'],
      validationRules: [
