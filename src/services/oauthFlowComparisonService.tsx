...
import { FiCheckCircle, FiXCircle, FiAlertTriangle, FiUsers, FiShield, FiGlobe } from 'react-icons/fi';
			...
			>
						<InfoBox $variant="info">
							...
							<div>
								...
								<InfoText>
									OAuth 2.0 provides multiple flows for different scenarios. This table helps you understand
									when to use each flow and how they differ in terms of authentication, security, and use cases.
								</InfoText>
							</div>
						</InfoBox>
							...
							<Table>
								...
								<Tbody>
									<tr>
										...
										<Td>
											Social login, SaaS applications, consumer apps
										</Td>
									</tr>
									...
									<tr>
										...
										<Td>
											Google Service Accounts, Auth0 M2M, API gateways
										</Td>
									</tr>
						...
						{highlightFlow && (
							<InfoBox $variant="warning" style={{ marginTop: '1.5rem' }}>
								...
								<div>
									<InfoTitle>
										{highlightFlow === 'jwt' ? 'JWT Bearer Token Flow' : 'SAML Bearer Assertion Flow'} - Educational Mock
									</InfoTitle>
									<InfoText>
										This flow is a <strong>mock/educational implementation</strong> because PingOne does not
										support {highlightFlow === 'jwt' ? 'JWT Bearer' : 'SAML Bearer'} assertions. However, this flow is widely
										used in enterprise OAuth servers and is valuable to understand for real-world OAuth implementations.
									</InfoText>
									<InfoText>
										<strong>Where it's used:</strong> Enterprise OAuth servers like Okta, Auth0, Azure AD, and Google Cloud
										support this flow for {highlightFlow === 'jwt' ? 'service account' : 'enterprise SSO'} scenarios.
									</InfoText>
								</div>
							</InfoBox>
						)}
