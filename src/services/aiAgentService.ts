		...
		return {
			flows: [
				{
					...
					description:
						'Complete OAuth 2.0 Authorization Code flow with PKCE support. Best for web and mobile apps.',
				...
				},
				{
					...
					description:
						'OAuth flow for input-constrained devices like smart TVs, IoT devices, and printers.',
				...
				},
				{
					name: 'Implicit Flow',
					description:
						'Legacy OAuth flow for single-page applications (deprecated, use Authorization Code with PKCE instead).',
				...
				},
				{
					...
					description:
						'Decoupled authentication flow where authentication happens on a different device.',
					path: '/flows/ciba-v7',
				...
				},
				{
					name: 'Hybrid Flow',
					description:
						'Combination of Authorization Code and Implicit flows for advanced scenarios.',
				...
				},
				{
					...
					description:
						'Direct username/password authentication (use only when redirect flows are not possible).',
				...
				},
				{
					...
					description:
						'Enhanced security by pushing authorization parameters directly to the authorization server.',
			...
			features: [
				{
					...
					description:
						'Manage, inspect, and analyze OAuth tokens including access tokens, refresh tokens, and ID tokens.',
				...
				},
				{
					...
					description:
						'Complete reference of available PingOne OAuth scopes and their permissions.',
				...
				},
				{
					name: 'Documentation',
					description:
						'Browse complete documentation for OAuth, OIDC, and the playground features.',
					path: '/documentation',
			...
			docs: [
				{
					...
					content:
						'Complete guide to using the OAuth Playground, including all features, flows, and best practices.',
					path: '/about',
					keywords: [
						'guide',
						'user',
			...
			apiDocs: [
				{
					...
					content:
						'Complete PingOne Platform API documentation including authentication, authorization, and management APIs.',
				...
				},
				{
					...
					content:
						'Authentication and authorization endpoints for OAuth 2.0, OpenID Connect, and SAML flows.',
				...
				},
				{
					...
					content:
						'Manage users, including creation, updates, password management, and user attributes.',
				...
				},
				{
					...
					content:
						'Manage OAuth/OIDC applications, including client credentials, redirect URIs, and application settings.',
				...
				},
				{
					...
					content:
						'Manage PingOne environments, including creation, configuration, and environment settings.',
				...
				},
				{
					...
					content:
						'Manage user populations for organizing and segmenting users within an environment.',
				...
				},
				{
					...
					content:
						'Multi-factor authentication APIs for SMS, email, TOTP, and FIDO2 authentication methods.',
				...
				},
				{
					...
					content:
						'Manage digital credentials and verifiable credentials for decentralized identity.',
				...
				},
				{
					...
					content:
						'Risk management and policy evaluation for adaptive authentication and fraud detection.',
				...
				},
				{
					...
					content:
						'Complete reference of OAuth scopes available in PingOne for API access control.',
			...
			specs: [
				...
				},
				{
					...
					content:
						'OAuth 2.1 consolidates best practices and security recommendations into a single specification.',
				...
				},
				{
					...
					content:
						'OAuth 2.0 Device Authorization Grant for browserless and input-constrained devices.',
			...
			workflows: [
				{
					...
					content:
						'Complete guide to PingOne workflow library for common identity and access management scenarios.',
				...
				},
				{
					...
					content:
						'Step-by-step workflow for assigning MFA sign-on policies to web applications in PingOne.',
				...
				},
				{
					...
					content:
						'Workflow for integrating social identity providers (Google, Facebook, etc.) with PingOne.',
			...
			userGuide: [
				{
					...
					content:
						'Comprehensive guide covering all OAuth Playground features, flows, educational content, developer tools, and PingOne API best practices.',
					path: '/about',
					keywords: [
						'guide',
						'user',
				...
				},
				{
					...
					content:
						'Learn about all available OAuth flows including Authorization Code, Client Credentials, Device Code, JWT Bearer, RAR, CIBA, and more.',
					path: '/about',
					keywords: [
						'flows',
						'oauth',
				...
				},
				{
					...
					content:
						'Complete guide to OIDC features including user authentication, ID token validation, user profile retrieval, and session management.',
					path: '/about',
					keywords: [
						'oidc',
						'openid',
				...
				},
				{
					...
					content:
						'Step-by-step guides, visual flow diagrams, code examples, best practices, and multiple flow versions (V1-V7) for learning.',
					path: '/about',
					keywords: [
						'educational',
						'learning',
				...
				},
				{
					...
					content:
						'Token analysis tools including JWT decoder, token introspection, claims inspection, signature validation, and API testing capabilities.',
					path: '/about',
					keywords: [
						'developer',
						'tools',
				...
				},
				{
					...
					content:
						'Essential best practices for PingOne APIs including user lookup, filter syntax, password operations, content-type patterns, and common field names.',
					path: '/about',
					keywords: [
						'pingone',
						'api',
				...
				},
				{
					...
					content:
						'Filter syntax rules, URL encoding, supported attributes, UUID validation, and fallback search mechanisms for PingOne user lookups.',
					path: '/about',
					keywords: [
						'user',
						'lookup',
				...
				},
				{
					...
					content:
						'Critical content-type patterns for password operations: force change, unlock, check password, and set password with proper field names.',
					path: '/about',
					keywords: [
						'password',
						'operations',
