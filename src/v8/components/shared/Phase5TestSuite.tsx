	...
	return (
		<div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
			...
			<section style={{ marginBottom: '40px' }}>
				...
				>
					<p>
						<strong>Memory Usage:</strong> Check browser dev tools
					</p>
					<p>
						<strong>Network Requests:</strong> Check browser dev tools
					</p>
					<p>
						<strong>Render Performance:</strong> Check browser dev tools
					</p>
					<p>
						<strong>Lazy Loading:</strong> Scroll down to test intersection observer
					</p>
				</div>
			</section>
			...
			<section style={{ marginBottom: '40px' }}>
				...
				<div style={{ height: '300px' }}>
					<LazyLoadWrapperV8
						loader={() =>
							import('./FlowProgressTrackerV8').then((module) => ({
								default: module.FlowProgressTrackerV8,
							}))
						}
						threshold={0.1}
						delay={500}
