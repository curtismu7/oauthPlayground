...
import { FiAlertCircle, FiInfo, FiX, FiArrowLeft } from 'react-icons/fi';
	...
	return (
		<ModalOverlay role="presentation" onClick={onClose} $hasPosition={hasPosition}>
			...
			>
				...
				<ModalBody>
					<p style={{ marginTop: 0 }}>
						You already have a FIDO2 device registered. PingOne allows only one FIDO device per user account.
						To register a different FIDO device, you'll need to delete your existing device first.
					</p>
					...
					<InfoCallout>
						...
						<InfoContent>
							...
							<ul style={{ margin: '0.5rem 0 0', paddingLeft: '1.25rem', color: '#1e40af' }}>
								...
								<li style={{ marginBottom: '0.35rem' }}>
									<strong>Choose a different device type:</strong> You can register multiple devices of
									other types (SMS, Email, TOTP) if needed.
								</li>
							</ul>
						</InfoContent>
					</InfoCallout>
