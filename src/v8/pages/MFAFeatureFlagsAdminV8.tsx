...
export const MFAFeatureFlagsAdminV8: React.FC = () => {
	...
	const handleEnableAll = (percentage: RolloutPercentage) => {
		modernMessaging.showBanner({
			...
			message: `Enable all devices at ${percentage}% rollout?`,
			actions: [
	...
	const handleDisableAll = () => {
		modernMessaging.showBanner({
			...
			message: 'Disable all devices (emergency rollback)?',
			actions: [
				{ label: 'Cancel', action: () => modernMessaging.hideBanner() },
				{
					label: 'Disable',
	...
	const resetAll = () => {
		modernMessaging.showBanner({
			...
			message: 'Reset all feature flags to defaults? This will disable all unified flows.',
			actions: [
				{ label: 'Cancel', action: () => modernMessaging.hideBanner() },
				{
					label: 'Reset',
							...
							<div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
								...
								<div>
									...
									>
										...
										<li>
											<strong>Bucketing:</strong> Same user always gets same experience
											(deterministic)
										</li>
										<li>
