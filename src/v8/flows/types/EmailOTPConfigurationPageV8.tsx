/**
 * @file EmailOTPConfigurationPageV8.tsx
 * @module v8/flows/types
 * @description Email/OTP Configuration and Education Page
 * @version 8.0.0
 *
 * This page provides:
 * - Email/OTP education and information
...
import { FiMail, FiShield, FiInfo, FiArrowRight, FiSettings, FiBook, FiCheckCircle, FiX } from 'react-icons/fi';
...
export const EmailOTPConfigurationPageV8: React.FC = () => {
	...
	const otpEducation = MFAEducationServiceV8.getFactorEducation('EMAIL');
	...
	return (
		<div style={{ minHeight: '100vh', background: '#f9fafb' }}>
			...
			<div style={{ 
				...
				{!tokenStatus.isValid && (
					...
					>
						...
						<p style={{ margin: '0 0 16px 0', fontSize: '14px', color: '#6b7280' }}>
							A worker token is required to register email devices and manage MFA policies.
						</p>
						<button
							type="button"
				...
				>
					<div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
						<FiBook size={24} color="#8b5cf6" />
						<h2 style={{ margin: 0, fontSize: '20px', fontWeight: '600', color: '#1f2937' }}>
							About Email / OTP Authentication
						</h2>
					</div>
					<div style={{ fontSize: '14px', color: '#6b7280', lineHeight: 1.6 }}>
						...
						<ul style={{ margin: '0 0 12px 0', paddingLeft: '20px' }}>
							...
							<li>Accessible: Works on any device with email access</li>
				...
				<div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
					...
					<button
						...
						style={{
							...
							border: 'none',
							borderRadius: '6px',
							background: selectedDeviceAuthPolicy && tokenStatus.isValid ? '#8b5cf6' : '#9ca3af',
							color: 'white',
							fontSize: '16px',
							fontWeight: '600',
