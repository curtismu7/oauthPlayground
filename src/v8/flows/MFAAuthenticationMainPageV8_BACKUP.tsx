...
export const MFAAuthenticationMainPageV8: React.FC = () => {
	...
	const [maxPollingAttempts] = useState(30);
	const [showDeviceCodePollingModal, setShowDeviceCodePollingModal] = useState(false);
	...
	return (
		...
		>
			...
			{/* Device Code Polling Modal */}
			<DeviceCodePollingModal
				show={showDeviceCodePollingModal}
				status={pollingStatus}
				attempts={pollingAttempts}
				maxAttempts={maxPollingAttempts}
				onCancel={() => {
					setShowDeviceCodePollingModal(false);
...
export const MFAAuthenticationMainPageV8: React.FC = () => {
	return (
		<div style={{ padding: '20px', textAlign: 'center' }}>
			...
			<p>This component is temporarily disabled for testing modal spinner functionality.</p>
