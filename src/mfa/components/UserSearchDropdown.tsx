...
import { checkWorkerTokenStatusSync } from '@/mfa/services/workerTokenStatusService';
...
export const UserSearchDropdown: React.FC<UserSearchDropdownV8Props> = ({
	environmentId,
	value,
	onChange,
	...
	const loadUsers = useCallback(
		async (search: string = '', reset: boolean = true) => {
			...
			try {
				...
				// Use environmentId if available, otherwise let MFAService handle it internally
				const result = await MFAService.listUsers(
