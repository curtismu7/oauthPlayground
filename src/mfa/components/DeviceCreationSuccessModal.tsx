// src/mfa/components/DeviceCreationSuccessModal.tsx
...
import { getDeviceTypeDisplay } from '../flows/shared/mfaSuccessPageService';

const _MODULE_TAG = '[DeviceCreationSuccessModal]';
...
export const DeviceCreationSuccessModal: React.FC<DeviceCreationSuccessModalV8Props> = ({
	isOpen,
	onClose,
	deviceInfo,
}) => {
