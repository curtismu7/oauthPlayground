/**
 * @file ShowTokenConfigCheckbox.tsx
 ...
 * Uses the useWorkerTokenConfig hook for consistent state management.
 * Wraps row in <label> with htmlFor so the whole row is clickable.
 */
export const ShowTokenConfigCheckbox: React.FC<ShowTokenConfigCheckboxV8Props> = ({
	className = '',
	style = {},
	...
	const id = useId();
	const { showTokenAtEnd, updateShowTokenAtEnd, isReady } = useWorkerTokenConfig();
...
export default ShowTokenConfigCheckbox;
