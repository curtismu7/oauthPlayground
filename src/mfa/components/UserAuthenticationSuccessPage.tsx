/**
 * @file UserAuthenticationSuccessPage.tsx
 ...
 */
export const UserAuthenticationSuccessPage: React.FC<UserAuthenticationSuccessPageV8Props> = ({
				...
				>
					...
					<div style={{ display: 'grid', gap: '12px' }}>
						...
						>
							...
							{TokenDisplayService.isJWT(sessionInfo.accessToken) && (
								<button
									type="button"
									onClick={() => {
										const decoded = TokenDisplayService.decodeJWT(sessionInfo.accessToken);
										if (decoded) {
				...
				{sessionInfo.idToken && (
					...
					>
						...
						>
							...
							{TokenDisplayService.isJWT(sessionInfo.idToken) && (
								<button
									type="button"
									onClick={() => {
										const decoded = TokenDisplayService.decodeJWT(sessionInfo.idToken!);
										if (decoded) {
											const payload = JSON.stringify(decoded.payload, null, 2);
