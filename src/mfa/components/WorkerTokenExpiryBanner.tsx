/**
 * @file WorkerTokenExpiryBanner.tsx
...
export interface WorkerTokenExpiryBannerV8Props {
	/** Called when the user clicks "Fix Token" — typically opens WorkerTokenModal */
	onFixToken: () => void;
...
export const WorkerTokenExpiryBanner: React.FC<WorkerTokenExpiryBannerV8Props> = ({
	onFixToken,
...
export default WorkerTokenExpiryBanner;
