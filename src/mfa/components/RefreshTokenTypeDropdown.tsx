/**
 * @file RefreshTokenTypeDropdown.tsx
...
/**
 * RefreshTokenTypeDropdown - Dropdown for selecting refresh token type
 *
 ...
 * @component
 */
export const RefreshTokenTypeDropdown: React.FC<RefreshTokenTypeDropdownV8Props> = ({
	value,
	onChange,
	disabled = false,
	className,
