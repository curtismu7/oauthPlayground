 ...
 * Replaces the old UserCacheProgress component that used IndexedDB.
 */

import React from 'react';
import { useSQLiteStats } from '@/mfa/hooks/useSQLiteStats';
 ...
 * ```
 */
export const SQLiteStatsDisplay: React.FC<SQLiteStatsDisplayV8Props> = ({
	environmentId,
	compact = false,
	refreshInterval = 30,
...
export default SQLiteStatsDisplay;
