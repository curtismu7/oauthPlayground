/**
 * @file WorkerTokenPromptModal.tsx
...
import { PINGONE_WORKER_MFA_SCOPE_STRING } from '@/mfa/config/constants';
...
export const WorkerTokenPromptModal: React.FC<WorkerTokenPromptModalV8Props> = ({
	isOpen,
	onClose,
	onGetToken,
}) => {
