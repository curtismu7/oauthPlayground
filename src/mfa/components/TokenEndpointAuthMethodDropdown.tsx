/**
 * @file TokenEndpointAuthMethodDropdown.tsx
...
} from '@/mfa/services/tokenEndpointAuthMethodService';
...
export const TokenEndpointAuthMethodDropdown: React.FC<
...
> = ({
	...
	const _availableMethods = TokenEndpointAuthMethodService.getAuthMethods(
		flowType,
		specVersion,
		usePKCE
	);
	const allMethodsWithStatus = TokenEndpointAuthMethodService.getAllAuthMethodsWithStatus(
		flowType,
		specVersion,
		usePKCE
	);
...
export default TokenEndpointAuthMethodDropdown;
