/**
 * @file SuperSimpleApiDisplay.tsx
...
export const SuperSimpleApiDisplay: React.FC<SuperSimpleApiDisplayV8Props> = ({
	flowFilter = 'all',
	excludePatterns = [],
	includePatterns = [],
	reserveSpace = false,
		...
		try {
			...
			if (serverHealth.isOnline) {
				try {
					...
					logger.error('[SuperSimpleApiDisplay] Failed to fetch API calls:', {
						error,
						errorMessage,
					...
					>
						...
						>
							...
							<div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
								...
								<button
									type="button"
									onClick={() => apiDisplayService.hide()}
									style={{
										...headerButtonBaseStyle,
										background: '#6b7280',
										color: 'white',
