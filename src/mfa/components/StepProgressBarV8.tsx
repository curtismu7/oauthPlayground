...
import { StepProgressBarProps } from '@/mfa/types/stepNavigation';
 ...
 */
export const StepProgressBarV8: React.FC<StepProgressBarProps> = ({
	currentStep,
	totalSteps,
	completedSteps,
	className = '',
}) => {
	logger.info(`${MODULE_TAG} Rendering progress bar`, {
		currentStep,
		totalSteps,
...
export default StepProgressBarV8;
