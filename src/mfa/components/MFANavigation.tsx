 ...
 * <MFANavigation currentPage="hub" showBackToMain={true} />
 */
...
import { MFADocumentationModal } from './MFADocumentationModal';
import { ApiDisplayCheckbox } from './SuperSimpleApiDisplay';
...
export const MFANavigation: React.FC<MFANavigationV8Props> = ({
	currentPage,
	...
	return (
		<>
			...
			<MFADocumentationModal isOpen={showDocsModal} onClose={() => setShowDocsModal(false)} />
			<style>{`
				.mfa-nav-links {
					display: flex;
					gap: 6px;
