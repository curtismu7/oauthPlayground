/**
 * @file useStepNavigation.test.ts
 * @module v8/hooks/__tests__
 * @description Tests for useStepNavigation hook
 * @version 8.0.0
 * @since 2024-11-16
 */
...
describe('useStepNavigation', () => {
	...
	describe('Initial State', () => {
		...
		it('should initialize with custom initial step', () => {
			const { result } = renderHook(() => useStepNavigation(4, { initialStep: 2 }));
	...
	describe('Step Navigation', () => {
		...
		it('should go to previous step', () => {
			const { result } = renderHook(() => useStepNavigation(4, { initialStep: 1 }));
		...
		it('should not go beyond last step', () => {
			const { result } = renderHook(() => useStepNavigation(4, { initialStep: 3 }));
	...
	describe('Callbacks', () => {
		it('should call onStepChange when step changes', () => {
			...
			const { result } = renderHook(() => useStepNavigation(4, { onStepChange }));
		...
		it('should call onValidationChange when errors change', () => {
			...
			const { result } = renderHook(() => useStepNavigation(4, { onValidationChange }));
	...
	describe('Edge Cases', () => {
		...
		it('should handle many steps', () => {
			const { result } = renderHook(() => useStepNavigation(100));
