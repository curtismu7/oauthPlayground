 ...
 *
 * @example
 * const responseTypes = ResponseTypeService.getResponseTypes('oauth-authz', 'oidc');
...
export class ResponseTypeService {
	...
	static getDefaultResponseType(flowType: FlowType, specVersion: SpecVersion): ResponseType {
		const types = ResponseTypeService.getResponseTypes(flowType, specVersion);
	...
	static isResponseTypeValid(
		...
		const validTypes = ResponseTypeService.getResponseTypes(flowType, specVersion);
