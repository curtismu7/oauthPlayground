/**
 * @file unifiedMFASuccessPageService.tsx
 * @module v8/services
...
export const UnifiedMFASuccessPage: React.FC<UnifiedMFASuccessPageProps> = ({
	data,
	onStartAgain,
}) => {
	...
	if (deviceTypeStr === 'FIDO2' || deviceType === 'FIDO2') {
		logger.info('[UnifiedMFASuccessPage] FIDO2 documentation button check:', {
			deviceType,
			deviceTypeStr,
			flowType,
			hasDocumentation,
				...
				>
					...
					<div style={{ display: 'grid', gap: '12px' }}>
						...
						>
							...
							{TokenDisplayService.isJWT(completionResult.accessToken) && (
								<button
									type="button"
									onClick={() => {
										const decoded = TokenDisplayService.decodeJWT(completionResult.accessToken!);
										if (decoded) {
