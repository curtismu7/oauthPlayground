// src/mfa/services/deviceCreateDemoService.ts
/**
 * @module v8/services
...
export async function sendCreateDeviceRequest(
	...
	try {
		...
		logger.info(
			`${MODULE_TAG} Device created successfully for user ${trimmedUserId}`,
			'Logger info'
		);
...
export const deviceCreateDemoService = {
	sendCreateDeviceRequest,
};

export default deviceCreateDemoService;
