/**
 * @file emailMfaSignOnFlowService.ts
 * @module v8/services
 ...
 */
export class EmailMFASignOnFlowService {
	/**
	 * Get worker token
	 */
	...
	static async createApplication(
		...
		const workerToken = await EmailMFASignOnFlowService.getWorkerToken();
		...
		try {
			const response = await EmailMFASignOnFlowService.pingOneFetch(
