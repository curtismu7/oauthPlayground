/**
 * @file unifiedMFASuccessPageService.test.tsx
 * @module v8/services/__tests__
 * @description Unit tests for UnifiedMFASuccessPage validation insights
 * @version 9.15.0
 * @since 2026-03-06
 */

import { vi, beforeEach, describe, expect, it } from 'vitest';
import type { UnifiedMFASuccessPageProps } from '../unifiedMFASuccessPageService';
...
vi.mock('../../services/apiDisplayService', () => ({
	apiDisplayService: {
...
describe('UnifiedMFASuccessPage', () => {
