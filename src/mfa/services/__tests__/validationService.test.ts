 ...
 * @description Tests for ValidationService
 * @version 8.0.0
 * @since 2024-11-16
 */
...
describe('ValidationService', () => {
	...
	describe('validateOIDCScopes', () => {
		it('should pass when openid scope is present', () => {
			const result = ValidationService.validateOIDCScopes('openid profile email');
		...
		it('should fail when openid scope is missing', () => {
			const result = ValidationService.validateOIDCScopes('profile email');
		...
		it('should fail when scopes are empty', () => {
			const result = ValidationService.validateOIDCScopes('');
		...
		it('should warn about offline_access scope', () => {
			const result = ValidationService.validateOIDCScopes('openid profile offline_access');
	...
	describe('validateOAuthScopes', () => {
		it('should pass with any non-empty scopes', () => {
			const result = ValidationService.validateOAuthScopes('profile email');
		...
		it('should fail when scopes are empty', () => {
			const result = ValidationService.validateOAuthScopes('');
	...
	describe('validateUrl', () => {
		it('should validate valid HTTP localhost URL', () => {
			const result = ValidationService.validateUrl('http://localhost:3000/callback', 'redirect');
		...
		it('should validate valid HTTPS URL', () => {
			const result = ValidationService.validateUrl('https://example.com/callback', 'redirect');
		...
		it('should fail for invalid URL format', () => {
			const result = ValidationService.validateUrl('not-a-url', 'redirect');
		...
		it('should fail for empty URL', () => {
			const result = ValidationService.validateUrl('', 'redirect');
		...
		it('should require HTTPS for issuer URLs (non-localhost)', () => {
			const result = ValidationService.validateUrl('http://example.com', 'issuer');
		...
		it('should allow HTTP for localhost issuer', () => {
			const result = ValidationService.validateUrl('http://localhost:8080', 'issuer');

			expect(result.valid).toBe(true);
		});

		it('should warn about HTTP for non-localhost redirect', () => {
			const result = ValidationService.validateUrl('http://example.com/callback', 'redirect');
	...
	describe('validateUUID', () => {
		...
		it('should fail for invalid UUID format', () => {
			const result = ValidationService.validateUUID('not-a-uuid', 'Environment ID');
		...
		it('should fail for empty UUID', () => {
			const result = ValidationService.validateUUID('', 'Environment ID');
	...
	describe('validateAuthorizationUrlParams', () => {
		it('should validate complete authorization URL params', () => {
			...
			const result = ValidationService.validateAuthorizationUrlParams(params);
	...
	describe('validateCallbackParams', () => {
		it('should validate successful callback with code', () => {
			...
			const result = ValidationService.validateCallbackParams(params, 'expected-state');
		...
		it('should fail when callback contains error', () => {
			...
			const result = ValidationService.validateCallbackParams(params);
	...
	describe('validateTokenResponse', () => {
		it('should validate OAuth token response', () => {
			...
			const result = ValidationService.validateTokenResponse(tokens, 'oauth');
		...
		it('should validate OIDC token response with ID token', () => {
			...
			const result = ValidationService.validateTokenResponse(tokens, 'oidc');
	...
	describe('getRequiredFields', () => {
		it('should return required fields for OIDC', () => {
			const fields = ValidationService.getRequiredFields('oidc');
		...
		it('should return required fields for OAuth', () => {
			const fields = ValidationService.getRequiredFields('oauth');
		...
		it('should return required fields for client credentials', () => {
			const fields = ValidationService.getRequiredFields('client_credentials');
	...
	describe('formatWarnings', () => {
		it('should format single warning', () => {
			...
			const formatted = ValidationService.formatWarnings(warnings);
		...
		it('should return empty string for no warnings', () => {
			const formatted = ValidationService.formatWarnings([]);
