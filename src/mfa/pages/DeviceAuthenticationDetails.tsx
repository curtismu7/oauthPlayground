// src/mfa/pages/DeviceAuthenticationDetails.tsx
/**
 * @module v8/pages
...
export const DeviceAuthenticationDetails: React.FC = () => {
	...
	const runLookup = useCallback(
		async (options?: { suppressToast?: boolean }) => {
			...
			try {
				...
				const response = await MFAService.readDeviceAuthentication(requestParams);
...
export default DeviceAuthenticationDetails;
