...
import { isPopoutWindow, openDebugLogViewerPopout } from '@/mfa/utils/debugLogViewerPopoutHelper';
...
export const DebugLogViewer: React.FC = () => {
	...
	const clearLogs = () => {
		if (logSource === 'localStorage') {
			MFARedirectUriService.clearDebugLogs();
			setLogs([]);
	...
	const exportLogs = () => {
		if (logSource === 'localStorage') {
			MFARedirectUriService.exportDebugLogs();
		} else if (logSource === 'file') {
			// Export file content
