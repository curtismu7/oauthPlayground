/**
 * @file MFADeviceManagementFlow.tsx
 * @module v8/flows
...
import { MFADeviceManager } from '@/mfa/components/MFADeviceManager';
...
export const MFADeviceManagementFlow: React.FC = () => {
	...
	const [credentials, setCredentials] = useState<Credentials>(() => {
		...
		const unifiedMfaCredentials = CredentialsService.loadCredentials('mfa-flow-v8', {
			flowKey: 'mfa-flow-v8',
			flowType: 'oidc',
		...
		const deviceMgmtCredentials = CredentialsService.loadCredentials(FLOW_KEY, {
			flowKey: FLOW_KEY,
			flowType: 'oidc',
			includeClientSecret: false,
			includeRedirectUri: false,
...
export default MFADeviceManagementFlow;
