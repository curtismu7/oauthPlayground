/**
 * @file mfaSuccessPageService.tsx
 ...
 *
 * NOTE: This service now uses the UnifiedMFASuccessPage component from unifiedMFASuccessPageService
 */
...
} from '@/mfa/services/unifiedMFASuccessPageService';
...
const convertToUnifiedData = (
	...
	if (deviceType === 'FIDO2' || successData.deviceType === 'FIDO2') {
		logger.info('[MFASuccessPage] Converting FIDO2 success data:', {
 ...
 * Now uses the UnifiedMFASuccessPage component
 */
export const MFASuccessPage: React.FC<MFASuccessPageProps> = ({
	successData,
	credentials,
	onStartAgain,
	...props
	...
	return <UnifiedMFASuccessPage data={unifiedData} onStartAgain={onStartAgain || (() => {})} />;
};
