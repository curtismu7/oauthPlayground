...
import { NicknamePromptModalV8 } from '@/mfa/components/NicknamePromptModalV8';
import { SuperSimpleApiDisplayV8 } from '@/mfa/components/SuperSimpleApiDisplayV8';
import { WhatsAppNotEnabledModalV8 } from '@/mfa/components/WhatsAppNotEnabledModalV8';
...
import { fetchPhoneFromPingOne } from '@/mfa/services/phoneAutoPopulationServiceV8';
										...
										try {
											...
											if (mfaState.authenticationId && mfaState.deviceId) {
												const { MfaAuthenticationServiceV8 } = await import(
													'@/mfa/services/mfaAuthenticationServiceV8'
												);
