/**
 * @file MobileOTPConfigurationPageV8.tsx
...
import { UserLoginSectionV8 } from '@/mfa/components/UserLoginSectionV8';
...
import { MFARedirectUriServiceV8 } from '@/mfa/services/mfaRedirectUriServiceV8';
import { MFAServiceV8 } from '@/mfa/services/mfaServiceV8';
import { OAuthIntegrationServiceV8 } from '@/mfa/services/oauthIntegrationServiceV8';
import { WorkerTokenStatusServiceV8 } from '@/mfa/services/workerTokenStatusServiceV8';
import { WorkerTokenUIServiceV8 } from '@/mfa/services/workerTokenUIServiceV8';
...
export const MobileOTPConfigurationPageV8: React.FC = () => {
	...
	const [credentials, setCredentials] = useState<MFACredentials>(() => {
		...
		// #region agent log
		sendAnalyticsLog({
			location: 'MobileOTPConfigurationPageV8.tsx:45',
	...
	useEffect(() => {
		...
		// #region agent log
		sendAnalyticsLog({
			location: 'MobileOTPConfigurationPageV8.tsx:140',
			message: 'MobileOTPConfigurationPageV8 checking for callback code',
			data: {
				hasCode: !!code,
				hasError: !!error,
		...
		const processCallback = async () => {
			// #region agent log
			sendAnalyticsLog({
				location: 'MobileOTPConfigurationPageV8.tsx:159',
			...
			if (code && state) {
				...
				if (state !== hasUserLoginState) {
					// #region agent log
					sendAnalyticsLog({
						location: 'MobileOTPConfigurationPageV8.tsx:173',
				...
				try {
					...
					// #region agent log
					sendAnalyticsLog({
						location: 'MobileOTPConfigurationPageV8.tsx:186',
					...
					// #region agent log
					sendAnalyticsLog({
						location: 'MobileOTPConfigurationPageV8.tsx:211',
					...
					setCredentials((prev) => {
						...
						// #region agent log
						sendAnalyticsLog({
							location: 'MobileOTPConfigurationPageV8.tsx:224',
					...
					// #region agent log
					sendAnalyticsLog({
						location: 'MobileOTPConfigurationPageV8.tsx:228',
	...
	useEffect(() => {
		// #region agent log
		sendAnalyticsLog({
			location: 'MobileOTPConfigurationPageV8.tsx:467',
		...
		setTimeout(() => {
			...
			// #region agent log
			sendAnalyticsLog({
				location: 'MobileOTPConfigurationPageV8.tsx:479',
