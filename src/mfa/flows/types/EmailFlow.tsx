...
import { unifiedFlowLoggerService as UnifiedFlowLoggerService } from '@/lab/services/unifiedFlowLoggerServiceV8U';
import { FiMail } from '../../../icons';
import { logger } from '../../../utils/logger';
import { DeviceCreationSuccessModal } from '../../components/DeviceCreationSuccessModal';
...
const EmailFlowV8WithDeviceSelection: React.FC = () => {
	...
	React.useEffect(() => {
		...
		const fetchUserEmail = async () => {
			try {
				const user = await MFAService.lookupUserByUsername(environmentId, username);
		...
		(props: MFAFlowBaseRenderProps) => {
			...
			const handleRegisterDevice = async () => {
				...
				try {
					...
					// Use ValidationService for consistent error formatting
					const formattedError = ValidationService.formatMFAError(
