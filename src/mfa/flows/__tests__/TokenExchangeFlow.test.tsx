// src/mfa/flows/__tests__/TokenExchangeFlow.test.tsx
...
import { TokenExchangeConfigService } from '../../services/tokenExchangeConfigService';
import { TokenExchangeService } from '../../services/tokenExchangeService';
import { TokenExchangeFlow } from '../TokenExchangeFlow';

// Mock the services
vi.mock('../../services/tokenExchangeService');
vi.mock('../../services/tokenExchangeConfigService');
vi.mock('../../services/globalEnvironmentService');
vi.mock('../../utils/toastNotifications');

const mockTokenExchangeService = TokenExchangeService as any;
const mockConfigService = TokenExchangeConfigService as any;
...
describe('TokenExchangeFlow', () => {
	...
	beforeEach(() => {
		...
		// Mock TokenExchangeConfigService
