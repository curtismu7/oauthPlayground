...
const JWTGenerator: React.FC = () => {
  ...
  const handleGenerateLoginHintToken = () => {
    try {
      ...
      setMessage({ type: 'error', text: `Generation failed: ${error instanceof Error ? error.message : 'Unknown error'}` });
    }
  };

  const handleGenerateRequestObject = () => {
    try {
      if (!requestObjectForm.clientId || !requestObjectForm.redirectUri || !requestObjectForm.scope) {
        setMessage({ type: 'warning', text: 'Please fill in required fields (Client ID, Redirect URI, Scope)' });
        return;
      }
  ...
  const handleGenerateClientSecretJWT = () => {
    try {
      if (!clientSecretForm.clientId || !clientSecretForm.tokenEndpoint || !clientSecretForm.clientSecret) {
        setMessage({ type: 'warning', text: 'Please fill in required fields (Client ID, Token Endpoint, Client Secret)' });
        return;
      }
  ...
  const handleGeneratePrivateKeyJWT = () => {
    try {
      if (!privateKeyForm.clientId || !privateKeyForm.tokenEndpoint || !privateKeyForm.privateKey) {
        setMessage({ type: 'warning', text: 'Please fill in required fields (Client ID, Token Endpoint, Private Key)' });
        return;
      }
  ...
  const handleGenerateJWKS = () => {
    try {
      ...
      setMessage({ type: 'error', text: `Generation failed: ${error instanceof Error ? error.message : 'Invalid JSON format'}` });
    }
  };
      ...
      <FormSection>
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange={(e) => setLoginHintForm(prev => ({ ...prev, expiryMinutes: e.target.value }))}
          />
        </FormGroup>
      </FormSection>
    </FormContainer>
      ...
      <FormSection>
        <FormGroup>
          ...
          <Input
            ...
            onChange={(e) => setRequestObjectForm(prev => ({ ...prev, clientId: e.target.value }))}
        ...
        <FormGroup>
          ...
          <Select
            ...
            onChange={(e) => setRequestObjectForm(prev => ({ ...prev, responseType: e.target.value }))}
          >
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange={(e) => setRequestObjectForm(prev => ({ ...prev, redirectUri: e.target.value }))}
      ...
      <FormSection>
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange={(e) => setRequestObjectForm(prev => ({ ...prev, codeChallenge: e.target.value }))}
        ...
        <FormGroup>
          ...
          <Select
            ...
            onChange={(e) => setRequestObjectForm(prev => ({ ...prev, codeChallengeMethod: e.target.value }))}
          >
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange={(e) => setRequestObjectForm(prev => ({ ...prev, acrValues: e.target.value }))}
            placeholder="urn:mace:pingidentity.com:loc:1"
          />
        </FormGroup>
        <FormGroup>
      ...
      <FormSection>
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange={(e) => setClientSecretForm(prev => ({ ...prev, tokenEndpoint: e.target.value }))}
      ...
      <FormSection>
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange={(e) => setClientSecretForm(prev => ({ ...prev, expiryMinutes: e.target.value }))}
          />
        </FormGroup>
      </FormSection>
    </FormContainer>
      ...
      <FormSection>
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange={(e) => setPrivateKeyForm(prev => ({ ...prev, tokenEndpoint: e.target.value }))}
            placeholder="https://auth.pingone.com/your-env-id/as/token"
          />
        </FormGroup>
        <FormGroup>
  ...
  return (
    <GeneratorContainer>
      ...
      <TabContainer>
        ...
        <Tab $active={activeTab === 'request-object'} onClick={() => setActiveTab('request-object')}>
          Request Object
        </Tab>
