        ...
        {isEditing ? (
                        ...
                        {(provided, snapshot) => (
                          ...
                          >
                            ...
                            <div className="flex-grow-1">
                              ...
                              {device.phoneNumber && <div className="text-muted small">{device.phoneNumber}</div>}
                              {device.emailAddress && <div className="text-muted small">{device.emailAddress}</div>}
          ...
          <div>
            ...
            <div className="mt-3 text-muted small">
              ...
              <p className="mb-0">
                To change the order, click "Reorder Devices" above.
              </p>
            </div>
          </div>
        )}
