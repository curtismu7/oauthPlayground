...
const TVScreen = styled.div`
	background: linear-gradient(135deg, COLORS.TEXT.BLACK 0%, #0a0a0a 100%);
	border: none;
	border-radius: 0.1875rem;
	padding: 1rem;
	text-align: center;
	...
	background-image: url('https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=1200&h=800&fit=crop&q=90');
...
const AppleTVBox = styled.div`
	width: 120px;
	height: 40px;
	background: linear-gradient(135deg, #1d1d1f 0%, COLORS.TEXT.BLACK 100%);
...
const ControlButton = styled.button<{ $variant: 'primary' | 'secondary' }>`
	...
	&:hover {
		background: ${(props) =>
			props.$variant === 'primary' ? '#0051d5' : 'rgba(255, 255, 255, 0.15)'};
