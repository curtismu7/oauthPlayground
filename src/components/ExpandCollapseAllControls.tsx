 ...
 */
export const ExpandCollapseAllControlsCompact: React.FC<Omit<ExpandCollapseAllControlsProps, 'size' | 'variant'>> = (props) => {
  return (
 ...
 */
export const ExpandCollapseAllControlsPills: React.FC<Omit<ExpandCollapseAllControlsProps, 'size' | 'variant'>> = (props) => {
  return (
    <ExpandCollapseAllControls
      {...props}
      size="sm"
