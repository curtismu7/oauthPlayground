...
import { FiCopy, FiExternalLink, FiRefreshCw, FiXCircle, FiCheckCircle, FiAlertTriangle, FiTruck, FiNavigation, FiBattery, FiMusic, FiSettings } from 'react-icons/fi';
...
const VehicleControlButton = styled.button<{ $variant: 'primary' | 'secondary' | 'success' | 'danger' }>`
  background: ${props => {
    switch (props.$variant) {
      case 'primary': return '#f87171';
...
const StatusDisplay = styled.div<{ $status: string }>`
  background: ${props => {
    switch (props.$status) {
      ...
      case 'authorized': return 'linear-gradient(135deg, #22c55e 0%, #16a34a 100%)';
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: '0.25rem' }}>280 mi range</div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                alignItems: 'center',
                justifyContent: 'center',
                background: 'conic-gradient(from 0deg, #f97316 0deg, #f97316 72deg, #374151 72deg)'
              }}>
                <div style={{
                  width: '80px',
                  height: '80px',
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: '0.25rem' }}>AC: Auto</div>
            </div>
          </div>
