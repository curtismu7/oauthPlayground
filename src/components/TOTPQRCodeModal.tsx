...
import { FiX, FiCopy, FiCheck, FiEye, FiEyeOff, FiSmartphone, FiKey } from 'react-icons/fi';
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div><strong>Account:</strong> {userId}@{deviceName}</div>
                <div><strong>Algorithm:</strong> SHA1</div>
                <div><strong>Digits:</strong> 6</div>
                <div><strong>Period:</strong> 30 seconds</div>
              </div>
            </div>
          </div>
        )}
