...
import { FiSave, FiCheck, FiAlertCircle, FiInfo, FiRefreshCw, FiCopy } from 'react-icons/fi';
import OIDCDiscoveryInput from './OIDCDiscoveryInput';
import { credentialManager } from '../utils/credentialManager';
import { showGlobalSuccess, showGlobalError } from '../hooks/useNotifications';
import type { DiscoveryResult, OIDCDiscoveryDocument } from '../services/oidcDiscoveryService';

interface DiscoveryBasedConfigurationProps {
  onConfigurationComplete?: (credentials: any) => void;
  className?: string;
}
  ...
  return (
    <Container className={className}>
      <Header>
        ...
        <Subtitle>
          Configure your OAuth/OIDC flows using automatic endpoint discovery.
          Just provide your issuer URL and client credentials - we'll handle the rest!
        </Subtitle>
      </Header>
