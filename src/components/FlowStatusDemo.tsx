...
const mockGetFlowStatus = (flowId: string) => {
	...
	const mockData: Record<string, { lastExecutionTime?: string; hasCredentials?: boolean }> = {
		...
		'oidc-client-credentials-v5': { lastExecutionTime: 'Never', hasCredentials: false },
			...
			<div style={{ maxWidth: '1200px', margin: '0 auto' }}>
				...
				<div style={{ 
					...
					<ul style={{ color: '#374151', lineHeight: '1.6' }}>
						<li>✅ <strong>Consistent Light Blue Theme:</strong> All tables now use light blue (#eff6ff) backgrounds instead of mixed red/green</li>
						<li>✅ <strong>Enhanced Headers:</strong> Blue headers (#dbeafe) with consistent styling and better contrast</li>
						<li>✅ <strong>Improved Status Badges:</strong> "Missing" status now uses light blue instead of red for a friendlier appearance</li>
						<li>✅ <strong>Better Spacing:</strong> Increased padding and margins for better readability</li>
						<li>✅ <strong>Visual Hierarchy:</strong> Section titles with blue dots and consistent typography</li>
						<li>✅ <strong>Enhanced Borders:</strong> Thicker borders and subtle shadows for better definition</li>
						<li>✅ <strong>Consistent Colors:</strong> All sections use the same color scheme for uniformity</li>
					</ul>
				</div>
			</div>
		</div>
