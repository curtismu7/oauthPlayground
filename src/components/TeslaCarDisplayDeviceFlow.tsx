...
const ControlButton = styled.button<{ $variant: 'primary' | 'secondary' }>`
	background: ${(props) =>
		props.$variant === 'primary' ? 'rgba(0, 102, 204, 0.2)' : 'rgba(0, 0, 0, 0.1)'};
	color: V9_COLORS.TEXT.BLACK;
	border: 2px solid
		${(props) => (props.$variant === 'primary' ? 'rgba(0, 102, 204, 0.5)' : 'rgba(0, 0, 0, 0.3)')};
	border-radius: 0.5rem;
	...
	&:hover {
		background: ${(props) =>
			props.$variant === 'primary' ? 'rgba(0, 102, 204, 0.3)' : 'rgba(0, 0, 0, 0.15)'};
		border-color: ${(props) =>
			props.$variant === 'primary' ? 'rgba(0, 102, 204, 0.7)' : 'rgba(0, 0, 0, 0.4)'};
