...
import { openWebhookViewerPopout } from '../mfa/utils/webhookViewerPopoutHelper';
	...
	const [menuGroups, setMenuGroups] = useState<MenuGroup[]>(() => {
				...
				items: [
					{
						...
						label: ' API Status',
						icon: (
							<ColoredIcon $color="COLORS.PRIMARY.BLUE">
								<span></span>
							</ColoredIcon>
						),
						badge: (
					...
					// EDUCATION Entries (sorted alphabetically)
					{
						...
						icon: (
							<ColoredIcon $color="COLORS.PRIMARY.GREEN">
					...
					},
					{
						...
						icon: (
							<ColoredIcon $color="COLORS.PRIMARY.RED">
								<i className="bi bi-question-circle"></i>
							</ColoredIcon>
						),
						badge: (
					...
					},
					{
						...
						icon: (
							<ColoredIcon $color="COLORS.PRIMARY.RED_DARK">
								<span></span>
							</ColoredIcon>
						),
						badge: (
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						icon: (
							<ColoredIcon $color="COLORS.PRIMARY.YELLOW">
								<span></span>
							</ColoredIcon>
						),
						badge: (
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						icon: (
							<ColoredIcon $color="COLORS.PRIMARY.GREEN_DARK">
								<span></span>
							</ColoredIcon>
						),
						badge: (
		...
		if (savedOrder) {
			try {
				...
				logger.info('DragDropSidebar', ' Restoring menu layout from localStorage');
			...
			{searchQuery.trim() && (
				<div
					style={{
						padding: '0.5rem 1rem',
						background: '#f8fafc',
						borderBottom: '1px solid COLORS.BG.GRAY_LIGHT',
						fontSize: '0.875rem',
						color: '#3b82f6',
					}}
				>
									...
									<div key={subGroup.id} style={{ marginBottom: '0.75rem' }}>
										...
										<button
											...
											style={{
												...
												background:
													'linear-gradient(135deg, COLORS.PRIMARY.BLUE_LIGHT 0%, COLORS.PRIMARY.BLUE 100%)',
												borderRadius: '0.375rem',
												marginBottom: '0.25rem',
												cursor: 'pointer',
															...
															style={{
																...
																border:
																	...
																	dropTarget.index === itemIndex + 1
																		? '3px solid COLORS.PRIMARY.RED'
																		: isActive(item.path)
																			? '3px solid COLORS.PRIMARY.YELLOW'
