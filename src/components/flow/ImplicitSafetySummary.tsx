	...
	<section style={cardStyle}>
		...
		<div style={securityStyle}>
			...
			<p style={{ margin: '0 0 6px' }}>
				<strong>Deprecated:</strong> OAuth 2.0 Security Best Practices recommends against Implicit
				Flow for new applications.
			</p>
			<p style={{ margin: '0 0 6px' }}>
				<strong>Token Exposure:</strong> Tokens are exposed in the URL fragment, making them visible
				in browser history, server logs, and referrer headers.
			</p>
			<p style={{ margin: 0 }}>
				<strong>Modern Alternative:</strong> Use Authorization Code Flow with PKCE for better
				security.
			</p>
		</div>
	</section>
