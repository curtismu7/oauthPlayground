            ...
            <TokenHeader>
              ...
              <TokenActions>
                <ActionButton
                  ...
                  aria-label={isMasked ? `Show ${tokenMeta[tokenType].label}` : `Mask ${tokenMeta[tokenType].label}`}
                >
                ...
                >
                  {copiedStates[tokenType] ? <FiCheck aria-hidden="true" /> : <FiCopy aria-hidden="true" />}
