...
import { Card, Alert, DocumentationLink, DocumentationSection } from '../shared/PasswordResetSharedComponents';
	...
	return (
		<>
			<Card>
				...
				<div style={{ display: 'grid', gap: '1.5rem' }}>
					...
					<div>
						...
						<p style={{ color: '#6B7280', lineHeight: '1.6', marginBottom: '0.5rem' }}>
							<strong>Content-Type:</strong> <code style={{ background: '#F3F4F6', padding: '0.25rem 0.5rem', borderRadius: '0.25rem', fontSize: '0.875rem' }}>application/vnd.pingidentity.password.set-value+json</code>
						</p>
			...
			<Card style={{ marginTop: '2rem' }}>
				<h2 style={{ marginBottom: '1.5rem', fontSize: '1.5rem', color: '#1F2937' }}>User Lookup with Filter Parameters</h2>
				...
				<Alert $type="info" style={{ marginBottom: '1.5rem' }}>
					...
					<div>
						...
						<p style={{ margin: '0.5rem 0 0 0', fontSize: '0.875rem' }}>
							This application uses PingOne Management API with filter parameters to look up users by username, email, or user ID.
							The lookup supports three methods: direct ID lookup (fastest), filter by username, and filter by email.
							<strong> If multiple users match (e.g., same email), the first user is returned.</strong>
						</p>
					</div>
				</Alert>

				<div style={{ marginBottom: '1.5rem' }}>
					<h3 style={{ marginBottom: '1rem', color: '#1F2937', fontSize: '1.125rem' }}>Filter Examples</h3>
					
					<div style={{ background: '#F9FAFB', border: '1px solid #E5E7EB', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem' }}>
						<h4 style={{ marginBottom: '0.5rem', color: '#374151', fontSize: '1rem' }}>1. Lookup by Username</h4>
						<code style={{ 
							display: 'block', 
							background: '#FFFFFF', 
							padding: '0.75rem', 
						...
						<p style={{ marginTop: '0.5rem', fontSize: '0.875rem', color: '#6B7280' }}>
							<strong>Note:</strong> Use lowercase <code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>username</code> (not userName).
							Filter must be URL-encoded: spaces become <code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>%20</code>, quotes become <code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>%22</code>
						</p>
					</div>

					<div style={{ background: '#F9FAFB', border: '1px solid #E5E7EB', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem' }}>
						<h4 style={{ marginBottom: '0.5rem', color: '#374151', fontSize: '1rem' }}>2. Lookup by Email</h4>
						<code style={{ 
							display: 'block', 
							background: '#FFFFFF', 
							padding: '0.75rem', 
							...
							GET /v1/environments/&#123;envID&#125;/users?filter=email%20eq%20%22cmuir%40pingone.com%22
						</code>
						<p style={{ marginTop: '0.5rem', fontSize: '0.875rem', color: '#6B7280' }}>
							<strong>Note:</strong> The @ symbol must be URL-encoded as <code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>%40</code>.
							If multiple users have the same email, the first user is returned.
						</p>
					</div>

					<div style={{ background: '#F9FAFB', border: '1px solid #E5E7EB', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem' }}>
						<h4 style={{ marginBottom: '0.5rem', color: '#374151', fontSize: '1rem' }}>3. Direct Lookup by User ID</h4>
						<code style={{ 
							display: 'block', 
							background: '#FFFFFF', 
							padding: '0.75rem', 
						...
						<p style={{ marginTop: '0.5rem', fontSize: '0.875rem', color: '#6B7280' }}>
							<strong>Fastest method:</strong> Direct ID lookup doesn't require a filter parameter and returns a single user immediately.
						</p>
					</div>

					<div style={{ background: '#FEF3C7', border: '1px solid #FCD34D', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1rem' }}>
						<h4 style={{ marginBottom: '0.5rem', color: '#92400E', fontSize: '1rem' }}>💡 URL Encoding in JavaScript</h4>
						<code style={{ 
							display: 'block', 
							background: '#FFFFFF', 
							padding: '0.75rem', 
...
// Result: /users?filter=username%20eq%20%22curtis7%22`}
						...
						<p style={{ marginTop: '0.5rem', fontSize: '0.875rem', color: '#92400E' }}>
							Always use <code style={{ background: '#FEF3C7', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>encodeURIComponent()</code> to properly encode filter values.
						</p>
					</div>
				</div>
				...
				<Alert $type="info">
					...
					<div>
						...
						<p style={{ margin: '0.5rem 0 0 0', fontSize: '0.875rem' }}>
							PingOne Management API uses SCIM-style filter syntax with GET requests.
							The format is: <code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>attribute eq "value"</code>
							where <code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>eq</code> means "equals".
							Values must be enclosed in double quotes and the entire filter must be URL-encoded.
						</p>
						<p style={{ margin: '0.5rem 0 0 0', fontSize: '0.875rem' }}>
							<strong>Supported filter attributes:</strong> <code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>username</code>, 
							<code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>email</code>, 
							<code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>name.given</code>, 
							<code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>name.family</code>, 
							<code style={{ background: '#F3F4F6', padding: '0.125rem 0.25rem', borderRadius: '0.25rem' }}>enabled</code>, and more.
						</p>
					</div>
				</Alert>
