/**
 * ========================================================================
 * DragDropSidebar V2 - Badge Migration Version
 * ========================================================================
 *
 * This version replaces all green checkmark badges with color-coded
 * MenuVersionBadge components for better version visibility.
 *
 * Current Version: V2 (Badge Migration - Feb 2026)
 *
 * Changes from V1:
 * - Replaced 60+ badges with MenuVersionBadge components
 * - Added color-coded badges by flow type (V8, V8U, V7, Production)
 * - Improved version visibility in sidebar menu
 * ========================================================================
 */
	...
	const [menuGroups, setMenuGroups] = useState<MenuGroup[]>(() => {
				...
				items: [
					{
						...
						badge: <MenuVersionBadge version="9.11.76" type="v7" />,
					},
					{
		...
		if (savedSidebarData?.menuOrder) {
			try {
				...
				log.warn('DragDropSidebar', 'Failed to parse saved menu order from V9 storage:', {
					error,
				});
			}
		}
		...
		if (savedOrder) {
			try {
				...
				log.warn('DragDropSidebar', 'Failed to migrate saved menu order from localStorage:', {
					error,
				});
			}
		}
