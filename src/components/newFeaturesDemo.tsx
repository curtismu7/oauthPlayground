...
const _validation = EnhancedConfigurationService.validateConfiguration(config);

// Export configuration for backup
const _configJson = EnhancedConfigurationService.exportConfiguration(
	FlowType.OAUTH_CLIENT_CREDENTIALS
);

export { ServiceDiscoveryPage, ConfigurationPage, AppWithErrorHandling };
