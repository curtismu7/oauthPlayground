...
import { FiAlertTriangle, FiX, FiRefreshCw, FiExternalLink } from 'react-icons/fi';
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
        ...
        {/* Documentation Link */}
        <button
          onClick={() => window.open('https://docs.pingidentity.com/bundle/pingone-for-customers/page/authentication.html', '_blank')}
          style={{
            padding: '0.5rem 1rem',
            background: '#3b82f6',
            color: 'white',
