...
const PARConfigurationExample: React.FC<PARConfigurationExampleProps> = ({
	...
	return (
		<div style={{ padding: '1rem', border: '1px solid #e5e7eb', borderRadius: '0.5rem', margin: '1rem 0' }}>
			...
			<div style={{ marginTop: '1rem', padding: '1rem', background: '#f0f9ff', borderRadius: '0.375rem' }}>
				<h4 style={{ marginBottom: '0.5rem', color: '#374151' }}>URL Parameters for PAR Request:</h4>
				<pre style={{ fontSize: '0.875rem', color: '#6b7280', margin: 0 }}>
			...
			<div style={{ marginTop: '1rem', padding: '1rem', background: '#f0fdf4', borderRadius: '0.375rem' }}>
				<h4 style={{ marginBottom: '0.5rem', color: '#374151' }}>Flow-Specific Defaults:</h4>
				<p style={{ fontSize: '0.875rem', color: '#6b7280', margin: 0 }}>
					This example uses <strong>{flowType}</strong> flow defaults. 
					Different flow types have different default PAR configurations.
				</p>
			</div>
		</div>
	);
