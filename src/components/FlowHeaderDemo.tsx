    ...
    <DemoContainer>
      ...
      <DemoSection>
        ...
        <FlowHeader 
          ...
          customConfig={{
            subtitle: "This is a custom subtitle showing how you can override the default description for specific implementations or use cases."
          }}
        />
      </DemoSection>
      ...
      <DemoSection>
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: '1rem' }}>
            <div style={{ color: '#10b981', marginBottom: '0.5rem' }}>// With Custom Configuration:</div>
            <div>{'<FlowHeader'}</div>
