...
import { FiCopy, FiInfo, FiEye, FiEyeOff } from 'react-icons/fi';
...
export const GeneratedParametersDisplay: React.FC<GeneratedParametersDisplayProps> = ({
	...
	const getParameterInfo = () => {
		const info: Record<string, any> = {
			'Code Verifier': {
				description: 'A cryptographically random string used to prove possession of the authorization request.',
				details: [
