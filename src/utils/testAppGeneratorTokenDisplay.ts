...
export function testAppGeneratorTokenDisplay() {
  ...
  try {
    ...
    const mockJWTToken = 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..invalid-signature';
    ...
    console.log(`✅ JWT Detection: ${isJWT ? 'Correctly identified as JWT' : 'Failed to identify JWT'}`);
    
    // Test 2: Opaque Token Detection
    const isOpaque = !TokenDisplayService.isJWT(mockOpaqueToken);
    console.log(`✅ Opaque Token Detection: ${isOpaque ? 'Correctly identified as opaque' : 'Failed to identify opaque'}`);
