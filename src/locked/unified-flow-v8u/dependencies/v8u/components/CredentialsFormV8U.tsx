...
import { ClientTypeRadioV8 } from '../../v8/components/ClientTypeRadioV8.tsx';
import {
	type DisplayMode,
	DisplayModeDropdownV8,
} from '../../v8/components/DisplayModeDropdownV8.tsx';
import { IssuerURLInputV8 } from '../../v8/components/IssuerURLInputV8.tsx';
import { LoginHintInputV8 } from '../../v8/components/LoginHintInputV8.tsx';
import { MaxAgeInputV8 } from '../../v8/components/MaxAgeInputV8.tsx';
import {
	OidcDiscoveryModalV8,
	type OidcDiscoveryResult,
} from '../../v8/components/OidcDiscoveryModalV8.tsx';
import { PKCEEnforcementDropdownV8 } from '../../v8/components/PKCEEnforcementDropdownV8.tsx';
import { PKCEInputV8, type PKCEMode } from '../../v8/components/PKCEInputV8.tsx';
import { ResponseModeDropdownV8 } from '../../v8/components/ResponseModeDropdownV8.tsx';
import { ResponseTypeDropdownV8 } from '../../v8/components/ResponseTypeDropdownV8.tsx';
import { TokenEndpointAuthMethodDropdownV8 } from '../../v8/components/TokenEndpointAuthMethodDropdownV8.tsx';
import { TooltipV8 } from '../../v8/components/TooltipV8.tsx';
import { WorkerTokenModalV8 } from '../../v8/components/WorkerTokenModalV8.tsx';
...
import { ConfigCheckerServiceV8 } from '../../v8/services/configCheckerServiceV8.ts';
...
import { FlowOptionsServiceV8 } from '../../v8/services/flowOptionsServiceV8.ts';
import { MFAConfigurationServiceV8 } from '../../v8/services/mfaConfigurationServiceV8.ts';
import { OidcDiscoveryServiceV8 } from '../../v8/services/oidcDiscoveryServiceV8.ts';
import { RedirectUriServiceV8 } from '../../v8/services/redirectUriServiceV8.ts';
import { ResponseTypeServiceV8 } from '../../v8/services/responseTypeServiceV8.ts';
...
import { TokenEndpointAuthMethodServiceV8 } from '../../v8/services/tokenEndpointAuthMethodServiceV8.ts';
import { TooltipContentServiceV8 } from '../../v8/services/tooltipContentServiceV8.ts';
	...
	useEffect(() => {
		const fetchAllowedScopes = async () => {
			...
			try {
				...
				logger.error(`${MODULE_TAG} Error fetching allowed scopes:`, error);
	...
	useEffect(() => {
		...
		if (hasChanges) {
			...
			try {
				...
				logger.error(`${MODULE_TAG} Error saving credentials after setting defaults`, {
					flowKey,
					error,
				});
			}
			...
			try {
				...
				if (sharedCreds.environmentId || sharedCreds.clientId) {
					...
					SharedCredentialsServiceV8.saveSharedCredentials(sharedCreds).catch((err) => {
						logger.warn(`${MODULE_TAG} Background disk save failed (non-critical):`, err);
					});
				}
				...
				logger.error(`${MODULE_TAG} Error saving credentials`, { field, flowKey, error });
			}
		...
		async (app: DiscoveredApp) => {
			...
			if (credentials.environmentId) {
				try {
					...
					logger.error(`${MODULE_TAG} Error fetching application secret`, {
			...
			try {
				...
				logger.error(`${MODULE_TAG} Error saving credentials after app selection`, {
					flowKey,
					error,
				});
			}
