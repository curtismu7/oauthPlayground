...
import { UserLoginModalV8 } from '../../../dependencies/v8/components/UserLoginModalV8.tsx';
...
import { OAuthIntegrationServiceV8 } from '../../../dependencies/v8/services/oauthIntegrationServiceV8.ts';
		...
		const processCallback = async () => {
			...
			if (code && state) {
				...
				if (storedState && state && storedState !== state) {
					logger.warn(
						`[📧 EMAIL-CONFIG-PAGE-V8] State mismatch - possible CSRF attack`,
						'Logger warning'
					);
				...
				>
					...
					<div style={{ fontSize: '14px', color: '#6b7280', lineHeight: 1.6 }}>
						...
						<ul style={{ margin: '0 0 12px 0', paddingLeft: '20px' }}>
							...
							<li>Widely supported: Works on any device with email access</li>
