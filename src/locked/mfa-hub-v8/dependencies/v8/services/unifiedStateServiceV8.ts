...
class UnifiedStateServiceV8 {
  ...
  private readonly transitions: Record<UnifiedMFAState, Partial<Record<UnifiedMFAEvent, UnifiedMFAState>>> = {
    INIT: {
   ...
   */
  async processEvent(event: UnifiedMFAEvent, data?: Partial<UnifiedMFAStateData>): Promise<UnifiedMFAStateData> {
   ...
   */
  private async logStateChange(from: UnifiedMFAState, to: UnifiedMFAState, reason: string): Promise<void> {
