...
import { FiArrowRight, FiShield, FiZap, FiUsers, FiLock, FiInfo, FiCheck, FiX, FiAlertTriangle, FiBarChart2, FiClock, FiDatabase } from 'react-icons/fi';
  ...
  return (
    <ComparisonContainer>
      ...
      <ComparisonSubtitle>
        ...
        Select flows to compare and get personalized recommendations.
      </ComparisonSubtitle>
          ...
          {selectedFlowTypes.map(flowType => {
            ...
            return (
              <ComparisonCard key={flowType}>
                ...
                <MetricRow>
                  <MetricLabel><FiShield /> Security</MetricLabel>
                ...
                <MetricRow>
                  <MetricLabel><FiClock /> Performance</MetricLabel>
                ...
                <MetricRow>
                  <MetricLabel><FiDatabase /> Complexity</MetricLabel>
                ...
                <MetricRow>
                  <MetricLabel><FiUsers /> User Experience</MetricLabel>
                  <MetricValue $rating={metrics.userExperience}>
                    <RatingBadge $rating={metrics.userExperience}>{metrics.userExperience}</RatingBadge>
                  </MetricValue>
                </MetricRow>
                
                <MetricRow>
                  <MetricLabel><FiLock /> Token Security</MetricLabel>
                  <MetricValue $rating={metrics.tokenSecurity}>
                    <RatingBadge $rating={metrics.tokenSecurity}>{metrics.tokenSecurity}</RatingBadge>
                  </MetricValue>
                </MetricRow>
                ...
                <div style={{ marginTop: '1rem' }}>
                  ...
                  <ul style={{ margin: '0 0 1rem 1.5rem', padding: 0, color: '#059669', fontSize: '0.875rem' }}>
                  ...
                  <ul style={{ margin: 0, padding: 0, paddingLeft: '1.5rem', color: '#dc2626', fontSize: '0.875rem' }}>
