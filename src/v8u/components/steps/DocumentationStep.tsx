/**
 * @file DocumentationStep.tsx
 * @description Documentation Step placeholder
...
export const DocumentationStep: React.FC<{ isCompleted?: boolean; isActive?: boolean }> = ({
	isCompleted = false,
	isActive = false,
}) => {
	return (
		<BaseUnifiedStep
			title="Documentation"
			description="Documentation and help implementation"
			stepNumber={1}
