/**
 * @file StepValidationFeedbackV8U.tsx
 ...
 */
export const StepValidationFeedbackV8U: React.FC<StepValidationFeedbackProps> = ({
	errors = [],
	warnings = [],
	showErrors = true,
	showWarnings = true,
...
export default StepValidationFeedbackV8U;
