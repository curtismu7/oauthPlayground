			...
			>
				...
				>
					...
					>
						...
						>
							<span className="mdi mdi-close" style={{ fontSize: '20px' }}></span>
						</button>
					</div>
					...
					<div style={{ padding: '32px' }}>
									...
									{unavailableDevices.map((device, index) => (
										...
										>
											...
											{device.status === 'LOCKED' && onUnlockDevice && (
												...
												>
													<span className="mdi mdi-lock-open" style={{ fontSize: '14px' }}></span>
													Unlock
												</button>
											)}
										</div>
						...
						>
							...
							>
								...
								{failureReason === 'Daily Limit Exceeded' && (
									<>
										You've exceeded the daily limit for SMS authentication attempts. Please try
										again tomorrow or use a different authentication method.
									</>
								)}
								...
								{![
									...
									<>
										One or more of your devices are temporarily unavailable. Please try another
										device or contact your administrator for assistance.
									</>
								)}
							</div>
						</div>
						...
						>
							{onRetry && (
								...
								>
									<span className="mdi mdi-refresh" style={{ fontSize: '16px' }}></span>
									Retry
								</button>
							)}
							{onTryAnotherDevice && (
