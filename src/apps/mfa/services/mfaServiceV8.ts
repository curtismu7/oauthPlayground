 ...
 * @version 8.0.0
 * @since 2024-11-19
 * @deprecated Use MfaAuthenticationServiceV8 from '@/apps/mfa/services/mfaAuthenticationServiceV8' instead
 *
 ...
 *
 * ⚠️ DEPRECATION NOTICE: This service is deprecated and will be removed in future versions
 * - NEW CODE: Use MfaAuthenticationServiceV8 from '@/apps/mfa/services/mfaAuthenticationServiceV8'
 * - MIGRATION: All methods have been migrated to MfaAuthenticationServiceV8 with enhanced features
 * - EXAMPLE: import { MfaAuthenticationServiceV8 } from '@/apps/mfa/services/mfaAuthenticationServiceV8';
 *
