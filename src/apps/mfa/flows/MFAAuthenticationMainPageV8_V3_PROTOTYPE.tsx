	...
	return (
		<div style={{ padding: '32px', maxWidth: '1400px', margin: '0 auto' }}>
			...
			>
				...
				<button type="button" onClick={() => workerToken.setShowWorkerTokenModal(true)}>
					Get Worker Token
				</button>
				<button type="button" onClick={() => workerToken.refreshTokenStatus()}>
					Refresh Status
				</button>
			</section>
			...
			>
				...
				<button type="button" onClick={() => mfaDevices.refreshDevices()}>
					Refresh Devices
				</button>
				<button type="button" onClick={() => mfaDevices.clearDevices()}>
					Clear Devices
				</button>
			</section>
			...
			>
				...
				<button type="button" onClick={() => mfaAuth.resetAuthState()}>
					Reset Auth State
				</button>
				<button type="button" onClick={() => mfaAuth.closeAllModals()}>
					Close All Modals
				</button>
			</section>
			...
			>
				...
				<button type="button" onClick={() => mfaPolicies.refreshPolicies()}>
					Refresh Policies
				</button>
				<button type="button" onClick={() => mfaPolicies.clearPolicies()}>
					Clear Policies
				</button>
			</section>
