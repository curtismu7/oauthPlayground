 ...
 * @description Unified MFA Authentication Main Page - MFA FLOW
 * @version 8.3.0
 * @since 2025-01-XX
 *
				...
				>
						...
						sections={[
							{
								...
								icon: <span className="mdi mdi-shield" style={{ fontSize: '18px' }}></span>,
								oneLiner:
								...
								content: (
									<div>
										...
										<ul>
											...
											<li>
												<strong>Challenge Handling</strong> - OTP codes, push notifications, or
												FIDO2 challenges
											</li>
											<li>
							...
							},
							{
								...
								icon: <span className="mdi mdi-key" style={{ fontSize: '18px' }}></span>,
								oneLiner:
									'Select user → Choose device → Complete challenge → Authentication success',
								content: (
									<div>
										<p>
										...
										<ul>
											...
											<li>
												<strong>Step 3: Challenge</strong> - Complete device-specific challenge
												(OTP, Push, FIDO2)
											</li>
											<li>
					...
					>
						...
						>
							...
							>
								<span className="mdi mdi-code-tags" style={{ fontSize: '18px' }}></span>
								OAuth & MFA API Test
							</ButtonSpinner>
						</div>
					</div>
					...
					>
						...
						<div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', alignItems: 'flex-end' }}>
							...
							>
								<span className="mdi mdi-shield"></span>
												...
												<div style={{ gridColumn: '1 / -1', marginTop: '8px' }}>
													...
													<div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
																		...
																		>
																			{selectedPolicy.skipUserLockVerification ? (
																				<>
																					...
																					locked before authentication. Locked accounts may be able
																					to authenticate.
																				</>
																			) : (
																				<>
														...
														{selectedPolicy.pairingDisabled !== undefined && (
															<div
																style={{
																	background: selectedPolicy.pairingDisabled
																		? '#fee2e2'
																		: '#dcfce7',
																...
																>
																	<div style={{ flex: 1 }}>
																		...
																		>
																			{selectedPolicy.pairingDisabled ? (
																				<>
																					<strong style={{ color: '#991b1b' }}>Action:</strong>{' '}
																					Device pairing/registration is <strong>disabled</strong>.
																					Users cannot register new MFA devices with this policy.
																				</>
																			) : (
																				<>
																					<strong style={{ color: '#166534' }}>Action:</strong>{' '}
																					Device pairing/registration is <strong>enabled</strong>.
																		...
																		>
																			{selectedPolicy.promptForNicknameOnPairing ? (
																				<>
																					...
																					After successful device pairing, we will{' '}
																					<strong>prompt the user</strong> to enter a custom
																					nickname for their device.
																				</>
																			) : (
																				<>
																					<strong style={{ color: '#4b5563' }}>Action:</strong>{' '}
																					Device nickname will be set <strong>automatically</strong>{' '}
								...
								{authState.devices.map((device) => (
									...
									>
										...
										>
											...
											>
												{device.type === 'SMS' || device.type === 'VOICE' ? (
													<span className="mdi mdi-phone" style={{ color: 'white' }}></span>
												) : device.type === 'EMAIL' ? (
													<span className="mdi mdi-email" style={{ color: 'white' }}></span>
												) : device.type === 'FIDO2' ? (
													<span className="mdi mdi-key" style={{ color: 'white' }}></span>
												) : (
										...
										<div>
											...
											<button
												...
												style={{
													...
													color:
														usernameInput.trim() && !authState.isLoading ? '#3b82f6' : '#9ca3af',
													fontSize: '16px',
													fontWeight: '600',
													cursor:
														usernameInput.trim() && !authState.isLoading
															? 'pointer'
															: 'not-allowed',
												}}
											>
						...
						>
							...
							>
								...
								>
									...
									>
										<span className="mdi mdi-close" style={{ fontSize: '18px' }}></span>
									</button>
									<PingIdentityLogo size={48} />
									<h3
										style={{
															...
															onSelectDevice={async (deviceId) => {
																...
																try {
																	...
																	try {
																		...
																		const userIdOrUsername =
																			authState.userId || usernameInput.trim();
																		authDetails =
																	...
																	if (!challengeId) {
																		...
																		if (isFIDO2Flow) {
																			...
																			if (data._links) {
																				const links = data._links as Record<
																					string,
																					{ href: string }
																				>;
																				const challengePollUrl =
																	...
																	const status =
																		(authDetails?.status as string) || data.status || '';
																	const nextStep =
						...
						onResendCode={async () => {
							...
							try {
								...
								if (!success) {
									...
									const nextStep =
										(authDetails?.nextStep as string) || reselectResult.nextStep || '';
