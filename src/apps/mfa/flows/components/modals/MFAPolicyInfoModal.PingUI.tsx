/**
 * @file MFAPolicyInfoModal.PingUI.tsx
 * @module v8/flows/components/modals
 * @description Info modal explaining Device Authentication Policies - Ping UI version
 * @version 8.3.0
 * @since 2025-01-19
 *
		...
		>
			...
			>
				...
				>
					...
					>
						<MDIIcon icon="close" size={20} aria-label="Close" />
					</div>
				</div>
