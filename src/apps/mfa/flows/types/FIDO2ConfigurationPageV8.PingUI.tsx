/**
 * @file FIDO2ConfigurationPageV8.PingUI.tsx
 * @module v8/flows/types
 * @description FIDO2 Configuration and Education Page - Ping UI version (icons only)
 * @version 8.0.0
 */
...
export const FIDO2ConfigurationPageV8: React.FC<Record<string, never>> = () => {
	...
	return (
		<div className="end-user-nano">
			<div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
				<MDIIcon icon="key" size={24} aria-hidden={true} />
				<span>FIDO2 Configuration</span>
			</div>
		</div>
	);
};
