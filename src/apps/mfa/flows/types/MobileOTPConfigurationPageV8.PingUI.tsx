/**
 * @file MobileOTPConfigurationPageV8.PingUI.tsx
 * @module v8/flows/types
 * @description Mobile OTP Configuration Page - Ping UI version (icons only)
 * @version 8.0.0
 */
...
export const MobileOTPConfigurationPageV8: React.FC<Record<string, never>> = () => {
	...
	return (
		<div className="end-user-nano">
			<div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
				<MDIIcon icon="cellphone" size={24} aria-hidden={true} />
				<span>Mobile OTP Configuration</span>
			</div>
		</div>
	);
};
