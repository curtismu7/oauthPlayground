 ...
 * @description Unified authorization URL builder for all OAuth/OIDC flows - OAUTH SERVICE
 * @version 8.0.0
 * @since 2025-11-23
 *
...
import { UnifiedFlowLoggerService } from '../services/unifiedFlowLoggerServiceV8U';

const _MODULE_TAG = '[🔗 AUTHORIZATION-URL-BUILDER-OAUTH]';
...
export class AuthorizationUrlBuilderService {
	...
	private static getResponseMode(
		...
		if (credentials.useRedirectless) {
			return 'pi.flow' as ResponseMode;
		}
