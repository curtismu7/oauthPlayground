...
import { FiUsers, FiLogOut, FiMonitor, FiShield, FiRefreshCw, FiInfo, FiCheck, FiPlay, FiCode, FiArrowRight, FiCopy, FiExternalLink } from 'react-icons/fi';
...
const OIDCSessionManagement = () => {
  ...
  const renderFlowDiagram = (actors: Array<{name: string, role: string, icon: React.ReactNode}>) => (
    <FlowDiagram>
          ...
          <InteractiveSection>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', marginTop: '1rem' }}>
              <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                ...
                <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Real-time session monitoring prevents unauthorized access</p>
              </div>
              <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                <FiUsers style={{ color: '#3b82f6', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Better UX</h4>
                <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Seamless logout across multiple applications</p>
              </div>
              <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                <FiMonitor style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Centralized Control</h4>
                <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Manage sessions from a single identity provider</p>
              </div>
            </div>
          </InteractiveSection>
      ...
      <CollapsibleSection title="🔄 Session Management Flows" defaultOpen={true}>
        <div style={{ marginTop: '1rem' }}>
          <p style={{ marginBottom: '2rem', color: '#64748b', lineHeight: '1.6' }}>
            ...
            for monitoring and managing user sessions across applications.
          </p>
            ...
            <FlowCard>
              <CardBody>
                ...
                {renderFlowDiagram([
                  ...
                  { name: 'PingOne', role: 'OpenID Provider', icon: <div style={{ background: 'linear-gradient(135deg, #f59e0b, #d97706)', color: 'white', borderRadius: '4px', padding: '0.25rem', fontSize: '0.75rem', fontWeight: 'bold' }}>P1</div> }
                ])}

                <DemoButton onClick={() => setActiveDemo(activeDemo === 'session-creation' ? null : 'session-creation')}>
                  <FiPlay />
  ...
  redirectToLogin();
                ...
                <PingOneNote>
                  ...
                  <div>
                    ...
                    <p>Enable session management in your PingOne application configuration. The session_state parameter will be automatically included in authentication responses.</p>
                  </div>
                </PingOneNote>
              </CardBody>
            </FlowCard>
            ...
            <FlowCard>
              <CardBody>
                ...
                {renderFlowDiagram([
                  ...
                  { name: 'OP', role: 'OpenID Provider', icon: <div style={{ background: 'linear-gradient(135deg, #f59e0b, #d97706)', color: 'white', borderRadius: '4px', padding: '0.25rem', fontSize: '0.75rem', fontWeight: 'bold' }}>P1</div> }
                ])}

                <DemoButton onClick={() => setActiveDemo(activeDemo === 'session-notification' ? null : 'session-notification')}>
                  <FiPlay />
                  ...
                  <div>
                    ...
                    <FlowStep>
                      ...
                      <StepContent>
                        ...
                        <StepDescription>
                          RP creates hidden iframes for session monitoring and OP creates iframe for status changes
                        </StepDescription>
                      </StepContent>
                    </FlowStep>
        ...
        style="display:none">
            ...
            <FlowCard>
              <CardBody>
                ...
                <DemoButton onClick={() => setActiveDemo(activeDemo === 'rp-logout' ? null : 'rp-logout')}>
                  <FiPlay />
  ...
  &state=xyz789`}</CodeBlock>
            ...
            <FlowCard>
              <CardBody>
                ...
                <DemoButton onClick={() => setActiveDemo(activeDemo === 'front-channel-logout' ? null : 'front-channel-logout')}>
                  <FiPlay />
  ...
  &iat=1516239022`}</CodeBlock>
            ...
            <FlowCard>
              <CardBody>
                ...
                <DemoButton onClick={() => setActiveDemo(activeDemo === 'back-channel-logout' ? null : 'back-channel-logout')}>
                  <FiPlay />
                  ...
                  <div>
                    ...
                    <FlowStep>
                      ...
                      <StepContent>
                        ...
                        <StepDescription>
                          OP sends POST requests with logout tokens to each RP's backchannel_logout endpoint
                        </StepDescription>
                      </StepContent>
                    </FlowStep>
  ...
  "jti": "logout_token_123"
            ...
            <FlowCard>
              <CardBody>
                ...
                <DemoButton onClick={() => setActiveDemo(activeDemo === 'session-validation' ? null : 'session-validation')}>
                  <FiPlay />
                  ...
                  <div>
                    ...
                    <FlowStep>
                      ...
                      <StepContent>
                        ...
                        <StepDescription>
                          RP calculates expected session state using Client ID, origin URL, and OP User Agent state
                        </StepDescription>
                      </StepContent>
                    </FlowStep>
                    ...
                    <FlowStep>
                      ...
                      <StepContent>
                        ...
                        <StepDescription>
                          If states don't match, RP may need to check session status with OP or redirect to login
                        </StepDescription>
                      </StepContent>
                    </FlowStep>
          ...
          <ImplementationCard>
            ...
            <CardBody>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', margin: '1.5rem 0' }}>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b', fontSize: '1rem' }}>Client ID</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>The OAuth client identifier</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b', fontSize: '1rem' }}>Origin URL</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>The origin URL of the Authentication Response</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b', fontSize: '1rem' }}>OP User Agent State</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>The OpenID Provider's User Agent state</p>
                </div>
              </div>
...
console.log('Calculated session state:', sessionState);`,
          ...
          <WarningCard>
            ...
            <CardBody>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', margin: '1.5rem 0' }}>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  <FiShield style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Third-party Content Blocking</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Modern browsers may block iframe access</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  <FiShield style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Cross-origin Restrictions</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Same-origin policy limitations</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  <FiShield style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>User Privacy</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Users may disable third-party cookies</p>
                </div>
              </div>
            </CardBody>
          </WarningCard>
          ...
          <ImplementationCard>
            ...
            <CardBody>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', margin: '1.5rem 0' }}>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiRefreshCw style={{ color: '#10b981', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Polling</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Periodically check session status via API calls</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiMonitor style={{ color: '#10b981', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>WebSockets</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Real-time session status updates</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiUsers style={{ color: '#10b981', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Server-Sent Events</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Push-based session notifications</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiCheck style={{ color: '#10b981', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Token Refresh</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Use token expiration for session management</p>
                </div>
              </div>
        ...
        <div style={{ marginTop: '1rem' }}>
          ...
          <ImplementationCard>
            ...
            <CardBody>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', margin: '1.5rem 0' }}>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiLogOut style={{ color: '#10b981', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>RP-Initiated Logout</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Applications can initiate user logout</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiRefreshCw style={{ color: '#10b981', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Front-Channel Logout</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Immediate logout across multiple applications</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiShield style={{ color: '#10b981', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Back-Channel Logout</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Reliable server-to-server logout communication</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiMonitor style={{ color: '#10b981', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Session Monitoring</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Real-time session status tracking</p>
                </div>
              </div>
            </CardBody>
          </ImplementationCard>
          ...
          <ImplementationCard>
            ...
            <CardBody>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', margin: '1.5rem 0' }}>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiArrowRight style={{ color: '#3b82f6', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Post-Logout Redirect URIs</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Configure where users go after logout</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiMonitor style={{ color: '#3b82f6', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Session Timeout</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Configurable session duration</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiRefreshCw style={{ color: '#3b82f6', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Idle Timeout</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Automatic logout after inactivity</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #e2e8f0' }}>
                  <FiUsers style={{ color: '#3b82f6', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Multi-Session Support</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Manage multiple concurrent sessions</p>
                </div>
              </div>
            ...
            <CardBody>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', margin: '1.5rem 0' }}>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  ...
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Use cryptographically strong session state values</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  <FiShield style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>HTTPS Only</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Always use HTTPS for session management endpoints</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  <FiCheck style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Token Validation</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Validate all tokens and session state parameters</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  <FiUsers style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Logout Confirmation</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Confirm logout actions to prevent accidental logouts</p>
                </div>
              </div>
            </CardBody>
          </WarningCard>
            ...
            <CardBody>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', margin: '1.5rem 0' }}>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  ...
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Implement CSRF tokens for logout requests</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  <FiShield style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Origin Validation</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Validate origin headers for security</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  <FiMonitor style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Session Timeout</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Implement reasonable session timeouts</p>
                </div>
                <div style={{ padding: '1rem', background: 'white', borderRadius: '0.5rem', border: '2px solid #fbbf24' }}>
                  <FiUsers style={{ color: '#f59e0b', fontSize: '1.5rem', marginBottom: '0.5rem' }} />
                  <h4 style={{ margin: '0 0 0.5rem 0', color: '#1e293b' }}>Audit Logging</h4>
                  <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>Log all session management events</p>
                </div>
              </div>
