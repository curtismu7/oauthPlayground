...
import { FiServer, FiCheckCircle, FiXCircle, FiAlertTriangle, FiCopy, FiRefreshCw } from 'react-icons/fi';
  ...
  return (
    <Container>
      ...
      <WebhookInfo>
        ...
        <div style={{ marginTop: '1.5rem', padding: '1rem', background: '#fef3c7', border: '1px solid #fbbf24', borderRadius: '0.5rem' }}>
          ...
          <p style={{ fontSize: '0.875rem', color: '#92400e', margin: 0 }}>
            ...
            you'll need to deploy this application to a publicly accessible server or use a webhook tunnel service.
          </p>
        </div>
        ...
        <div style={{ marginTop: '1.5rem' }}>
          ...
          <ol style={{ fontSize: '0.875rem', color: '#475569', paddingLeft: '1.5rem', lineHeight: '1.8' }}>
