...
const PingOneMFAFlowV6: React.FC = () => {
	...
	const addApiCall = useCallback((call: Omit<ApiCall, 'id' | 'timestamp' | 'duration' | 'status'>) => {
						...
						<>
							<InfoBox variant="warning">
								...
								<InfoContent>
									...
									<InfoText>
										PingOne MFA APIs are management APIs that require a worker token (server-to-server authentication).
										You need a PingOne Worker Application with MFA management scopes.
									</InfoText>
								</InfoContent>
							</InfoBox>
							...
							<FormSection>
								...
								<FormGrid>
									<FormGroup>
										...
										<FormInput
											...
											onChange={(e) => handleWorkerCredentialChange('environmentId', e.target.value)}
									...
									<FormGroup>
										...
										<PasswordInputContainer>
											<FormInput
												...
												onChange={(e) => handleWorkerCredentialChange('clientSecret', e.target.value)}
									...
									<FormGroup>
										...
										<Select
											...
											onChange={(e) => handleWorkerCredentialChange('tokenEndpointAuthMethod', e.target.value as any)}
										>
								...
								<div style={{ marginTop: '2rem' }}>
									<ActionButton
										...
										disabled={isGettingWorkerToken || !workerCredentials.environmentId || !workerCredentials.clientId || !workerCredentials.clientSecret}
									>
								...
								{workerToken && (
									<InfoBox variant="success">
										...
										<InfoContent>
											...
											<InfoText>
												Management API token ready for MFA operations.
											</InfoText>
											<CodeBlock>
												Authorization: Bearer {workerToken.substring(0, 50)}...
											</CodeBlock>
										</InfoContent>
									</InfoBox>
								)}
						...
						<>
							<InfoBox variant="info">
								...
								<InfoContent>
									...
									<InfoText>
										Configure the test user information. We're using your provided test phone number (9725231586) 
										and email (cmuir@pingone.com) for real MFA testing.
									</InfoText>
								</InfoContent>
							</InfoBox>
						...
						<>
							<InfoBox variant="info">
								...
								<InfoContent>
									...
									<InfoText>
										The remaining steps (Device Registration, MFA Challenge, Code Verification) will be implemented 
										with real PingOne MFA API calls using your worker token and test credentials.
									</InfoText>
								</InfoContent>
							</InfoBox>
			...
			<ContentWrapper>
				...
				<StepNavigationButtons
					...
					canNavigateNext={
						...
						(currentStep === 1 && userInfo.username && userInfo.phoneNumber && userInfo.emailAddress) ||
						currentStep > 1
					}
