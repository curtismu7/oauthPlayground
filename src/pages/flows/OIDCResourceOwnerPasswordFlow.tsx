			...
			<WarningCard>
				...
				<CardContent>
					...
					<CardText style={{ color: "#991b1b" }}>
						The OIDC Resource Owner Password Credentials flow is{" "}
			...
			<OIDCCard>
				...
				<CardContent>
					...
					<CardText style={{ color: "#374151" }}>
						This is the OIDC version of the Resource Owner Password flow, which
						includes additional OpenID Connect features:
					</CardText>
					<CardList style={{ color: "#374151" }}>
						...
						<CardListItem>
							<strong>Standardized Claims:</strong> Consistent user information
							format
						</CardListItem>
						<CardListItem>
							<strong>Session Management:</strong> OIDC session handling
							capabilities
						</CardListItem>
						<CardListItem>
							<strong>Discovery:</strong> Automatic endpoint discovery via
							.well-known
						</CardListItem>
					</CardList>
				</CardContent>
			...
			<InfoCard>
				...
				<CardContent>
					...
					<CardText style={{ color: "#0c4a6e" }}>
						This OIDC flow should only be used in very specific, high-trust
						scenarios:
					</CardText>
					<CardList style={{ color: "#0c4a6e" }}>
						...
						<CardListItem>
							When ID token and user claims are specifically needed
						</CardListItem>
					</CardList>
				</CardContent>
			</InfoCard>
			...
			<InfoCard>
				...
				<CardContent>
					...
					<CardText style={{ color: "#0c4a6e" }}>
						...
						directly for both an access token and an ID token containing user
					...
					<CardList style={{ color: "#0c4a6e" }}>
						...
						<CardListItem>
							Server returns access token, ID token, and optionally refresh
							token
						</CardListItem>
						<CardListItem>
							Application can use ID token for user identity
						</CardListItem>
						<CardListItem>
							Optional: Call UserInfo endpoint for additional claims
						</CardListItem>
					</CardList>
  ...
  "scope": "openid profile email read write"
			...
			<SecurityNotice>
				...
				<SecurityList>
					...
					<SecurityListItem>
						<strong>Validate ID tokens:</strong> Always verify ID token
						signature and claims
					</SecurityListItem>
					<SecurityListItem>
						<strong>Minimal scope:</strong> Request only the minimum required
						permissions and OIDC scopes
					</SecurityListItem>
					<SecurityListItem>
					...
					<SecurityListItem>
						<strong>Nonce validation:</strong> Use and validate nonce values in
						ID tokens
					</SecurityListItem>
					<SecurityListItem>
			...
			<InfoCard>
				...
				<CardContent>
					...
					<CardText style={{ color: "#0c4a6e" }}>
						Instead of the OIDC Resource Owner Password flow, consider these
						more secure alternatives:
					</CardText>
					<CardList style={{ color: "#0c4a6e" }}>
						<CardListItem>
							<strong>OIDC Authorization Code Flow:</strong> Most secure for web
							applications with SSO
						</CardListItem>
						<CardListItem>
							<strong>OIDC Authorization Code with PKCE:</strong> Best for
							mobile and SPA applications
						</CardListItem>
						<CardListItem>
							<strong>OIDC Implicit Flow:</strong> For legacy applications
							(deprecated, use PKCE instead)
						</CardListItem>
						<CardListItem>
							<strong>OIDC Hybrid Flow:</strong> When you need both ID token and
							authorization code
						</CardListItem>
						<CardListItem>
							<strong>OIDC Device Code Flow:</strong> For devices with limited
							input capabilities
						</CardListItem>
						<CardListItem>
							<strong>OIDC Client Credentials Flow:</strong> For
			...
			<SecurityNotice>
				...
				<CardText style={{ color: "#92400e" }}>
					This OIDC Resource Owner Password flow is currently{" "}
