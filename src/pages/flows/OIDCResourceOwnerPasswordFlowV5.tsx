// src/pages/flows/OIDCResourceOwnerPasswordFlowV5.tsx
...
const STEP_METADATA = [
	{
		...
		subtitle: 'Understand OIDC Resource Owner Password Flow and configure credentials',
	},
	{
		title: 'Step 1: Password Grant Request',
		subtitle: 'Request access token using username and password',
	},
	{ title: 'Step 2: Token Response', subtitle: 'Review the received access and ID tokens' },
					...
					<>
						...
						<ResultsSection>
							...
							<ul style={{ paddingLeft: '1.5rem' }}>
								...
								<li>Validate the ID token for user identification</li>
				...
				return (
					<>
						...
						<ResultsSection>
							...
							<ul style={{ paddingLeft: '1.5rem' }}>
								<li>How to use OIDC Resource Owner Password Flow for authentication</li>
								<li>Username and password credential handling</li>
								<li>Access and ID token management</li>
		...
		<Container>
			<ContentWrapper>
				...
				<MainCard>
					<StepHeader>
						<StepHeaderLeft>
							<VersionBadge>OIDC Resource Owner Password Flow · V5 · Legacy</VersionBadge>
...
export default OIDCResourceOwnerPasswordFlowV5;
