                    ...
                    <div>
                      ...
                      <FormGroup>
                        ...
                        <Input
                          ...
                          className={flowState.configErrors.some(e => e.includes('Environment')) ? 'error' : ''}
                        />
                      </FormGroup>
                      ...
                      <FormGroup>
                        ...
                        <Input
                          ...
                          className={flowState.configErrors.some(e => e.includes('Client ID')) ? 'error' : ''}
                        />
                      </FormGroup>
                      ...
                      <FormGroup>
                        ...
                        <Input
                          ...
                          className={flowState.configErrors.some(e => e.includes('Redirect')) ? 'error' : ''}
                        />
                      </FormGroup>
                      ...
                      <Button
                        ...
                        disabled={!flowState.credentials.clientId || !flowState.credentials.environmentId}
                      >
                        <FiCheckCircle />
                  ...
                  {step.number === 2 && (
                    <div>
                      <InfoBox>
                        ...
                        <p>
                          PKCE provides additional security for OAuth 2.0 flows by using cryptographically
                          random codes. This implementation uses SHA256 challenge method per RFC 7636.
                        </p>
                      </InfoBox>
                      ...
                      <Button
                        $variant="primary"
                        onClick={flowActions.generatePKCECodes}
                      >
                        <FiRefreshCw />
                  ...
                  {step.number === 3 && (
                    <div>
                      <InfoBox>
                        ...
                        <p>
                          The authorization URL includes all required parameters with cryptographically
                          secure state for CSRF protection.
                        </p>
                      </InfoBox>
                      ...
                      {flowState.authorizationUrl && (
                        <div>
                          <CodeBlock>
                            {flowState.authorizationUrl}
                            <CopyButton
                              onClick={() => copyToClipboard(flowState.authorizationUrl, 'Authorization URL')}
                            >
                              <FiCopy />
                              Copy
                            </CopyButton>
                      ...
                      {flowState.authorizationCode && (
                        <div>
                          ...
                          <InfoBox>
                            ...
                            <p>
                              Authorization code received and state parameter validated successfully.
                              You can now proceed to exchange the code for tokens.
                            </p>
                          </InfoBox>
                        </div>
                      )}
                  ...
                  {step.number === 5 && (
                    <div>
                      <InfoBox>
                        ...
                        <p>
                          Exchange the authorization code for access tokens using the PKCE code verifier
                      ...
                      {flowState.tokens && (
                        <div>
                          ...
                          <InfoBox>
                            ...
                            <p>
                              OAuth 2.0 Authorization Code Flow completed successfully with full RFC 6749 compliance.
                ...
                {flowState.errors.map((error, index) => (
                  <div key={index} style={{ marginBottom: '0.5rem' }}>
                    ...
                    {error.error_description && (
                      <>
                        <strong>Description:</strong> {error.error_description}<br />
                      </>
                    )}
                    {error.state && (
                      <>
