        ...
        <div>
          ...
          <div style={{ 
            ...
            <div 
              ...
              onClick={() => setShowGeneralTroubleshooting(!showGeneralTroubleshooting)}
            >
              <h4 style={{ margin: 0, color: '#92400e', display: 'flex', alignItems: 'center' }}>
                <FiAlertTriangle style={{ marginRight: '0.5rem' }} />
                Additional Troubleshooting
              </h4>
              {showGeneralTroubleshooting ? <FiChevronDown /> : <FiChevronRight />}
            </div>
              ...
              <div style={{ marginTop: '1.5rem' }}>
                ...
                <div style={{ 
                  ...
                  >
                    ...
                    {showUserInfoDetails ? <FiChevronDown /> : <FiChevronRight />}
                  </div>
  ...
  return (
    <Container>
      <Header>
        ...
        <Subtitle>
          OpenID Connect 1.0 Implicit Flow implementation (Deprecated - Use Authorization Code Flow with PKCE instead)
        </Subtitle>
      </Header>
