...
const OIDCHybridFlowV6: React.FC = () => {
	...
	const handleNext = useCallback(() => {
		if (currentStep === 0) {
			const { missingFields, canProceed } = CredentialGuardService.checkMissingFields(controller.credentials, {
			...
			<div>
				...
				>
					...
					<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem' }}>
						<div style={{ background: '#fff', borderRadius: '0.75rem', border: '1px solid #dbeafe', padding: '1rem' }}>
							<h4 style={{ margin: '0 0 0.5rem 0', color: '#1d4ed8' }}>Authorization Code</h4>
							<ul style={{ margin: 0, paddingLeft: '1rem', color: '#475569', fontSize: '0.875rem', lineHeight: 1.5 }}>
						...
						<div style={{ background: '#fff', borderRadius: '0.75rem', border: '1px solid #fef3c7', padding: '1rem' }}>
						...
						<div style={{ background: '#fff', borderRadius: '0.75rem', border: '1px solid #c4b5fd', padding: '1rem' }}>
							<h4 style={{ margin: '0 0 0.5rem 0', color: '#6d28d9' }}>Hybrid</h4>
							<ul style={{ margin: 0, paddingLeft: '1rem', color: '#475569', fontSize: '0.875rem', lineHeight: 1.5 }}>
			...
			{controller.authorizationUrl && (
				<div style={{ marginTop: '2rem' }}>
					{AuthenticationModalService.showModal(
						...
						() => {
							console.log('[OIDCHybridFlowV6] User clicked Continue - modal service will handle popup opening');
							setShowRedirectModal(false);
			...
			<div>
				...
				<div style={{ marginTop: '2rem' }}>
					{UnifiedTokenDisplayService.showTokens(
						{
							id_token: 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImRlZmF1bHQifQ.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.mock_signature',
							access_token: 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImRlZmF1bHQifQ.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.mock_signature',
							token_type: 'Bearer',
							expires_in: 3600,
	...
	const renderCodeExchange = () => (
		<div>
			...
			<div style={{ marginTop: '2rem' }}>
				{UnifiedTokenDisplayService.showTokens(
					{
						access_token: 'eyJhbGciOiJSUzI1NiIsImtpZCI6InRva2VuLWVuZHBvaW50In0.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJleHAiOjE1MTYyNDI2MjJ9.token_endpoint_signature',
