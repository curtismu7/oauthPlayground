      ...
      steps: [
        {
          ...
          content: 'OAuth 2.0 is an authorization framework that enables applications to obtain limited access to user accounts on an HTTP service.',
...
ID Token: JWT containing user identity information`,
    ...
    },
    {
      ...
      steps: [
        {
          title: 'Flow Overview',
          content: 'The Authorization Code flow is the most secure flow for applications that can securely store client secrets.',
  ...
  return (
    <Container>
      <Header>
        ...
        <p>
          Step-by-step guided learning paths to master OAuth 2.0 and OpenID Connect.
          Choose a tutorial and follow along with interactive examples and explanations.
        </p>
      </Header>

      <TutorialGrid>
        {tutorials.map((tutorial) => {
          const progress = completedTutorials.has(tutorial.id) ? 100 :
        ...
        <TutorialModal>
          <ModalContent>
            ...
            <StepContainer>
              ...
              <StepContent>
                {renderStepContent(selectedTutorial.steps[currentStep])}
              </StepContent>
