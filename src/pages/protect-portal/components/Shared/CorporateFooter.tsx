...
import { FiFacebook, FiTwitter, FiLinkedin, FiInstagram, FiYoutube, FiMail, FiPhone, FiMapPin } from 'react-icons/fi';
    ...
    <FooterContainer $brandColor={brandColor} $industry={industry}>
      <FooterContent>
        ...
        <FooterBottom $industry={industry}>
          ...
          <LegalLinks>
            <LegalLink href="#" $industry={industry}>Privacy Policy</LegalLink>
            <LegalLink href="#" $industry={industry}>Terms of Service</LegalLink>
            <LegalLink href="#" $industry={industry}>Cookie Policy</LegalLink>
            <LegalLink href="#" $industry={industry}>Accessibility</LegalLink>
            <LegalLink href="#" $industry={industry}>Legal Notices</LegalLink>
          </LegalLinks>
