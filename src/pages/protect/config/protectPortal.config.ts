...
export const MFA_DEVICE_TYPES = ['SMS', 'EMAIL', 'WHATSAPP', 'TOTP', 'FIDO2', 'MOBILE'] as const;
...
export const EDUCATIONAL_CONTENT = {
	...
	tokenDisplay: {
		...
		description:
			'Your login generates secure tokens that grant access to applications and services.',
		keyPoints: [
