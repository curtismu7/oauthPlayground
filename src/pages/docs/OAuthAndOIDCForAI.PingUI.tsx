...
const aiAuthResources = [
  {
    ...
    description: 'Comprehensive guide on implementing OAuth 2.0 flows specifically for AI agents and agentic systems.',
    url: 'https://datatracker.ietf.org/doc/html/draft-ietf-oauth-agent-flow-01',
    icon: 'FiCpu'
  },
  {
    title: 'OpenID Connect for AI',
    description: 'OIDC implementation patterns for AI systems with proper identity verification and token handling.',
    url: 'https://openid.net/connect/',
    icon: 'FiShield'
  },
  {
    title: 'JWT Bearer Tokens for AI',
    description: 'JWT-based authentication patterns for AI agent-to-agent communication and service integration.',
    url: 'https://datatracker.ietf.org/doc/html/rfc7523',
    icon: 'FiKey'
  },
  {
    title: 'AI Agent Security Best Practices',
    description: 'Security considerations and best practices for AI agent authentication and authorization.',
    url: 'https://owasp.org/www-project-ai-security/',
    icon: 'FiLock'
  },
  {
    title: 'Machine-to-Machine OAuth',
    description: 'Client Credentials flow optimization for AI systems and automated agent interactions.',
  ...
  return (
    <PingUIWrapper className="end-user-nano">
      <ContentContainer>
        ...
        <SectionTitle>
          <BootstrapIcon icon="FiCpu" size={24} />
        ...
        <LinkGrid>
          {aiAuthResources.map((resource, index) => (
            ...
            >
              <h3>
                {resource.title}
                <BootstrapIcon icon="FiExternalLink" size={16} />
              </h3>
        ...
        <SectionTitle>
          <BootstrapIcon icon="FiBookOpen" size={24} />
        ...
        <SectionTitle>
          <BootstrapIcon icon="FiShield" size={24} />
