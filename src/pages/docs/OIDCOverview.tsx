...
const OIDCOverview = () => {
	...
	const oidcConcepts: OIDCConcept[] = [
		...
		},
		{
			...
			icon: FiShield,
			examples: ['Web applications', 'Mobile apps', 'Single Page Apps', 'API services', 'Desktop applications'],
			importance: 'high',
		},
		{
			...
			icon: FiBookOpen,
			examples: ['PingOne', 'Auth0', 'Okta', 'Azure AD', 'Google Identity', 'Keycloak', 'AWS Cognito'],
			importance: 'high',
		},
		{
			title: 'Claims',
			description: 'Pieces of information about the end user included in the ID Token. Can be standard, custom, or aggregated.',
			icon: FiInfo,
			examples: [
		...
		},
		{
			...
			icon: FiZap,
			examples: ['Well-known configuration', 'JWKS endpoint', 'Supported scopes', 'Supported claims'],
			importance: 'medium',
		},
	];
			...
			<div style={{ 
				...
				<Header>
					...
					<p>
						...
						Learn about OIDC flows, security considerations, and implementation patterns.
					</p>
				</Header>
			...
			<section style={{ marginBottom: '4rem' }}>
				<div style={{ textAlign: 'center', marginBottom: '3rem' }}>
					...
					<p style={{ fontSize: '1.125rem', color: '#6b7280', maxWidth: '600px', margin: '0 auto' }}>
						Choose the right authentication flow for your application type and security requirements
					</p>
					<span style={{ 
							...
							<FlowCardBody>
								...
								<div style={{ marginBottom: '1rem' }}>
									<div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
										<strong style={{ fontSize: '0.875rem', color: '#374151' }}>Security Level:</strong>
									...
									>
										...
										<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
											<div>
												...
												<ul style={{ fontSize: '0.875rem', color: '#374151', margin: 0, paddingLeft: '1rem' }}>
