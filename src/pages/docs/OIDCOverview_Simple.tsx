		...
		<div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
			...
			>
				...
				<ul>
					...
					<li>Interactive flow cards with detailed information</li>
					<li>Visual security indicators</li>
					<li>Comprehensive pros/cons analysis</li>
...
export default OIDCOverviewSimple;
