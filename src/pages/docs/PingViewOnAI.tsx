  ...
  return (
    <PageContainer>
      ...
      <Header>
        ...
        <p>
          Ping Identity's comprehensive perspective on Artificial Intelligence in identity and access management
        </p>
      </Header>
      ...
      >
        <Card>
          <p>
            Artificial Intelligence is revolutionizing how organizations approach identity and access management. 
            Ping Identity recognizes AI as both an opportunity and a challenge, requiring new approaches to security, 
          ...
          <FeatureGrid>
            <FeatureCard>
              <h3><FiShield />AI-Enhanced Security</h3>
              <p>
                Leverage machine learning for threat detection, anomaly detection, and adaptive authentication 
                to protect against sophisticated attacks.
              </p>
            </FeatureCard>
            
            <FeatureCard>
              <h3><FiUsers />Intelligent User Experience</h3>
              <p>
                Use AI to personalize authentication flows, predict user needs, and provide seamless access 
                experiences across all touchpoints.
              </p>
            </FeatureCard>
            
            <FeatureCard>
              <h3><FiKey />Smart Identity Verification</h3>
              <p>
      ...
      >
        <Card>
          ...
          <FeatureGrid>
            <FeatureCard>
              <h3><FiShield />Adaptive Authentication</h3>
              <p>
                AI-driven risk assessment that continuously evaluates user behavior, device characteristics, 
                and contextual factors to determine appropriate authentication requirements.
              </p>
            </FeatureCard>
            ...
            <FeatureCard>
              <h3><FiGlobe />Intelligent Access Management</h3>
              <p>
                AI-powered access decisions that consider user roles, resource sensitivity, and risk factors 
                to provide dynamic, context-aware access control.
              </p>
            </FeatureCard>
            
            <FeatureCard>
              <h3><FiUsers />Personalized User Experience</h3>
              <p>
                AI-driven personalization that adapts authentication flows, UI elements, and user journeys 
                based on individual user preferences and behavior patterns.
              </p>
            </FeatureCard>
          </FeatureGrid>
          ...
          <InfoBox $variant="success">
            ...
            <div>
              ...
              with built-in compliance, audit trails, and governance controls.
            </div>
          </InfoBox>
        </Card>
      </CollapsibleHeader>
      ...
      >
        <Card>
          ...
          <FeatureGrid>
            <FeatureCard>
              <h3><FiShield />Data Protection</h3>
              <p>
            ...
            <FeatureCard>
              <h3><FiKey />Model Security</h3>
              <p>
                AI models are secured with encryption, access controls, and regular security audits. 
                Model integrity is continuously monitored and validated.
              </p>
            </FeatureCard>
            
            <FeatureCard>
              <h3><FiGlobe />Privacy by Design</h3>
              <p>
            ...
            <FeatureCard>
              <h3><FiUsers />Transparent AI</h3>
              <p>
                AI decisions are explainable and auditable. Users and administrators can understand 
                how AI models make decisions and access detailed audit logs.
              </p>
            </FeatureCard>
          </FeatureGrid>
          ...
          <InfoBox $variant="warning">
            ...
            <div>
              ...
              and other privacy regulations with built-in data protection and user rights management.
            </div>
          </InfoBox>
        </Card>
      </CollapsibleHeader>
        ...
        <Card>
          ...
          <div style={{ display: 'grid', gap: '1.5rem', marginTop: '1.5rem' }}>
            <div style={{ 
              ...
              <h4 style={{ fontSize: '1.125rem', fontWeight: '600', marginBottom: '0.5rem', color: '#0369a1' }}>
                Phase 1: Foundation
              </h4>
              <p style={{ color: '#0369a1', marginBottom: '1rem' }}>
                Establish data governance, privacy controls, and baseline security measures before implementing AI features.
              </p>
            ...
            <div style={{ 
              ...
              <h4 style={{ fontSize: '1.125rem', fontWeight: '600', marginBottom: '0.5rem', color: '#15803d' }}>
                Phase 2: Pilot Implementation
              </h4>
              <p style={{ color: '#15803d', marginBottom: '1rem' }}>
                Start with low-risk AI features in controlled environments to validate effectiveness and security.
              </p>
            ...
            <div style={{ 
              ...
              <p style={{ color: '#92400e', marginBottom: '1rem' }}>
                Roll out AI capabilities across the organization with comprehensive monitoring and governance.
              </p>
