			...
			<ContentWrapper>
				...
				>
					<SpecCard title="AI Authentication Fundamentals">
						<p>
							Understanding how AI systems authenticate and authorize access to resources and
							services:
						</p>
						<ul>
							<li>
								<strong>AI Agent Identity:</strong> How AI systems establish their identity and
								prove they are authorized to act
							</li>
							<li>
								<strong>User Context Preservation:</strong> Maintaining user identity through the AI
								processing pipeline
							</li>
							<li>
								<strong>Service-to-Service Authentication:</strong> AI systems authenticating with
								other services and APIs
							</li>
							<li>
								<strong>Delegated Authorization:</strong> AI acting on behalf of users with
								appropriate permissions
							</li>
							<li>
								<strong>Token Lifecycle Management:</strong> Managing authentication tokens for
					...
					<SpecCard title="AI Authentication Patterns">
						...
						<ul>
							<li>
								<strong>Client Credentials Flow:</strong> For AI model access and service-to-service
								authentication
							</li>
							<li>
							...
							<li>
								<strong>Device Authorization Flow:</strong> For AI systems running on constrained
								devices
							</li>
							<li>
							...
							<li>
								<strong>Token Exchange (RFC 8693):</strong> For AI systems exchanging tokens between
								services
							</li>
						</ul>
					</SpecCard>
					...
					<SpecCard title="AI-Specific OAuth Scopes">
						...
						<ul>
							<li>
								<strong>ai:read</strong> - AI can read user data for inference
							</li>
							<li>
								<strong>ai:analyze</strong> - AI can analyze patterns in user data
							</li>
							<li>
								<strong>ai:train</strong> - Use data for model training (requires explicit consent)
							</li>
							<li>
								<strong>ai:personalize</strong> - Store preferences for personalization
							</li>
							<li>
								<strong>ai:generate</strong> - Generate content using user context
							</li>
							<li>
								<strong>ai:share_insights</strong> - Share anonymized insights with third parties
							</li>
						</ul>
					</SpecCard>
					...
					<SpecCard title="Privacy-Preserving AI Authentication">
						...
						<ul>
							<li>
								<strong>Zero-Knowledge Proofs:</strong> Allow AI to verify user attributes without
								learning them
							</li>
							<li>
								<strong>Federated Learning Credentials:</strong> Authenticate AI contributions
								without revealing data sources
							</li>
							<li>
								<strong>Differential Privacy Tokens:</strong> Tokens that encode privacy budgets for
								AI queries
							</li>
							<li>
							...
							<li>
								<strong>Secure Multi-Party Computation:</strong> Collaborative AI without sharing
								raw data
							</li>
						</ul>
					</SpecCard>
					...
					<SpecCard title="Multi-Modal AI Authentication">
						...
						<ul>
							<li>
								<strong>Text Processing:</strong> Messages, documents, emails
							</li>
							<li>
								<strong>Image Analysis:</strong> Photos, diagrams, screenshots
							</li>
							<li>
								<strong>Audio Processing:</strong> Voice recordings, music
							</li>
							<li>
								<strong>Video Analysis:</strong> Calls, recordings
							</li>
							<li>
								<strong>Structured Data:</strong> Databases, spreadsheets
							</li>
							<li>
								<strong>Real-time Streams:</strong> Sensor data, live feeds
							</li>
						</ul>
					</SpecCard>
