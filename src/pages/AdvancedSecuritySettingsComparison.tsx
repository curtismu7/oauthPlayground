  ...
  return (
    <PageContainer>
      ...
      <InfoCard>
        ...
        <InfoText>
          We now have both a <strong>compact version</strong> for use inside flows and a <strong>full version</strong> for comprehensive configuration. 
          The compact version fits seamlessly into existing flows while maintaining all essential security settings.
        </InfoText>
      </InfoCard>
        ...
        <VersionCard>
          <VersionHeader>
            ...
            <VersionInfo>
              ...
              <VersionDescription>
                Designed for integration inside flows. Collapsible interface with essential security settings.
              </VersionDescription>
            </VersionInfo>
          </VersionHeader>
          <VersionContent>
        ...
        <VersionCard>
          <VersionHeader>
            ...
            <VersionInfo>
              ...
              <VersionDescription>
                Comprehensive configuration interface with detailed explanations and advanced features.
              </VersionDescription>
            </VersionInfo>
          </VersionHeader>
          <VersionContent>
      ...
      <div style={{ maxWidth: '1400px', margin: '2rem auto 0 auto' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: '600', color: '#0f172a', margin: '0 0 1rem 0' }}>
          Integration Examples
        </h2>
        <div style={{ 
          display: 'grid', 
          ...
          <div style={{
            ...
            <p style={{ fontSize: '0.875rem', color: '#64748b', margin: '0 0 1rem 0' }}>
              The compact version can be embedded directly into flow components like ComprehensiveCredentialsService.
            </p>
            <code style={{ 
              fontSize: '0.75rem', 
              background: '#f1f5f9', 
          ...
          <div style={{
            ...
            <p style={{ fontSize: '0.875rem', color: '#64748b', margin: '0 0 1rem 0' }}>
              The full version provides comprehensive configuration with educational content and advanced features.
            </p>
            <code style={{ 
              fontSize: '0.75rem', 
              background: '#f1f5f9', 
