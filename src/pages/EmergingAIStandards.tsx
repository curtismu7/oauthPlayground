import { FiAlertCircle, FiGitBranch, FiGlobe, FiLayers, FiLink, FiShield, FiUsers } from 'react-icons/fi';
...
const EmergingAIStandards = () => {
  ...
  const { PageContainer, ContentWrapper, SectionContainer, ContentGrid, Spacing } = PageLayoutService.createPageLayout(pageConfig);
        ...
        <SectionContainer>
          ...
          >
            <SummaryCard>
              <CardBody>
                <p>
                  Personal and enterprise AI agents increasingly interact with services that have no advance knowledge of the client. Traditional Dynamic Client Registration forces prior trust arrangements and manual approvals, creating friction that stalls emerging agent-to-service topologies. The community is responding with URL-addressable client metadata, assertion-based grants, and cross-domain identity chaining to preserve security while enabling spontaneous collaboration.
                </p>
                <Highlight>
                  <FiLink />
                  Coordinated standards work across the IETF OAuth Working Group and the Model Context Protocol is accelerating these capabilities.
                </Highlight>
              </CardBody>
            </SummaryCard>
          </CollapsibleHeader>
          ...
          >
            <Card>
              <CardBody>
                ...
                <p>
                  These resources capture the ongoing collaboration between standards leaders, including Brian Campbell, Aaron Parecki, and the Model Context Protocol community, as they align OAuth extensions with real-world agent requirements.
                </p>
              </CardBody>
            </Card>
          </CollapsibleHeader>
