...
import { FiCpu, FiBookOpen, FiExternalLink, FiLink2, FiFileText, FiDatabase, FiUsers, FiShield, FiCode, FiTool, FiHelpCircle } from 'react-icons/fi';
...
const PingAIResources: React.FC = () => {
  ...
  const { PageContainer, ContentWrapper, FlowHeader: LayoutFlowHeader } = PageLayoutService.createPageLayout(pageConfig);
      ...
      <ContentWrapper>
        ...
        <Header>
          ...
          <p>
            ...
            for implementing AI-powered identity solutions
          </p>
        </Header>
          ...
          <Card>
            <ResourceGrid>
              ...
              >
                ...
                <p>
                  Comprehensive guide to different types of AI agents and their specific identity and authentication requirements. 
                  Learn about agent architectures, capabilities, and how OAuth/OIDC applies to each type.
                </p>
          ...
          <Card>
            <ResourceGrid>
              ...
              >
                ...
                <p>
                  Official PingOne documentation for AI-powered identity solutions, including configuration, 
              ...
              >
                ...
                <p>
                  Internal Ping Identity wiki page covering AI group perspectives, strategies, and resources 
                  for AI-powered identity solutions.
                </p>
                <span className="external-link">
              ...
              >
                ...
                <p>
                  Visual architecture diagram showing AI identity system components, flows, and integration patterns 
                  in Lucidchart.
                </p>
                <span className="external-link">
              ...
              >
                ...
                <p>
                  Detailed flow diagram illustrating AI identity authentication and authorization processes 
                  in Lucidchart.
                </p>
                <span className="external-link">
                  View Diagram <FiExternalLink size={14} />
          ...
          <Card>
            <ResourceGrid>
              ...
              >
                ...
                <p>
                  Security best practices and guidelines for implementing identity solutions in AI-powered 
                  applications and protecting AI systems from identity-based attacks.
                </p>
                <span className="external-link">
          ...
          <Card>
            <ResourceGrid>
              ...
              >
                ...
                <p>
                  Comprehensive guide to agentic AI, understanding how autonomous AI agents work and how 
                  identity and access management applies to agentic AI systems.
                </p>
                <span className="external-link">
                  View Guide <FiExternalLink size={14} />
                </span>
          ...
          <Card>
            <ResourceGrid>
              ...
              >
                ...
                <p>
                  Complete API reference for PingOne authentication services, including OAuth 2.0 and OpenID Connect endpoints, 
              ...
              >
                ...
                <p>
                  Official PingOne SDKs for multiple programming languages and platforms, including JavaScript, 
                  Python, Java, .NET, and mobile SDKs for iOS and Android.
                </p>
                <span className="external-link">
              ...
              >
                ...
                <p>
                  Comprehensive guide to configuring and implementing OAuth 2.0 with PingOne, including 
                  grant types, token management, and security best practices.
                </p>
                <span className="external-link">
                  View Guide <FiExternalLink size={14} />
                </span>
              ...
              >
                ...
                <p>
                  Complete OpenID Connect implementation guide for PingOne, covering ID tokens, user information, 
                  discovery, and OIDC-specific features.
                </p>
                <span className="external-link">
                  View Guide <FiExternalLink size={14} />
                </span>
              ...
              >
                ...
                <p>
                  Step-by-step configuration guide for setting up OAuth 2.0 and OpenID Connect in PingOne, 
                  including application creation, scope configuration, and endpoint setup.
                </p>
                <span className="external-link">
                  View Guide <FiExternalLink size={14} />
                </span>
              ...
              >
                ...
                <p>
                  Complete guide to configuring Single Sign-On (SSO) with PingOne, including application integration, 
                  identity provider setup, and user experience configuration.
                </p>
                <span className="external-link">
                  View Guide <FiExternalLink size={14} />
                </span>
              ...
              >
                ...
                <p>
                  Access Ping Identity's support portal for technical assistance, knowledge base articles, 
                  community forums, and support ticket submission.
                </p>
                <span className="external-link">
        ...
        <InfoBox $variant="info" style={{ marginTop: '2rem' }}>
          <FiCpu size={20} />
          <div>
            <strong>Getting Started:</strong> Begin with the "Types of Agents" document to understand different 
            AI agent architectures. Then explore the PingOne AI-powered identity documentation for implementation 
            guidance and best practices. Use the developer resources section for API references and configuration guides.
          </div>
        </InfoBox>
      </ContentWrapper>
    </PageContainer>
