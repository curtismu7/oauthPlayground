...
const StatIcon = styled.div<{
	$variant: "flows" | "tokens" | "success" | "security";
}>`
  width: 40px;
  height: 40px;
  border-radius: 10px;
...
const Dashboard = () => {
	...
	const [_showActivityModal, setShowActivityModal] = useState(false);
	...
	const _infoType =
		(location.state as { type?: "success" | "error" | "warning" | "info" })
			?.type || "info";
				...
				if (activity.length === 0) {
					const sampleActivities = [
						...
						},
						{
							...
							success: true,
							details:
								"OAuth 2.0 Authorization Code flow completed successfully",
						},
					];
	...
	const calculateSuccessRate = useCallback((): number => {
		...
		const successfulActivities = recentActivity.filter(
			(activity) =>
				...
				activity.title?.toLowerCase().includes("success"),
		).length;
	...
	}, [tokens, calculateSecurityScore, calculateSuccessRate]);
		...
		<>
			...
			<DashboardContainer>
				...
				<Header>
					...
					<p>
						Your comprehensive OAuth 2.0 and OpenID Connect testing environment
					</p>
				</Header>
										...
										<tbody>
											...
											<tr>
												...
												>
													...
													>
														{getFlowStatus("oauth2-implicit-v3")
															?.lastExecutionTime || "Never"}
													</span>
												</td>
												<td
												...
												>
													<span
														style={{
															...
															fontWeight: "500",
															backgroundColor:
																getFlowStatus("oidc-implicit-v3")
																	?.lastExecutionTime &&
																getFlowStatus("oidc-implicit-v3")
																	?.lastExecutionTime !== "Never"
																	? "#dcfce7"
													...
													<span
														style={{
															...
															backgroundColor: getFlowStatus("oidc-implicit-v3")
																...
																? "#dcfce7"
																: "#fee2e2",
															color: getFlowStatus("oidc-implicit-v3")
																?.hasCredentials
																? "#166534"
																: "#dc2626",
														}}
													...
													<span
														style={{
															...
															backgroundColor: getFlowStatus("oidc-hybrid-v3")
																...
																? "#dcfce7"
																: "#fee2e2",
															color: getFlowStatus("oidc-hybrid-v3")
																?.hasCredentials
																? "#166534"
																: "#dc2626",
														}}
												...
												>
													<span
														style={{
															...
															fontWeight: "500",
															backgroundColor:
																getFlowStatus("device-code-oidc")
																	?.lastExecutionTime &&
																getFlowStatus("device-code-oidc")
																	?.lastExecutionTime !== "Never"
																	? "#dcfce7"
													...
													<span
														style={{
															...
															backgroundColor: getFlowStatus("device-code-oidc")
																...
																? "#dcfce7"
																: "#fee2e2",
															color: getFlowStatus("device-code-oidc")
																?.hasCredentials
																? "#166534"
																: "#dc2626",
														}}
													...
													<span
														style={{
															...
															backgroundColor: getFlowStatus("worker-token-v3")
																...
																? "#dcfce7"
																: "#fee2e2",
															color: getFlowStatus("worker-token-v3")
																?.hasCredentials
																? "#166534"
																: "#dc2626",
														}}
