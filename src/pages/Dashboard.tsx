...
const Dashboard = () => {
  ...
  const getFlowStatus = (flowType: string) => {
    const status = flowCredentialStatuses.find(
      (flowStatus) => flowStatus.flowType === flowType
    );
  ...
  const apiEndpoints = [
    ...
    { method: 'POST', path: '/api/token-exchange', desc: 'Exchange authorization codes for tokens' },
    ...
    <DashboardContainer>
      ...
      <ContentCard>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
              ...
              {Object.entries(FLOW_CONFIGS)
                ...
                return (
                  ...
                  >
                    ...
                    <StatusBadge
                      $status={status?.hasCredentials ? 'active' : 'error'}
                    >
          ...
          {/* OIDC V5 Flows */}
          <div>
            <h3 style={{ fontSize: '1rem', fontWeight: '600', marginBottom: '1rem', color: '#059669' }}>
              OIDC V5 Flows
            </h3>
            <div style={{ space: '0.5rem' }}>
              {Object.entries(FLOW_CONFIGS)
      ...
      <ContentCard>
        ...
        <div style={{ marginBottom: '1rem' }}>
          <p style={{ color: '#666', fontSize: '0.95rem' }}>
            Explore OAuth 2.0 and OpenID Connect flows. Defaults are secure-by-default (Auth Code with PKCE).
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
              <a href="/flows/oauth-authorization-code-v5" style={{
                ...
                textDecoration: 'none',
                fontSize: '0.875rem'
              }}>Authorization Code V5</a>
              
              <a href="/flows/client-credentials-v5" style={{
                display: 'inline-block',
                padding: '0.5rem 0.75rem',
                borderRadius: '6px',
                background: '#f3f4f6',
                ...
                textDecoration: 'none',
                fontSize: '0.875rem'
              }}>Client Credentials V5</a>
              
              <a href="/flows/device-authorization-v5" style={{
                display: 'inline-block',
                padding: '0.5rem 0.75rem',
                borderRadius: '6px',
                background: '#f3f4f6',
              ...
              <a href="/flows/oauth-implicit-v5" style={{
                display: 'inline-block',
                padding: '0.5rem 0.75rem',
                borderRadius: '6px',
                background: '#f3f4f6',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
              <a href="/flows/oidc-authorization-code-v5" style={{
                display: 'inline-block',
                padding: '0.5rem 0.75rem',
                borderRadius: '6px',
                background: '#10b981',
                ...
                textDecoration: 'none',
                fontSize: '0.875rem'
              }}>OIDC Authorization Code V5</a>
              
              <a href="/flows/oidc-implicit-v5" style={{
                display: 'inline-block',
                padding: '0.5rem 0.75rem',
                borderRadius: '6px',
                background: '#f3f4f6',
