	...
	useEffect(() => {
		...
		const handleCallback = () => {
			...
			if (code) {
				...
				logger.info('✅ [AuthCallback] Full authorization code length:', code.length);
				...
				if (isPopup) {
					...
					logger.info(
						'✅ [AuthCallback] Set callback_processed flag for polling fallback',
						'Logger info'
					);
					...
					logger.info(
						'✅ [AuthCallback] Storing in current window sessionStorage...',
						'Logger info'
					);
				...
				logger.info('✅ [AuthCallback] Verification results:', {
					isPopup,
					code: verifyCode
				...
				if (isPopup) {
					...
					logger.info('✅ [AuthCallback] Scheduling redirect to', redirectPath, 'in 3 seconds...');
					setTimeout(() => {
						setRedirecting(true);
						logger.info('✅ [AuthCallback] Redirecting now to', redirectPath);
						setTimeout(() => {
							logger.info(
								'✅ [AuthCallback] Executing window.location.href redirect...',
								'Logger info'
							);
