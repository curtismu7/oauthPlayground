      ...
      if (errorParam) {
        ...
        return;
			...
			if (code) {
				...
				const isOIDCFlow = activeFlow.includes('oidc-authorization-code') || activeFlow.includes('oidc-v');
      ...
      <Card>
        ...
        {status === 'success' && (
          <>
            ...
            {!redirecting && (
              <RedirectingMessage>
                🐛 DEBUG MODE: Popup will stay open so you can review the console logs. Close this window manually when done.
              </RedirectingMessage>
            )}
          </>
        )}
