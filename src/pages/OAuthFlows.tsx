	...
	return (
		<FlowsContainer>
			<PageHeader>
				...
				>
					<strong> PingOne Support:</strong> All flows shown below are fully supported by PingOne's
					OAuth 2.0 and OpenID Connect implementation. PingOne follows OAuth 2.0 RFC 6749 and OpenID
					Connect Core 1.0 specifications, ensuring industry-standard compliance and security.
				</div>
			</PageHeader>
				...
				<FlowDemo>
					...
					<CardBody>
						<div style={{ marginBottom: '1.5rem' }}>
							<h3>Use Cases</h3>
							<ul>
								{selectedFlow.useCases.map(
									(useCase: OAuthFlow['useCases'][number], index: number) => (
