				...
				<div style={styles.layoutGrid}>
					...
					<div style={styles.card}>
						...
						{viewMode === 'single' ? (
							...
							<>
								...
								<div style={styles.fieldGroup}>
									...
									/>
									<p style={styles.hint}>
										Filter by correlation ID to track related activities across multiple audit
										events
									</p>
								</div>
								...
								<div style={styles.fieldGroup}>
									...
									>
										Note: Time-based filtering is not supported by the PingOne Audit API. Results
						...
						<div style={styles.buttonRow}>
							...
							>
								<span>❌</span>
								{viewMode === 'single' ? 'Clear ID' : 'Reset Filters'}
							</button>
						</div>
															...
															<div style={styles.activityMain}>
																...
																<div style={styles.activityDetails}>
																	...
																	{activity.actors?.client?.name && (
																		<span style={styles.detailBadge('#f8fafc')}>
