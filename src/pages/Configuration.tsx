...
cd oauthPlayground`}
				...
				<StepCard>
					...
					<InfoBox $type="info">
						<strong>Note:</strong> This project requires Node.js version 16.0 or higher. Check your
						version with <code>node --version</code>.
					</InfoBox>
				</StepCard>
				...
				<StepCard>
					...
					<InfoBox $type="info">
						...
						backend (Express) servers, performs health checks, and automatically opens your browser
						to <code>https://localhost:3000</code>.
					</InfoBox>
				</StepCard>
			</Card>
			</CollapsibleHeader>
		...
		>
			...
			<div style={{ display: 'grid', gap: '1rem' }}>
					...
					<InfoBox $type="info">
						...
						PingOne configuration. Check the <code>.env</code> file exists and contains the required
						variables.
					</InfoBox>
				</div>
			</Card>
