...
const OAuthCodeGeneratorHub: React.FC = () => {
	return (
		<PageContainer>
			...
			<HeroSection>
				<FeatureGrid>
					<FeatureCard color={COLORS.PRIMARY.GREEN}>
						<FeatureIcon
					...
					<FeatureCard color={COLORS.PRIMARY.BLUE_DARK}>
						<FeatureIcon
					...
					<FeatureCard color={COLORS.PRIMARY.RED}>
						<FeatureIcon
					...
					<FeatureCard color={COLORS.PRIMARY.BLUE}>
						<FeatureIcon
