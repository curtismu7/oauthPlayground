...
const ConsoleLayout = styled.div`
	...
	background: radial-gradient(circle at top, rgba(59, 130, 246, 0.4), transparent 55%),
		linear-gradient(135deg, #e0f2fe 0%, #cbd5fe 60%, #bfdbfe 100%);
								...
								<InfoBox $variant="info" style={{ marginTop: '1rem' }}>
									...
									<div>
										...
										<InfoText>
											...
											`refresh_token`. For ID Tokens and UserInfo, use the OIDC Device Authorization
											Flow which adds the `openid` scope.
										</InfoText>
									</div>
								</InfoBox>
			...
			<InfoBox $variant="info" style={{ marginTop: '1rem' }}>
				...
				<div>
					...
					<InfoText>
						...
						<br />
						<br />
						<strong>Scopes:</strong> PingOne requires the <code>openid</code> scope even for OAuth
						flows. It will be automatically added if you remove it. You can add additional scopes
						like
						<code>profile</code>, <code>email</code>, <code>offline_access</code>, or custom API
						scopes.
					</InfoText>
				</div>
			</InfoBox>
							...
							<InfoBox $variant="info">
								...
								<div>
									...
									<InfoText style={{ marginTop: '0.75rem', color: '#0c4a6e' }}>
										Select the type of device you want to simulate. This updates the entire flow’s
