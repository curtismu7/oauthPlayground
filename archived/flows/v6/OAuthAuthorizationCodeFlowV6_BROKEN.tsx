...
import { EnhancedApiCallData, EnhancedApiCallDisplayService } from '../../services/enhancedApiCallDisplayService';
...
import { IntrospectionApiCallData, TokenIntrospectionService } from '../../services/tokenIntrospectionService';
...
const OAuthAuthorizationCodeFlowV6: React.FC = () => {
	...
	usePageScroll({ pageName: 'OAuth Authorization Code Flow V6', force: true });
