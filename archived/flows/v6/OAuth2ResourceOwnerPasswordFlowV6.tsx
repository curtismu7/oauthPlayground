						...
						<>
							...
							<MockNotice>
								...
								<MockNoticeContent>
									...
									<MockNoticeText>
										This flow uses your real PingOne credentials but generates mock tokens for
										educational purposes. The username and password are pre-filled with demo values.
									</MockNoticeText>
								</MockNoticeContent>
							</MockNotice>
							...
							{controller.tokens && (
								<ResultCard>
									...
									<TokenDisplay>
										...
										<div style={{ fontSize: '0.75rem' }}>{controller.tokens.access_token}</div>
									</TokenDisplay>
