...
const RARFlowV6: React.FC = () => {
	console.log('🚀 [RARFlowV6] Component loaded!', {
	...
	const handleNext = useCallback(() => {
		console.log('🔍 [RAR V6] handleNext called:', {
			currentStep,
		...
		AuthorizationCodeSharedService.Navigation.handleNext(
			currentStep,
			controller.credentials,
			'oidc', // RAR is based on OIDC
			controller,
			isStepValid,
			() => {
				console.log('✅ [RAR V6] Navigation allowed, moving to next step');
						...
						>
							<InfoBox $variant="info">
								...
								<div>
									...
									<InfoText>
										OIDC Authorization Code Flow is perfect when you need to authenticate users and
										verify their identity while also accessing their resources. Provides full OIDC
										context with ID tokens.
									</InfoText>
								</div>
							</InfoBox>
							<FlowSuitability>
							...
							<ParameterGrid>
								<InfoBox $variant="info">
									...
									<div>
										...
										<InfoList>
											<li>
												<strong>response_type=code:</strong> Tells PingOne you want an authorization
												code (not tokens)
											</li>
											<li>
								...
								<InfoBox $variant="success">
									...
									<div>
										...
										<InfoList>
											...
											<li>
												<strong>nonce:</strong> (OIDC) Random value to prevent replay attacks on ID
												tokens
											</li>
										</InfoList>
									</div>
					...
					<>
						...
						>
							<ResultsSection>
								...
								<HelperText>
									Use the authorization code immediately—it expires quickly. Copy it if you need to
									inspect the token exchange request.
								</HelperText>
								{authCode ? (
									<GeneratedContentBox>
					...
					<>
						...
						>
							<ExplanationSection>
								...
								<InfoText>
									Call the backend token exchange endpoint to swap the authorization code for access
									and ID tokens.
								</InfoText>
							</ExplanationSection>
						</CollapsibleHeader>
	...
	return (
		<Container>
			<ContentWrapper>
				...
				{currentStep === 0 &&
					AdvancedParametersSectionService.getSimpleSection('oauth-authorization-code')}
			...
			{AuthenticationModalService.showModal(
				...
				() => {
					console.log(
						'🔧 [RARFlowV6] User clicked Continue - modal service will handle popup opening'
					);
					setShowRedirectModal(false);
