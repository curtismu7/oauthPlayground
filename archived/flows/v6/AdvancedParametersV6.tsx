...
} from '../../components/DisplayParameterSelector';
...
export const AdvancedParametersV6: React.FC<AdvancedParametersV6Props> = ({
	...
	const isPingOneFlow =
		actualFlowType.includes('authorization-code') &&
			...
			<Content>
				...
				{isPingOneFlow && (
					...
					>
						<div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
							<FiAlertCircle
								style={{ flexShrink: 0, marginTop: '0.25rem', color: '#ea580c' }}
								size={24}
							/>
							<div>
								<strong style={{ color: '#ea580c' }}>Note: PingOne Flow</strong>
								<p style={{ marginTop: '0.5rem', marginBottom: '0.5rem' }}>
									This page shows only parameters that are well-supported by PingOne. Some advanced
									OAuth/OIDC parameters (like <strong>Resource Indicators RFC 8707</strong> and{' '}
									<strong>Display Parameter</strong>) are not reliably supported and have been
									hidden.
								</p>
				...
				{!isDeviceFlow && (
					<>
						...
						{!isPingOneFlow && (
							...
							>
								<InfoBox $variant="warning">
									<strong>⚠️ Limited Support:</strong> RFC 8707 Resource Indicators are not widely
									supported. PingOne and many authorization servers do not honor this parameter. See
									the{' '}
									<Link
										to="/flows/advanced-oauth-params-demo"
				...
				<ButtonContainer>
					...
					<InfoBox style={{ maxWidth: '600px', marginTop: '1rem' }}>
						<strong>💡 Tip:</strong> Save your advanced parameters to persist them across browser
						refreshes. Your saved settings will automatically load next time you visit this flow.
					</InfoBox>
				</ButtonContainer>
			</Content>
		</Container>
