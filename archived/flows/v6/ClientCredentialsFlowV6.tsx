			...
			if (isClientCredentialsV7) {
				if (!trimmedScopes) {
					...
					v4ToastManager.showWarning(
						'Added default admin scopes required for PingOne client credentials'
					);
				}
						...
						<CollapsibleContent>
							<InfoBox $variant="info">
								...
								<div>
									...
									<InfoText>
										...
										This is ideal for background processes, API integrations, and service-to-service
										communication.
									</InfoText>
								</div>
							</InfoBox>
							...
							<InfoBox $variant="success">
								...
								<div>
									...
									<InfoText>
										Unlike user-facing flows that require user interaction and consent, Client
										Credentials flow is designed for trusted applications that need to authenticate
						...
						<CollapsibleContent>
							...
							<InfoBox $variant="warning">
								...
								<div>
									<InfoTitle>Security Considerations</InfoTitle>
									<InfoText>
										Store client secrets securely and never expose them in client-side code. Use
										environment variables, secure vaults, or managed identity systems.
									</InfoText>
								</div>
							</InfoBox>
						</CollapsibleContent>
						...
						<CollapsibleContent>
							<InfoBox $variant="info">
								...
								<div>
									...
									<InfoText>
										Execute a token request using {config.authMethod.replace(/_/g, ' ')}{' '}
										authentication to obtain an access token for API access.
									</InfoText>
								</div>
							</InfoBox>
					...
					<CollapsibleContent>
						...
						<InfoBox $variant="success">
							...
							<div>
								...
								<InfoText>
									Verify token expiration, scope, audience, and other claims to ensure the token is
									valid and appropriate for your use case.
								</InfoText>
							</div>
						</InfoBox>
					</CollapsibleContent>
					...
					<CollapsibleContent>
						<InfoBox $variant="info">
							...
							<div>
								...
								<InfoText>
									Introspect, manage, and monitor your access tokens to ensure proper security and
						...
						<InfoBox $variant="success">
							...
							<div>
								...
								<InfoText>
									Monitor token usage, validate claims, and revoke tokens when necessary to maintain
