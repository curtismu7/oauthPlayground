...
export const RARFlowV6: React.FC = () => {
	...
	useEffect(() => {
		try {
			...
			console.log(
				'💾 [RAR-V6] Authorization details saved to FlowStorageService:',
				authorizationDetails
			);
			...
			console.log(
				'💾 [RAR-V6] Authorization details saved to localStorage (legacy):',
				authorizationDetails
			);
		} catch (error) {
					...
					<>
						...
						{tokens && (
							<>
								...
								{UnifiedTokenDisplayService.showTokens(tokens, 'oauth', 'rar-v6', {
