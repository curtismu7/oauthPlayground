					...
					<>
							...
							<InfoBox $variant="info">
								...
								<div>
									...
									<InfoList>
										...
										<li>
											<strong>Request Integrity:</strong> PAR = Cannot be modified | Standard = User
											can modify query params
										</li>
										<li>
											<strong>URL Length:</strong> PAR = Compact request_uri | Standard = May exceed
											browser limits
										</li>
										<li>
						...
						<ComprehensiveCredentialsService
							...
							postLogoutRedirectUri={
								localCredentials.postLogoutRedirectUri || 'https://localhost:3000/logout-callback'
							}
							// Change handlers
							...
							<InfoBox $variant="info">
								...
								<div>
									...
									<InfoText>
										...
										challenge is included in the PAR request, and the code verifier is used during
										token exchange.
									</InfoText>
								</div>
							</InfoBox>
						...
						{currentStep === 3 && (
							<ResultsSection>
								...
								{settings.tokenAutoExchange ? (
									<HelperText>
										Tokens will exchange automatically once the redirect completes because Token
										Auto-Exchange is enabled in UI settings.
									</HelperText>
								) : (
									<>
										<HelperText>
											Token Auto-Exchange is disabled. Click the button below after obtaining an
											authorization code.
										</HelperText>
										<Button
											$variant="primary"
						...
						>
							<InfoBox $variant="success">
								...
								<div>
									...
									<InfoText>
										You have successfully completed the PAR flow. The authorization URL is ready and
										contains the secure request_uri from your PAR request.
									</InfoText>
									<InfoList>
										<li>
