...
// It represents the End-User's login state at the OP`}</CodeBlock>
								<PingOneNote>
									...
									<div>
										...
										<p>
											PingOne provides session_state in authentication responses for session
											management.
										</p>
									</div>
								</PingOneNote>
  ...
  redirectToLogin();
			...
			<Card>
				...
				<CardBody>
					...
					<p>
						The Session State value is calculated on the server and recalculated by the OP iframe in
						the User Agent. It's based on a salted cryptographic hash of:
					</p>
					<ul style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						<li>
							<strong>Client ID:</strong> The OAuth client identifier
						</li>
						<li>
							<strong>Origin URL:</strong> The origin URL of the Authentication Response
						</li>
						<li>
							<strong>OP User Agent State:</strong> The OpenID Provider's User Agent state
						</li>
					</ul>

					<h3>Iframe Communication</h3>
					<p>
						Session monitoring relies on iframe communication between the OP and RP. This approach
						has some limitations:
					</p>
					<ul style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						<li>
							<strong>Third-party Content Blocking:</strong> Modern browsers may block iframe access
						</li>
						<li>
							<strong>Cross-origin Restrictions:</strong> Same-origin policy limitations
						</li>
						<li>
							<strong>User Privacy:</strong> Users may disable third-party cookies
						</li>
					</ul>

					<h3>Alternative Approaches</h3>
					<p>When iframe-based session monitoring isn't suitable, consider these alternatives:</p>
					<ul style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						<li>
							<strong>Polling:</strong> Periodically check session status via API calls
						</li>
						<li>
							<strong>WebSockets:</strong> Real-time session status updates
						</li>
						<li>
							<strong>Server-Sent Events:</strong> Push-based session notifications
						</li>
						<li>
							<strong>Token Refresh:</strong> Use token expiration for session management
						</li>
					</ul>
				</CardBody>
			</Card>
			...
			<Card>
				...
				<CardBody>
					...
					<ul style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						<li>
							<strong>RP-Initiated Logout:</strong> Applications can initiate user logout
						</li>
						<li>
							<strong>Front-Channel Logout:</strong> Immediate logout across multiple applications
						</li>
						<li>
							<strong>Back-Channel Logout:</strong> Reliable server-to-server logout communication
						</li>
						<li>
							<strong>Session Monitoring:</strong> Real-time session status tracking
						</li>
					</ul>
					...
					<ul style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						<li>
							<strong>Post-Logout Redirect URIs:</strong> Configure where users go after logout
						</li>
						<li>
							<strong>Session Timeout:</strong> Configurable session duration
						</li>
						<li>
							<strong>Idle Timeout:</strong> Automatic logout after inactivity
						</li>
						<li>
							<strong>Multi-Session Support:</strong> Manage multiple concurrent sessions
						</li>
					</ul>
			...
			<Card>
				...
				<CardBody>
					...
					<ul style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						<li>
							<strong>Secure Session State:</strong> Use cryptographically strong session state
							values
						</li>
						<li>
							<strong>HTTPS Only:</strong> Always use HTTPS for session management endpoints
						</li>
						<li>
							<strong>Token Validation:</strong> Validate all tokens and session state parameters
						</li>
						<li>
							<strong>Logout Confirmation:</strong> Confirm logout actions to prevent accidental
							logouts
						</li>
					</ul>
					...
					<ul style={{ paddingLeft: '1.5rem', lineHeight: '1.6' }}>
						<li>
							<strong>CSRF Protection:</strong> Implement CSRF tokens for logout requests
						</li>
						<li>
							<strong>Origin Validation:</strong> Validate origin headers for security
						</li>
						<li>
							<strong>Session Timeout:</strong> Implement reasonable session timeouts
						</li>
						<li>
							<strong>Audit Logging:</strong> Log all session management events
						</li>
					</ul>
