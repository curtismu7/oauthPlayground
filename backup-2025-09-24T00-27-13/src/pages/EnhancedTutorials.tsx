  ...
  const tutorials = [
    {
      ...
      description: 'Learn the core concepts of OAuth 2.0 including flows, tokens, and security considerations.',
      ...
      steps: [
        {
          ...
          description: 'Learn about the four key roles in OAuth: Resource Owner, Client, Authorization Server, and Resource Server.',
          content: (
            <div>
              <p><strong>Resource Owner:</strong> The user who owns the data (you!)</p>
              <p><strong>Client:</strong> The application requesting access</p>
              <p><strong>Authorization Server:</strong> Issues tokens (PingOne)</p>
              <p><strong>Resource Server:</strong> Hosts the protected data</p>
            </div>
          )
        },
        {
...
if (!isValid) {
  throw new Error('Invalid token');
    ...
    },
    {
      ...
      description: 'Step-by-step guide through the most secure OAuth flow for server-side applications.',
  ...
  headers: {
    ...
    },
    {
      ...
      description: 'Learn to implement PKCE (Proof Key for Code Exchange) for enhanced security in public clients.',
...
console.log('Code Verifier:', codeVerifier);`
    ...
    },
    {
      ...
      description: 'Master the art of validating JWT tokens including signature verification and claims validation.',
  ...
  return (
    <Container>
      <PageHeader>
        ...
        <p>
          Master OAuth 2.0 and OpenID Connect through hands-on tutorials and practical tools.
          Learn by doing with real implementations and immediate feedback.
        </p>
      </PageHeader>
