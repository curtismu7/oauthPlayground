		...
		<MonitorContainer>
			...
			<MetricsGrid>
				...
				<MetricCard>
					...
					<MetricDescription>Total application size</MetricDescription>
				</MetricCard>
				...
				<MetricCard>
					...
					<MetricDescription>Code-split chunks</MetricDescription>
				</MetricCard>
				...
				<MetricCard trend={metrics.cacheHitRate > 80 ? 'up' : 'down'}>
					...
					<MetricDescription>Resource cache efficiency</MetricDescription>
				</MetricCard>
				...
				<MetricCard trend={metrics.errorRate < 5 ? 'up' : 'down'}>
					...
					<MetricDescription>Lazy loading errors</MetricDescription>
				</MetricCard>
