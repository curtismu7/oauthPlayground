 ...
 * 
 * Improves readability of server messages sent to frontend with:
 ...
 * 
 * Formats server messages for improved readability in frontend logs and progress windows
 */
class ServerMessageFormatter {
    ...
    formatMessageBlock(eventType, eventStage, message, details = {}) {
        try {
            ...
            console.error('Error formatting message block:', error);
    ...
    formatProgressMessage(operation, current, total, message, stats = {}) {
        try {
            ...
            console.error('Error formatting progress message:', error);
