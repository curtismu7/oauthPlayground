...
import {  FiActivity, FiTrendingUp, FiTrendingDown, FiZap, FiDownload, FiMonitor  } from 'react-icons/fi';
  ...
  useEffect(() => {
    const updatePerformanceData = () => {
      ...
      const memoryUsage = (performance as unknown).memory ? 
        (performance as unknown).memory.usedJSHeapSize / 1024 / 1024 : 0;
