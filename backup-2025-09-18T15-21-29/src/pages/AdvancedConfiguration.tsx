...
const AdvancedConfiguration = () => {
  ...
  const predefinedScopes = [
    ...
    { id: 'offline_access', label: 'Offline Access', description: 'Request refresh tokens for long-term access' }
  ];
  ...
  const saveConfiguration = () => {
    ...
    const allClaims = [
      ...standardClaims,
      ...customClaims.filter(claim => claim.trim() !== '')
    ];
  ...
  return (
    <Container>
      <Header>
        ...
        <p>
          Customize OAuth scopes and OpenID Connect claims for your specific use case.
          Configure exactly what data your application requests and receives.
        </p>
      </Header>
      ...
      <PreviewSection>
        ...
        <CardBody>
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <div style={{ fontFamily: 'monospace', fontSize: '0.875rem', color: '#059669', backgroundColor: '#f0fdf4', padding: '0.5rem', borderRadius: '0.25rem' }}>
              {allScopes.join(' ')}
            </div>
          </div>
