...
const FlowCard = styled(Card)`;
  ...
  &:hover {
    ...
    box-shadow: 0 8 px 25 px rgba(0, 0, 0, 0.1);
  }
        ...
        code: `// Server validates: SHA256(codeVerifier) === storedChallenge
{
  ...
  &scope=openid profile email`
      ...
      },
      {
        ...
        code: `#access_token=eyJhbGciOiJSUzI1 NiIsInR5 cCI6 IkpXVCJ9...
&id_token=eyJhbGciOiJSUzI1 NiIsInR5 cCI6 IkpXVCJ9...
...
const OAuthFlows = () => {;
  ...
  const handleFlowSelect = (flow: OAuthFlow) => {;
    ...
    try {
      ...
      console.error('Demo failed:', _error);
      setDemoStatus('error');
    }
  };
