...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (savedCredentials) {
      try {
        ...
        if (parsedCredentials.clientSecret === '0mClRqd3fif2vh4WJCO6B-8OZuOokzsh5gLw1V3GHbeGJYCMLk_zPfrptWzfYJ.a') {
        ...
        console.error('❌ [Login] Failed to parse saved credentials:', _error);
      }
    } else {
  ...
  const handleCredentialSave = () => {
    ...
    try {
      ...
      console.error('❌ [Login] Failed to save credentials:', _error);
      setSaveStatus({
        type: 'danger',
        title: 'Error',
