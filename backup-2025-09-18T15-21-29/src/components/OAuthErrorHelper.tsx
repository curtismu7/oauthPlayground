...
export const OAuthErrorHelper: React.FC<OAuthErrorHelperProps> = ({
  ...
  const getErrorGuidance = (error: string) => {
    switch (error.toLowerCase()) {
          ...
          solutions: [
            {
              ...
              icon: <FiSettings />,
              description: 'Verify that the required scopes are enabled in your PingOne application settings.',
              steps: [
            ...
            },
            {
              ...
              icon: <FiGlobe />,
              description: 'Verify your application has the necessary permissions for the requested scopes.',
              steps: [
      ...
      default:
        return {
          title: 'OAuth Error',
          description: errorDescription || 'An OAuth error occurred during the authorization process.',
          solutions: [
            {
  ...
  const guidance = getErrorGuidance(_error);
  ...
  return (
    <ErrorContainer>
      ...
      <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
        ...
        <ActionButton 
          onClick={() => window.open('https://docs.pingidentity.com/bundle/pingone/page/ojg1564020488637.html', '_blank')}
        >
