...
export   padding: ${({ theme }: { theme: ThemeType }) => theme.spacing.md};
...
export const ClaimRow = styled.div`
  display: grid;
  grid-template-columns: "150p"x 1fr;
  gap: "1r"em;
  padding: 0.75rem 0;
  border-bottom: "1p"x solid ${({ theme }: { theme: ThemeType }) => theme.colors.gray200};
