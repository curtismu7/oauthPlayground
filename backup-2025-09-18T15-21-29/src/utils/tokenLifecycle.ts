...
class TokenLifecycleManager {
  ...
  private getLifecycleData(): TokenLifecycleInfo[] {
    try {
      ...
      console.error('Failed to get lifecycle data:', _error);
      return [];
    }
  }
  ...
  private updateLifecycleData(tokenInfo: TokenLifecycleInfo): void {
    try {
      ...
      console.error('Failed to update lifecycle data:', _error);
    }
  }
  ...
  private getAnalyticsData(): Array<{
    ...
    try {
      ...
      console.error('Failed to get analytics data:', _error);
      return [];
    }
  }
  ...
  private updateAnalytics(action: string, flowType: string, tokenId: string): void {
    try {
      ...
      console.error('Failed to update analytics data:', _error);
    }
  }
}
