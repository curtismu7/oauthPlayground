...
export const getTokenHistory = (): TokenHistory => {
  try {
    ...
    console.error('❌ [TokenHistory] Error retrieving token history:', _error);
  }
...
export const addTokenToHistory = (
  ...
  try {
    ...
    console.error('❌ [TokenHistory] Error adding token to history:', _error);
    return false;
  }
};
...
export const clearTokenHistory = (): boolean => {
  try {
    ...
    console.error('❌ [TokenHistory] Error clearing token history:', _error);
    return false;
  }
};
...
export const removeTokenFromHistory = (entryId: string): boolean => {
  try {
    ...
    console.error('❌ [TokenHistory] Error removing token from history:', _error);
    return false;
  }
};
