...
export const localStorageService: StorageService = {
  ...
  removeItem(key) {
    try {
      ...
      console.error('Error removing from localStorage:', _error);
      return false;
    }
  },
...
export const sessionStorageService: StorageService = {
  ...
  setItem(key, value) {
    try {
      ...
      console.error('Error saving to sessionStorage:', _error);
      return false;
    }
  },
  ...
  getItem(key, defaultValue = null) {
    try {
      ...
      console.error('Error reading from sessionStorage:', _error);
      return defaultValue;
    }
  },
  ...
  removeItem(key) {
    try {
      ...
      console.error('Error removing from sessionStorage:', _error);
      return false;
    }
  },
