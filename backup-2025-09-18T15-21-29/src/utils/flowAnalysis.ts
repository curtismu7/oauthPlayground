...
export class FlowAnalyzer {
  ...
  private generateReasons(flowType: string, metrics: FlowMetrics, flowData: unknown): string[] {
  ...
  private generateWarnings(flowType: string, flowData: unknown): string[] {
  ...
  private findBestFlow(flows: unknown[], metric: string): string {
  ...
  private generateComparisonSummary(flows: unknown[], bestFlows: unknown): string {
  ...
  private matchesRequirements(flowType: string, requirements: unknown): boolean {
    const flowData = flowAnalysisData[flowType as keyof typeof flowAnalysisData];
...
export const getFlowRecommendations = (requirements: unknown): FlowRecommendation[] => {
