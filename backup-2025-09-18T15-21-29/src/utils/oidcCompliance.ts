...
export const validateOIDCCompliance = (config: OIDCFlowConfig): OIDCComplianceResult => {
  ...
  const validResponseTypes = ['code', 'id_token', 'id_token token', 'code id_token', 'code token', 'code id_token token'];
  ...
  const validAuthMethods = ['client_secret_post', 'client_secret_basic', 'client_secret_jwt', 'private_key_jwt', 'none'];
