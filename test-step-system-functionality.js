...
try {
	...
	const integrationChecks = [
		...
		{
			feature: 'Centralized messaging',
			check: v3FlowContent.includes('CentralizedSuccessMessage'),
		},
		{
			feature: 'Clean component structure',
			check: v3FlowContent.includes('OAuth2AuthorizationCodeFlow') === false,
		}, // Should be V3, not OAuth2
		{
			feature: 'No conflicting logic',
			check: !v3FlowContent.includes('setTimeout') || v3FlowContent.split('setTimeout').length < 3,
		},
	];
