...
class OAuthError extends Error {
	...
	static isOAuthError(error) {
		return error instanceof OAuthError || (error && error.name === 'OAuthError');
	}
}
 ...
 * @returns {OAuthError} New OAuthError instance
 */
const createOAuthError = (code, { description = '', uri = '', originalError = null } = {}) => {
	...
	const errorMessages = {
		...
		[OAuthErrorTypes.ACCOUNT_SELECTION_REQUIRED]:
		...
		[OAuthErrorTypes.INVALID_CODE_CHALLENGE_METHOD]:
			'The provided code challenge method is not supported',
