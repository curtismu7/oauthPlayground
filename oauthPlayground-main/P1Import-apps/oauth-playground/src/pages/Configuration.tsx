      ...
      <Card style={{ marginTop: '2rem' }}>
        ...
        <CardBody>
          ...
          <ol style={{ paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
            <li>Sign in to the <a href="https://admin.pingone.com" target="_blank" rel="noopener noreferrer">PingOne Admin Console</a></li>
            ...
            <ul style={{ listStyle: 'disc', paddingLeft: '1.5rem', margin: '0.5rem 0' }}>
              <li>Add the Redirect URI: <code>{formData.redirectUri || 'https://your-app.com/callback'}</code></li>
          ...
          <ul style={{ paddingLeft: '1.5rem', marginBottom: 0 }}>
            <li><a href="https://docs.pingidentity.com/bundle/pingone-oauth-20/page/lyc1469003009669.html" target="_blank" rel="noopener noreferrer">PingOne OAuth 2.0 Documentation</a></li>
            <li><a href="https://docs.pingidentity.com/bundle/pingone-openidconnect/page/lyc1469003009669.html" target="_blank" rel="noopener noreferrer">PingOne OpenID Connect Documentation</a></li>
            <li><a href="https://support.pingidentity.com/s/" target="_blank" rel="noopener noreferrer">Ping Identity Support</a></li>
          </ul>
        </CardBody>
      </Card>
    </ConfigurationContainer>
