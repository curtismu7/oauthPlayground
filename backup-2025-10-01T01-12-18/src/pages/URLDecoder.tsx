  ...
  return (
    <Container>
      <Header>
        ...
        <Subtitle>
          Decode and analyze URLs, especially useful for OAuth authorization URLs and callback parameters.
          Break down complex URLs into readable components and parameters.
        </Subtitle>
      </Header>
      ...
      <ContentCard>
        <CardHeader>
          ...
          <CardDescription>
            Paste or type a URL to decode. This tool works with complete URLs, URL-encoded strings, and OAuth authorization URLs.
          </CardDescription>
        </CardHeader>
        ...
        <ButtonGroup>
          <Button 
            ...
            variant="primary"
          >
            {isDecoding ? <FiRefreshCw style={{ animation: 'spin 1s linear infinite' }} /> : <FiSearch />}
      ...
      <ContentCard>
        ...
        <InfoBox type="warning">
          ...
          <p style={{ margin: 0 }}>
            Be careful when sharing decoded URLs that contain sensitive information like client secrets, 
            tokens, or personal data. This tool is for development and debugging purposes only.
          </p>
        </InfoBox>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
          <div>
            ...
            <p style={{ margin: 0, fontSize: '0.875rem', color: '#6b7280' }}>
              Perfect for analyzing OAuth authorization URLs, callback URLs, and token exchange requests. 
              Helps debug parameter issues and understand URL structure.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: '0.875rem', color: '#6b7280' }}>
              Breaks down query parameters and hash fragments into readable key-value pairs. 
              Useful for debugging redirect URI mismatches and parameter validation.
            </p>
          </div>
