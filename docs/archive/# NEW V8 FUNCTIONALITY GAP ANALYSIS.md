...
|---|---------------------------------------------------|----------------------------|-------------------|-------------|------------------------------------|-----------------------------------------------|--------------------------------------------------------------------------------|
| 1 | OIDC Discovery (well-known endpoint)              | Discovery / Config         | TBD               | TBD         | TBD                                | e.g. `ComprehensiveCredentialsService`      | Ensure discovery can be triggered via **pop-up/slide-out** with education.     |
