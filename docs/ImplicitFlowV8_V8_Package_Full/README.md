# ImplicitFlow V8 Package — Docs & Manifests

This ZIP contains everything needed to build and wire the **ImplicitFlow V8** experience using Cursor/Windsurf.

## Contents

- `docs/ImplicitFlow-StarterSkeleton.md`  
  - Full starter skeleton for `ImplicitFlow.tsx` with V8 UX and PingOne alignment.
...
- `manifests/cursor-import-manifest-ImplicitFlow.md`  
...
2. Open `manifests/cursor-import-manifest-ImplicitFlow.md` in Cursor.  
3. Instruct Cursor:  
