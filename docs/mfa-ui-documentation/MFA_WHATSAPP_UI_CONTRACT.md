...
- [MFA WhatsApp UI Documentation](./MFA_WHATSAPP_UI_DOC.md) - WhatsApp UI structure and components
...
This document defines the UI contract for WhatsApp device registration and authentication flows. WhatsApp MFA is implemented as an SMS-like MFA factor via PingOne MFA with type = "WHATSAPP". All outbound WhatsApp messages are sent by PingOne using its configured sender. This contract ensures consistent behavior, error handling, and user experience across all WhatsApp-related UI components.
...
**Applies To:**
- ✅ WhatsApp Device Registration Flow (Admin)
- ✅ WhatsApp Device Registration Flow (User)
- ✅ WhatsApp Device Authentication Flow
...
- Must default device name to "WHATSAPP" when entering Step 2
- Must show "Register WhatsApp Device" button
...
**Device Name:**
- Defaults to "WHATSAPP" when entering Step 2
...
- Must display environment ID input
- Must display device authentication policy selector
- Must load and display available WhatsApp devices
- Must allow user to select specific device

**Device List Contract:**
- Must show all available WhatsApp devices
...
**Contract:**
- Must display when WhatsApp is not enabled in PingOne environment
- Must provide guidance on enabling WhatsApp
...
- **v1.0.0** (2026-01-06): Initial WhatsApp UI contract
...
- **Device Name:** Always defaults to "WHATSAPP" when entering Step 2
