...
- [MFA Email UI Documentation](./MFA_EMAIL_UI_DOC.md) - Email UI structure and components
...
This document defines the UI contract for Email device registration and authentication flows. This contract ensures consistent behavior, error handling, and user experience across all Email-related UI components.
...
**Applies To:**
- ✅ Email Device Registration Flow (Admin)
- ✅ Email Device Registration Flow (User)
- ✅ Email Device Authentication Flow
...
**Contract:**
- Must display email address input
- Must validate email format
- Must display device name input (optional, shown if `promptForNicknameOnPairing` is enabled)
- Must default device name to "EMAIL" when entering Step 2
- Must show "Register Email Device" button
...
**Device Name:**
- Defaults to "EMAIL" when entering Step 2
...
- Must display environment ID input
- Must display device authentication policy selector
- Must load and display available Email devices
- Must allow user to select specific device

**Device List Contract:**
- Must show all available Email devices
- Must display device email address
...
- **v1.0.0** (2026-01-06): Initial Email UI contract
...
- **Device Name:** Always defaults to "EMAIL" when entering Step 2
